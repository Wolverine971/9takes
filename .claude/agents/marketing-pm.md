...
| Shared evidence packet for the six-perspective jury             | `/blog_perspective_research_people`                                                                                                                                                    |
| One isolated audience-perspective audit                         | `/blog_perspective_review_people`                                                                                                                                                      |
| Perspective adjudication / revision brief                       | `/blog_perspective_synthesis_people`, then `/blog_perspective_verify_people`                                                                                                           |
