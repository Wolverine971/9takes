...
This resolution answers the clean synthesis generated from the corrected source-task context, the
immutable draft, the evidence packet, and six independent perspectives. The live draft's whole-file
SHA after the final grade metadata is
`7ce10dccafe67acf857fd31cd0abe115e38b71193ea2f3f55c9c517c59c53df8`; its reader-visible
perspective hash is
`01bc30b73f427f21caadc2359c8fb87d8b87981d9644c34a5bf0fb2c511aeac6`.

Exit checks on the live article: blog lint **0 fail / 2 warn**; reader-visible body **4,439 words**
against the 4,500 ceiling; source audit **5 inline / 1 vague / 0 untagged**; quality report **0 strong /
1 comparative**; same-type similarity **clear**, top pair `0.066`.
...
was then graded twice from scratch; those graders changed only `content_quality` frontmatter and the
directly related grade sidecar.

## Protected hits checked

All twelve clean-synthesis protections remain in the live draft:

- **PROTECT-01:** exact H2 4 cue and imagined passage remain adjacent and unchanged.
- **PROTECT-02:** “The reframe changes what the behavior means without changing what it cost.” remains
  verbatim upstream of the H2 7 ending.
- **PROTECT-03 / PROTECT-04:** the turnover mechanism, competing account, and safe-pass falsifier remain.
- **PROTECT-05:** the criticism filter and “there is no gym she can go to about that” remain; P1-09
  adds a third category before the untouched filter.
- **PROTECT-06:** “We'll have to see,” the best-player-in-the-world clause, and Clark's Olympic
  self-assertion remain.
- **PROTECT-07:** the bespoke table and its final row remain; only the inferential column heading changed.
- **PROTECT-08 / PROTECT-09:** the Swoopes concession and open commercial seam remain.
- **PROTECT-10:** Clark's “The fire and the passion, that's what makes me, me” ending remains.
- **PROTECT-11:** the six-out-of-ten opening and negative-scouting-report payoff remain.
- **PROTECT-12:** the direct Type 1/1w2 answer, five FAQs, and entity metadata remain.

## Unresolved decisions

1. The source audit retains one non-blocking vague attribution for “We'll have to see,” but reports
   zero untagged load-bearing quotes and no untagged quote in the opening.
2. One comparative pair remains in PROTECT-05's criticism filter. It is below the formula cap and was
   protected by the jury; the deterministic quality report records 0 strong / 1 comparative.
3. The article has 61 words of headroom. Any later live-season refresh should replace dated material
