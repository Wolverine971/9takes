...
**FUTURE-H1 — The anchor is timeless by design.** The piece's emotional and evidentiary center is the drawer dialogue and the one-word close:
...
- An "as of [month year]" anchor on the lawsuit status, given the piece was researched the day the packet confirms "no source after May 12, 2026" exists on it. (Absent.)
- Nomination-current Emmy facts, since the nominations landed a month before the review date and are Tier-1 sourced. (Absent — still phrased at submission stage.)
- Absolute month for the 2025 Capitol trip in a section whose whole method is date precision. (It says "Spring 2025"; the trip was June 10–12, 2025.)
- The thesis not depending on any 2026 event. (Present — expectation met.)
...
- **Minimum viable repair:** Replace with absolute, nomination-current phrasing: "The show went into the September 2026 Emmys with 25 nominations, the most of any series on television and nearly double its first-year count; Wyle was nominated for acting and directing both." (After the ceremony: update with results.)
- **Expected benefit:** The paragraph survives the ceremony as a correct historical statement instead of a stale forecast; the record-setting double nomination strengthens the stress-arrow point it is there to make.
- **Confidence:** High.
- **Acceptance test:** The paragraph contains no deictic time reference ("this September") and states Wyle's 2026 Emmy status as "nominated" (or, post-ceremony, the actual results); a reader on 2026-09-15 finds nothing contradicted by that morning's news.
...
- **Minimum viable repair:** Drop the label: "No personality framework settles a lawsuit." Identical rhetorical force, zero legal exposure, permanently true.
- **Expected benefit:** Removes the article's only sentence that could be falsified by a court document.
- **Confidence:** High that the label is risky; medium on which label is technically correct (that uncertainty is the point).
...
- **Minimum viable repair:** Swap in the ruling article for the ruling claim (RS Feb 2025 or AP via S-13), a finale recap that contains the quote (TV Insider, S-34) for the Time link, and add Disability Scoop (S-19) alongside CBS for the arrest specifics.
- **Expected benefit:** The citation block survives spot-checking now and link-rot triage later.
- **Confidence:** High.
...
- **Minimum viable repair:** "**June 2025.**"
- **Expected benefit:** The case file's two dates are both checkable and both check out, forever.
- **Confidence:** High.
...
- **Minimum viable repair:** Pin the age to the dated moment ("a man who had to reach fifty-four to ask") or drop the number.
- **Expected benefit:** The closing image — the piece's best paragraph — never acquires a factual asterisk.
- **Confidence:** High on the arithmetic; medium on whether readers will notice.
...
- **Minimum viable repair:** None now; add to the refresh list with a January 2027 trigger. Optionally hedge "fifteen episodes" to "a season is one continuous shift" (true of both aired seasons, format-proof).
- **Expected benefit:** The refresh pass knows exactly which sentences to re-check against S3.
- **Confidence:** Medium (depends on S3 creative choices no one can know).
...
- **Minimum viable repair:** "He champions the set's phone ban — 'invasive energy' — because without them actors…" (one verb swap; his quoted rationale is untouched).
- **Expected benefit:** The claim matches all current and likely future coverage; the calm-section evidence survives skeptical reading.
- **Confidence:** High.
- **Acceptance test:** The article credits Wyle only with endorsing/enforcing the ban, never instituting it.

## Follow-on questions

**FUTURE-Q1 — What does California's Second Appellate District decide, and when?** A reversal ends the case (lawsuit section becomes history); an affirmance sends it toward trial or settlement (section needs a new "what's next" clause). Best source: the Div. 3 docket, with Deadline/Variety as the practical alert channel. This is the single answer most likely to force a rewrite of a full section within twelve months.

**FUTURE-Q2 — What happens on September 14, 2026?** Wyle winning acting again, winning directing, losing both, or the show losing Drama Series each changes the Emmy paragraph's framing (repeat champion vs. record nominee). Best source: Television Academy (S-7 page updates same night). Five weeks out — this is the first refresh trigger.

**FUTURE-Q3 — Does the complaint plead contract only, or contract plus copyright-adjacent claims?** The answer determines whether FUTURE-C2's label question has a clean answer or the draft should stay label-free permanently. Best source: the complaint itself (LA Superior Court records or erlawsuit.com — the packet's acknowledged Tier-1 gap).

**FUTURE-Q4 — Does season 3 keep the fifteen-episode / one-shift format and Robby's status?** Answer determines whether the present-tense production claims and FAQ 4 survive January 2027 untouched. Best source: HBO Max's S3 announcement coverage (Deadline tracker already live).

## Preserve list

- The drawer dialogue block and the one-word "Somewhere" close — the article's most durable and best material; no temporal repair touches it.
- The two-date case-file structure of the Capitol section (with the June fix applied) — absolute-date architecture is why that section will still argue in 2027.
- "None of that settles who owes what to Crichton's heirs; courts exist because motives and rights are different questions." — outcome-proof hedging; keep verbatim through any lawsuit update.
- "The award came 26 years after his last nomination; SlashFilm counted the gap, 1999 to 2025." — self-dating attribution done right.
- The bookend ("He never worked a shift. He just spent thirty years reporting for one.") — timeless, and the piece's cleanest landing.

## Research log

1. **Packet reuse:** All claim-level verification, source tiers, and the litigation/Emmy timelines come from the evidence packet (compiled 2026-08-09, same day as this review). It answered most durability questions, including "no lawsuit source after May 12, 2026."
2. **Search 1 — "Crichton estate Warner Bros 'The Pitt' lawsuit appeal ruling 2026":** Confirmed the appeal remains undecided (nothing newer than the completed May 2026 briefing — [Deadline](https://deadline.com/2026/05/the-pitt-lawsuit-crichton-estate-appeal-hbo-1236899649/)). Also surfaced [Rolling Stone's ruling coverage](https://www.rollingstone.com/tv-movies/tv-movie-news/michael-crichton-er-the-pitt-lawsuit-1235279635/) describing both contract-interference and copyright-infringement findings — which downgraded my planned blocker on the "copyright case" line to concern FUTURE-C2 (the label is disputed across coverage, not cleanly contradicted).
3. **Search 2 — The Pitt season 3 status:** Confirmed renewal and a January 2027 target ([Deadline tracker](https://deadline.com/feature/the-pitt-season-3-news-updates-everything-we-know-1236928731/), [Forbes June 2026](https://www.forbes.com/sites/paultassi/2026/06/17/an-update-on-the-pitt-season-3s-release-date-and-a-cast-member-confirmed/)). Decision affected: added FUTURE-C6 and FUTURE-Q4; established that the show's press footprint keeps growing through the review horizon (raises the cost of the phone-ban overreach, FUTURE-C7).

## Limits of this review

- Twelve-month refresh triggers, in order: **(1)** 2026-09-14 Emmy ceremony → update the Emmy paragraph with results; **(2)** appellate decision, any time → update lawsuit section + FAQ 3; **(3)** January 2027 S3 premiere → re-check present-tense production claims and FAQ 4; **(4)** ongoing → re-verify AOL/Yahoo syndication links for rot and fix the three mis-pointed citations (FUTURE-C3). Items (1) and (2) are near-certain to fire; the article should be written today as if they already have.
- I evaluated temporal durability only. Non-temporal accuracy issues the packet flags (the "really good" arrest-quote compression, camp-size dispute, "set of 300" gloss, Emmy-speech wording variance, "Abbot" spelling and intervention mechanics) are other perspectives' lanes; I touched factual matters only where time makes them worse (FUTURE-C2, C7) or where a citation will fail a future click-through (C3).
- I cannot know future events; every forward-looking statement here is a trigger condition, not a prediction. The lawsuit-currency claim rests on absence of coverage as of 2026-08-09, not a docket check — the same limitation the packet discloses.
- The Enneagram type call itself is time-stable either way (motivational claims don't expire) and was not evaluated here.
