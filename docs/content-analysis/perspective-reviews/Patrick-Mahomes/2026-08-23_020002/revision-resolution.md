...
- **Grader Enneagram item (inner-thought vocabulary)** — middle of the inner-thought rewritten in his own phrase: "and the moment is never bigger than what it is" (from "how can you not let the moment be bigger than what it is," *New Heights* 2022). First and last sentences verbatim (PROTECT-15).
