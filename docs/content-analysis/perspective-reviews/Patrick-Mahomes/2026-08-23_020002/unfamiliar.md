...
**Recommendation: revise**, light. Fix the misattributed quote, soften the production credit, and add five or six orienting clauses. Nothing structural needs to move.

## What landed

**UNFAMILIAR-H1 — The opening pair.** "Nine teams had already passed. Patrick Mahomes wanted to know whether his mother's phone was working." … "I didn't think about it at all." … "Both are true. That is the whole puzzle of Patrick Mahomes." Zero prior knowledge required; the contradiction is the hook, and it is paid off at the very last line. Must survive because it is the piece's only fully self-contained entry point.

**UNFAMILIAR-H2 — The orientation paragraph.** "He is the face of the NFL: two MVPs, three rings, and a style of play so loose it has its own vocabulary. No-look. Sidearm. Backyard. He is also, as of this writing, a quarterback born in 1995 coming off the first torn ACL of his life…" One paragraph answers who, why, and why now. Must survive; it is the reader's whole map.

**UNFAMILIAR-H3 — The Kobe answer and its coda.** "…they don't see that preparation." followed by the 13-second game and "The situation was new to the stadium. It was not new to him." The thesis is shown on the field before it is named as a type. Must survive because it is the only on-field proof a newcomer gets that "anxious type = calmest in a crisis" is not just a slogan.

**UNFAMILIAR-H4 — The Jason Kelce trap.** "Mahomes did not argue. He confessed." … "In the back of my head all I think about is, if this doesn't work right here." The whole argument lands in an exchange, without a single "looks like X, is really Y" sentence. Must survive; it is the moment I believed the article.

**UNFAMILIAR-H5 — The wrist strap.** "an 18 the morning of the AFC Championship Game…" "The dread belongs to the waiting. It leaves the moment he has something to do." The most memorable new idea in the piece for a reader who knows nothing about him; it also makes "Type 6" feel like a description of a person rather than a label.

**UNFAMILIAR-H6 — "Notice the word. Validated."** A one-line reading of a quote that teaches the reader how to read the rest of the article. Must survive.

**UNFAMILIAR-H7 — The helmet turn.** "…the flop, the helmet and the 'great rush, dude' are one behavior. … He would rather be mocked than unprotected. Every Six makes some version of that trade. His is just televised." The article takes the most-mocked thing about him and makes it legible without excusing it ("I probably shouldn't have done that" is quoted first). This is the closest the piece gets to exceptional for a newcomer.

**UNFAMILIAR-H8 — "Pass rushers get compliments. The people inside the structure get held to it."** A newcomer's one-sentence summary of how he treats people. Must survive.

**UNFAMILIAR-H9 — The father's-arrest "order of operations" paragraph.** "The boy who copied his father's tongue … had become the reference point his father calibrated against." Handles a painful family story with the father's own words and no speculation. Must survive, with the co-produced credit fixed underneath it (see C1).

**UNFAMILIAR-H10 — Dr. Cooper and the close.** "…did not believe in his own knee until a doctor he trusted tried to break it and failed." and "Nine years after draft night, he is still checking the line. The difference is that he knows exactly who is on the other end." The close returns the reader to sentence one and needs no football to land.
...
**UNFAMILIAR-M3 — "walked him to the safeties."** The meaning of the beat (Texas's coaches did not see him as a quarterback) is invisible to anyone who does not know that "safety" is a defensive position. The paragraph's point, "the adults who were supposed to know the way did not all agree on it," lands only halfway. See C4.

**UNFAMILIAR-M4 — "counterphobic" is the thesis's load-bearing word and is never defined.** The TL;DR bullet gives an implicit gloss ("the most anxious type is often the calmest one when the worst case finally arrives"), but the diagnosis sentence "in its counterphobic form, with a Seven wing that supplies the grin" is two undefined terms in a row. See C3.

**UNFAMILIAR-M5 — One type claim is asserted where the others are shown.** "That is what a Six under stress looks like, performing certainty he does not have." The jump from "I ran a little bit too much" to "performing certainty" is the only place the type lens asks me to take its word for it. See C8.

**UNFAMILIAR-M6 — An ahead-of-evidence sentence.** "That is a Six talking: a man whose first instinct is to imagine the moment going wrong…" is placed under the Kobe quote, which is about preparation, not about imagining failure. The evidence for "imagine the moment going wrong" ("if this doesn't work right here") arrives one section later. It is a sequencing wobble, not a claim problem; noting it, not counting it.
...
- **Quotes that are the speaker's.** Expected and, in one place, not delivered (R1).

## What surprised me

- **Welcome:** the idea that the flop, the safest helmet, the early slide, and the compliments to pass rushers are one behavior. I arrived knowing, vaguely, that "Mahomes flops" is a meme; I left understanding it as threat management, and the article did that without asking me to forgive him.
- **Welcome:** the film-week timeline copied from Alex Smith. A concrete, visual, non-football-dependent artifact of what "rehearsed" means.
- **Welcome:** "The dread belongs to the waiting. It leaves the moment he has something to do." A sentence I will remember about a person I did not previously think about.
- **Jarring, mildly:** the styled first-person block after the Toney flag ("The rules are supposed to hold. That is the deal…"). For a beat I read it as a quote. The site renders it as an italic callout with a thought-bubble icon (`src/scss/blog.scss:630`), which is a reasonable cue, so I am recording this as a preference, not a concern.
- **Jarring, after the packet:** learning that the most vivid line in the "specific dread" paragraph belongs to someone else. It reframed how carefully I read the rest.
...
- **Expected benefit:** the paragraph keeps its point with a sentence the subject actually said; the "specific dread" claim becomes first-person evidence instead of a borrowed one.
- **Confidence:** high (verified in the primary transcript).
- **Acceptance test:** every quotation inside the walkthrough paragraph can be located in the EP15 transcript inside Mahomes's own turn (before "Travis was also like"); the phrase "Coach Reid is gonna kill me" no longer appears in the draft.
...
- **Minimum viable repair:** a five-to-ten-word appositive at the diagnosis use, in whatever sense the enneagram juror confirms is defensible (e.g. "the version that walks toward the thing it fears" or, if the label changes, the plain-language version of that). This review does not adjudicate which label is right.
- **Expected benefit:** the reader can state what "counterphobic" adds to "Type 6," instead of skipping it.
- **Confidence:** high that it is undefined; the label's correctness is outside this perspective.
...
- **Minimum viable repair:** "the coaches sent him to work out with the safeties, a defensive position; they did not see a quarterback." Or quote him: "they had kind of sent me over to play safety."
- **Expected benefit:** the "didn't see him as a quarterback" beat lands, which is what sets up Brittany's "Wait, what?"
- **Confidence:** high.
...
- **Minimum viable repair:** "Kliff Kingsbury, the Texas Tech coach who offered him a scholarship 'whenever I had no real offers'"; "the moment Whitehouse High's quarterback graduated."
- **Expected benefit:** the college chapter gets its nouns; the reader can place him on a map from high school to the draft.
- **Confidence:** high.
...
- **Minimum viable repair:** "On December 10, 2023, at Buffalo, an offside flag…" and "found Bills quarterback Josh Allen afterward."
- **Expected benefit:** the scene has a place and the stranger has a role; it also quietly rhymes with the 13-second game.
- **Confidence:** high.
...
- **Minimum viable repair:** either show the bridge in his own words (what, specifically, did running too much substitute for?) or drop the type sentence and let "The man who never takes a hit was taking them" stand alone; the Rabbit Hole already carries the stress-arrow theory.
- **Expected benefit:** the body keeps its "shown, not asserted" standard intact through its final section.
- **Confidence:** medium.
- **Acceptance test:** every "That is a Six…" sentence in the body sits within one paragraph of a first-person quote that supports it, or the sentence is gone.

### Preferences (not counted)

- **Inner-thought block.** Italic plus a thought-bubble icon is an adequate cue that the paragraph is imagined; a two-word lead-in ("Imagine it:") would remove the last ambiguity, but this is taste.
- **"A-Rod" then "Rodriguez."** Same person, two names, never joined; one "Alex Rodriguez" at first use would do it.
- **Rabbit Hole texture ("Kermit jokes," "Whataburger ketchup," "Vegas blackjack").** Context-free to a newcomer, but the section is labeled skippable and the rest of the piece does not depend on it.
- **"Green room," "second or third-round grade," "base-install day," "third-down cut-up," "lateral."** Inferable from context; I would not spend words on them.

## Specific improvements

Ordered by priority. Each is clause-level; together they add roughly 60–80 words, so they should be paired with trims (the Rabbit Hole subtype paragraph's superstition list is the obvious donor).
...
5. **UNFAMILIAR-I5 — Translate "walked him to the safeties" (C4).** Repair: quote him ("they had kind of sent me over to play safety") plus "a defensive position." Benefit: the paragraph's hinge lands. Confidence: high. Test: a non-fan can say what Texas thought he should play.

6. **UNFAMILIAR-I6 — Name the college and the high school (C5).** Repair: "the Texas Tech coach who offered him a scholarship"; "Whitehouse High's quarterback." Benefit: the reader can place him. Confidence: high. Test: both institutions named in the body.

7. **UNFAMILIAR-I7 — Fix or cut the Jason Kelce "conceded" clause (C6).** Repair: cut, or make the sarcasm visible. Benefit: no inverted third-party stance. Confidence: medium-high. Test: "conceded" not attached to Jason Kelce.

8. **UNFAMILIAR-I8 — Place the Toney-flag game (C7).** Repair: "at Buffalo"; "Bills quarterback Josh Allen." Benefit: the scene has a setting; Allen is not a stranger. Confidence: high. Test: opponent and Allen's role stated on first use.

9. **UNFAMILIAR-I9 — Earn or drop "performing certainty he does not have" (C8).** Repair: a supporting first-person line, or delete the type sentence. Benefit: the body's "shown, not asserted" standard holds to the end. Confidence: medium. Test: every body-level type sentence sits next to its evidence.
...
**UNFAMILIAR-Q4 — What was Nate Burleson's actual question?** What would change: "Asked … where the highlights come from, Mahomes named neither" becomes "Asked what it is like when the game slows down…" if the packet's transcription (CBS, "in the zone") is right. The Kobe answer still works; the framing sentence would just stop paraphrasing. Best source: `youtube-transcripts/mahomes/cbs-mornings-dad-career-legacy.md` (S05).

**UNFAMILIAR-Q5 — Will the opener read correctly the week after September 14?** What would change: "a quarterback … cleared for camp and pointed at a September 14 opener" and "sat out both August preseason games" (a third, Aug 28, was still ahead at the packet cutoff). Not this perspective's lane beyond noting that the why-now paragraph is the one most likely to need a dated line. Best source: the future juror.

## Preserve list

- "Nine teams had already passed. Patrick Mahomes wanted to know whether his mother's phone was working." / "Both are true. That is the whole puzzle of Patrick Mahomes." — the self-contained hook and its thesis.
- "He is the face of the NFL: two MVPs, three rings, and a style of play so loose it has its own vocabulary. No-look. Sidearm. Backyard." — the newcomer's map.
- "The type runs on the fear of being caught without support or a plan. Its signature is that the most anxious person in the room becomes the steadiest one when the crisis is real, because the crisis has been rehearsed." — the plain-language Enneagram claim; the article's accessibility rests on it.
- "The situation was new to the stadium. It was not new to him." — on-field proof in one line.
- "Mahomes did not argue. He confessed." and the "if this doesn't work right here" quote — the thesis in an exchange.
- "The dread belongs to the waiting. It leaves the moment he has something to do." — the most memorable sentence for a reader who arrived knowing nothing.
- The Alex Smith timeline block — concrete, visual, bespoke.
- "Notice the word. Validated." — teaches the reader how to read quotes.
- "Pass rushers get compliments. The people inside the structure get held to it."
- "He would rather be mocked than unprotected. Every Six makes some version of that trade. His is just televised."
- The father's-arrest paragraph: "…had become the reference point his father calibrated against. … He did not hide it. He waited until he trusted the structure." (minus "controlled the room," per C1).
- "The most gifted quarterback of his generation did not believe in his own knee until a doctor he trusted tried to break it and failed."
...
- This is a comprehension-and-orientation review. I did not evaluate the typing itself, the wing/subtype claims, the fairness of the psychological reading to the subject, the strength of the critical case, or the piece's durability past September 2026; those belong to other jurors. Where I touch them (C3, C8, Q1) it is only to report what a newcomer can and cannot follow.
- The blocker and C1 were surfaced by the packet, not by my unaided read; an unfamiliar reader would not catch either alone. I report them because the blocker definition is shared across perspectives and because I verified R1 in the primary transcript myself.
- I judged rendering from the SCSS, not from a rendered page; the inner-thought cue and the accordion/TL;DR behavior were not viewed in a browser.
- I read the embedded pipeline comments (ledgers, fresh-eyes, second-pass notes) as part of the file. I did not consult any other juror's review and none existed in the directory at the time of writing.
- Packet knowledge cutoff is 2026-08-23 07:00 UTC; nothing after the August 22 preseason game is known to this review.
