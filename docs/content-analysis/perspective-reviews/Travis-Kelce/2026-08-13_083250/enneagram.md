...
This is one of the stronger motivational arguments the pipeline has produced. The Type 7 case is built on the right kind of evidence: a repeatedly documented reframe reflex (suspension into "worked out perfect," rejection into a podcast bit, the marijuana-word deflection) rather than surface energy or party-guy behavior. The connecting lines are used correctly against 9takes' own house material (stress toward the rigid, critical side of 1; growth toward the focused depth of 5), counter-typing is properly quarantined to the Rabbit Hole, and the core fear is rendered in plain language ("A Seven builds his whole life around the exits") without a single jargon crutch in the main body.

Three problems keep it from passing clean. One is a blocker: the No. 87 origin story, which carries a full section's emotional load plus an FAQ answer, was publicly disputed by its own co-protagonist (Jason Kelce, November 2025) and the draft states it as flat fact. The others are calibration problems: the diagnosis section's first-person joy vocabulary rests substantially on verbatim-unverified quotes, and the typing machinery is deployed with more certainty than the public evidence supports (a hard-coded 7w8 against a crowd 7w6 lean; no stated falsifier; the same incident spent twice under two mechanisms). Recommendation: revise. Every repair is small and none threatens the thesis; the No. 87 fix arguably strengthens it.
...
- **A statement of what would change the call.** The role's central question. Absent. The counterarguments block rebuts Type 3 and Type 8 but never names a falsifier for Type 7 itself.
- **Serious treatment of alternatives.** Present and better than genre norm: the Type 3 case is steelmanned with real evidence (image-consciousness, greatest-ever ambition) before the past-tense rebuttal, and the Type 8 read gets a fair mechanical distinction (baseline weather vs. blocked joy). Noted, though: the 3-case and its rebuttal both lean on the verbatim-unverified GQ quotes (CLM-14).
- **Hedge discipline per the entity-gap rule ("present as argued analysis, never as consensus fact").** Met in the Rabbit Hole ("Kelce reads as a 7w8"). Broken in FAQ 1, which asserts "specifically a 7w8" flat.
- **Motivation-not-behavior argumentation.** Largely met; this draft argues from the reframe reflex, not from extroversion or energy, which is the most common typing error in celebrity Enneagram content and it is avoided here.
...
- **Minimum viable repair:** verify against the September 3, 2024 episode audio/transcript (S27; the repo has a YouTube-transcript workflow), or re-attribute as reported speech, or swap for verified equivalents (the return-at-36 decision is fact, S11; the "battle of my career" and marijuana-word quotes are verified and can carry more weight). Give "own worst critic" an outlet or cut it.
- **Expected benefit:** the type call's evidentiary spine becomes fully load-bearing.
- **Confidence:** high that the quotes are unverified; medium on drift risk being realized.
...
- **Minimum viable repair:** two sentences in the Rabbit Hole (natural home; keeps the main narrative clean): (1) name the discriminator vs. mere competitiveness — the off-field reframe evidence competitiveness cannot predict; (2) name a falsifier — e.g., evidence that the film-room depth was self-initiated before Jason/Reid imposed structure would collapse the borrowed-discipline pillar, and a documented tolerance for private stillness would weaken core 7.
- **Expected benefit:** the typing reads as a tested hypothesis rather than a lens that cannot lose, which is also the site's stated positioning (clustering hypothesis the product tests).
- **Confidence:** high.
...
- **Minimum viable repair:** soften FAQ 1 to match the Rabbit Hole's register ("reads as a 7w8"), and add one sentence to the wing section conceding the circle-dependence as real w6 evidence before landing on w8 via the documented physical aggression and full-send default.
- **Expected benefit:** the wing call survives contact with informed readers instead of inviting the correction.
- **Confidence:** high on the calibration problem; the w8 call itself remains defensible.
...
- **Confidence:** high. **Acceptance test:** stated age matches the quote dates.

## Follow-on questions

**ENNEAGRAM-Q1 — What does the September 3, 2024 Rich Eisen audio actually contain?**
What would change: if the four quotes verify, R2 largely dissolves and the diagnosis voice is safe; if "full send" or the roller-coaster line is materially different, the diagnosis section needs re-quoting from verified material. Best source: the episode itself (S27, Apple Podcasts) or its YouTube upload via the repo's transcript workflow.

**ENNEAGRAM-Q2 — Is there pre-Reid evidence of self-initiated discipline?**
What would change: the borrowed-discipline pillar. If 2011–2013 Cincinnati-era or draft-cycle accounts show self-driven film/preparation habits before structure was imposed, "rewired by other people" needs re-weighting and the growth-arrow story softens. Best sources: 2013 scouting profiles and pre-draft reporting; Cincinnati-era coach interviews.

**ENNEAGRAM-Q3 — Has Kelce ever described his tolerance for stillness or an off-season baseline?**
What would change: the sharpest 7-vs-3 discriminator available. A Seven's off-season is restless for stimulation; a Three's is restless for advancement. First-person evidence either way would upgrade the counterarguments block from inference to observation. Best sources: long-form sit-downs (the full GQ 2025 story, WSJ Magazine-style profiles), not game-week pressers.

## Preserve list

- The marijuana-word deflection passage and its framing sentence (H1) — the piece's most discriminating verified evidence.
- The failed-reframe reading of the shove, including the inner-thought panel and the verified "battle of my career" anchor (H2).
- The borrowed-discipline counter-thesis and the "Rewired. By other people." beat (H3).
- The ending's "built his whole life around the exits" rendering of the core fear and the unresolved reward-or-trap question (H4).
- The quarantine discipline: zero counter-typing ladders in the main body; theory density confined to the Rabbit Hole; the main narrative stays person-first.
- The Type 3 steelman structure in the counterarguments block (fix its quote sourcing per R2, but keep the argument's shape).

## Research log

1. **Evidence packet (read first, per protocol).** Answered nearly every factual question: verification status of all load-bearing quotes (CLM-05, CLM-14, Dispute #6), the No. 87 dispute (S8b, Dispute #1), the bracelet framing dispute, the crowd 7w6 lean, and the null-hypothesis note. Decisions affected: R1 (blocker call), R2 (quote-load concern), R3 (falsifiability concern).
2. **Internal: `src/blog/enneagram/enneagram-type-7.md`.** Research question: does the draft's theory usage match house definitions? Confirmed: core fear "being trapped, deprived, unfulfilled"; stress = "rigid, critical qualities of Type 1"; growth = "focused depth of Type 5"; the reframe reflex as the central defense ("the bad feeling never got metabolized — it just got outrun"). Decision affected: no theory-error blocker exists; H1/H2/H4 confirmed as house-consistent; the draft's arrow usage is correct.
3. **Internal: `docs/content-analysis/entity-gaps/Travis-Kelce.md` (targeted grep).** Research question: how strong is the crowd 7w6 lean and what is the house rule for presenting the wing? Found: "Crowd databases type him 7w6; the draft argues 7w8 — a defensible point of differentiation, not an error" and "present as argued analysis, never as consensus fact." Decision affected: R4 (the FAQ's flat "specifically a 7w8" violates the stated rule; the Rabbit Hole's hedged register complies).
4. **No external web research.** The packet resolved all factual questions this perspective needed; remaining unknowns (Eisen audio, pre-Reid discipline, stillness baseline) are logged as follow-on questions rather than chased, per the 2–4-source budget.

## Limits of this review

- I did not audit any podcast audio or the 2023 documentary; quote-verification statuses are taken from the packet, which itself relied on secondary renderings for those primaries.
- The wing judgment (R4) and the null-hypothesis concern (R3) are argued analysis, not settled fact; a reasonable evaluator could weight the documented aggression heavily enough to keep 7w8 with less hedging than I recommend.
- I evaluated theory usage against 9takes' own published Type 7 material and mainstream connecting-line conventions (7→1 stress, 7→5 growth); other Enneagram schools weight wings and instincts differently, and I did not adjudicate between schools.
- Independence maintained: I read only `context.json`, `draft-reviewed.md`, and `evidence-packet.md` from the review directory; no other perspective files existed to avoid, and the grade block embedded in the draft's frontmatter (including its `enneagram: 9` dimension score) was disregarded as an anchor.
- The subject's actual type is unknowable from public evidence; this review tests whether the draft's certainty is proportional to that evidence, not whether the typing is "true."
