...
blog: true
previewHtml: ''
pic: 'greek-statue-manipulation-masks'
---
```
...
<QuickAnswer question="How does each Enneagram type manipulate?">
	Every type has a specific manipulation style based on their core fear. Type 2s guilt-trip, Type 3s
	craft false images, Type 8s intimidate. But manipulation isn't evil—it's usually unconscious
	protection. Recognizing your own pattern is the first step to healthier communication.
</QuickAnswer>
```
...
## Why We Manipulate (~300 words)

### H2: The Psychology of Manipulation
...
Each type has a core fear. Manipulation tactics serve to:

1. Get needs met without risking the fear
...
## Type-by-Type Manipulation (~2,400 words total, ~260 each)

### H2: Type 1: Moral Superiority
...
### H2: Type 2: Guilt and Obligation
...
### H2: Type 5: Withholding and Superiority

**The Style:** "I know things you don't."

Type 5 manipulation is subtle—it's what they _don't_ do. Withholding information, withdrawing emotionally, making you feel stupid. Their power is knowledge and access, and they control through scarcity.
...
### H2: Type 6: Testing and Accusation
...
### H2: Type 7: Distraction and Reframing
...
### H2: Type 8: Intimidation and Dominance
...
## Manipulation Tactics Summary Table

| Type | Manipulation Style   | Key Tactic             | How to Respond                    |
| ---- | -------------------- | ---------------------- | --------------------------------- |
...
## Recognizing It In Yourself (~300 words)

### H2: Are You the Manipulator?
...
## When Manipulation Becomes Abuse (~200 words)

### H2: The Line Between Pattern and Pathology
...
- Therapy for complex relationship dynamics
...
All types manipulate—they just do it differently. Type 2's guilt-tripping is obvious; Type 5's withdrawal is subtle. Type 8's intimidation is overt; Type 9's passive resistance is covert. There's no "most" manipulative—just different styles with different visibility.
...
**File:** User is creating this

**Concept:** Greek statues with masks, hidden faces, or shadow puppetry theme

**Target filename:** `greek-statue-manipulation-masks.webp`
