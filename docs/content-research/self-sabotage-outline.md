...
```yaml
title: 'How Each Enneagram Type Self-Sabotages Success'
...
```markdown
<QuickAnswer question="How does each Enneagram type self-sabotage success?">
Every Enneagram type has a predictable self-sabotage pattern rooted in childhood protection mechanisms. Type 1s paralyze themselves with perfectionism. Type 7s start everything but finish nothing. Type 9s procrastinate into oblivion. Understanding your pattern is the first step to breaking it.
</QuickAnswer>
```
...
<p class="firstLetter">You're smart. You work hard. Your ideas are good.</p>
...
**Here's what's actually happening:** Your Enneagram type has a specific self-sabotage pattern that was built in childhood as a protection mechanism. It worked then. It's working against you now.
...
## Why We Self-Sabotage (Psychology Section) (~300 words)

### H2: The Psychology of Self-Sabotage
...
- A Type 1 who was criticized for mistakes develops perfectionism (defense)
- That perfectionism now prevents them from finishing anything that isn't "perfect" (self-sabotage)
...
## Type-by-Type Self-Sabotage Patterns (~2,500 words total, ~275 each)

### H2: Type 1: Paralysis by Perfectionism
...
### H2: Type 2: Martyrdom and Burnout
...
### H2: Type 3: Workaholism and Identity Collapse
...
### H2: Type 4: Creative Blocks and Comparison
...
### H2: Type 6: Worst-Case Spiraling
...
### H2: Type 7: Shiny Object Syndrome
...
### H2: Type 9: Procrastination and Numbing
...
## When Self-Sabotage Becomes Clinical (~200 words)
...
Your Enneagram type has a core fear that creates a protective pattern. When that pattern gets triggered—often unconsciously—you prioritize emotional safety over success. Understanding your specific pattern is how you start interrupting it.

**Which Enneagram types are most prone to self-sabotage?**

All types self-sabotage, but the patterns are more visible in some than others. Types 4, 5, 6, and 9 often show clearer patterns because their defenses involve withdrawal or avoidance. Types 1, 3, and 8 may sabotage through overwork and rigidity. Types 2 and 7 through over-extension.

**How do I actually stop self-sabotaging?**

First, identify your type's specific pattern. Then practice the _opposite_ behavior in small doses:
...
Not necessarily. Self-sabotage is a normal human pattern. However, chronic self-sabotage can be connected to anxiety, depression, or trauma responses. If patterns persist despite awareness and effort, professional support helps.

**Why do I give up when I'm close to success?**

This is often fear of success (success brings visibility, expectations, change, and potential loss). Your type determines _how_ this fear shows up—Type 3 might fear being "found out," Type 4 fears becoming ordinary, Type 9 fears the conflict that success might bring.
...
Now you know what you're dealing with. The only question left: What will you do with that knowledge?
...
**File:** `/docs/content-generation/image-prompts/self-sabotage-prompt.md`

**Concept:** Greek statues depicting internal conflict, self-struggle, one figure blocking another
