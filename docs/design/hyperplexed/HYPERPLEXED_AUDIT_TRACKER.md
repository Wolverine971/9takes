...
| Admin surfaces                | [`ADMIN_SURFACES_AUDIT_2026-07-09.md`](ADMIN_SURFACES_AUDIT_2026-07-09.md)                 | 2026-07-18 | P0.1/P0.4 and P1 shipped; mobile command center + grouped searchable nav shipped P3+P4+P6+P8+P9+P12+P13; P0.2/P0.3/P2 remain   | Representative 390x844 dark/light, overflow, menu filter/Escape/focus pass; authenticated real-data pass owed |
