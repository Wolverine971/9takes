...
| `/questions/[slug]` thread    | [`QUESTION_DETAIL_THREAD_AUDIT_2026-07-03.md`](QUESTION_DETAIL_THREAD_AUDIT_2026-07-03.md)             | 2026-07-22 | Tier 1 + composer + voice capture shipped; unlocked hierarchy is community-first and a session-deduped desktop share nudge follows contribution P1+P4+P6+P8+P11+P13                                                                       | Share nudge and failed-native-share fallback pass at desktop; confirmed absent at 390x844 with zero overflow; active-recording capture remains owed                                                                                                                                            |
...
| Admin surfaces                | [`ADMIN_SURFACES_AUDIT_2026-07-09.md`](ADMIN_SURFACES_AUDIT_2026-07-09.md)                             | 2026-07-27 | P0.1/P0.4 and P1 shipped; mobile command center, route rail/adaptation layer, category/client cards, consulting nav, asset bench, reactivation recipient activity, and shared unsubscribe states shipped; P0.2/P0.3/P2 remainder deferred | Representative 390x844 dark/light command-menu + Categories/Clients/Assets overflow, controls, and long-string pass; 2026-07-27 engagement/unsubscribe compiler and responsive-code pass, but both local browser sessions were signed out so authenticated real-data verification remains owed |
...
| Article evidence hooks        | [`PERSONALITY_ARTICLE_EVIDENCE_AUDIT_2026-07-26.md`](PERSONALITY_ARTICLE_EVIDENCE_AUDIT_2026-07-26.md) | 2026-07-26 | Mixed feature/compact hierarchy shipped locally: quieter citations, direct speaker labels, and relationship-era Talulah/Elon image; P2+P4+P5+P6+P8+P10+P19; Supabase publish deferred                                                     | Pass at 1100px/1440px and 390px; 5/5 images load after lazy scroll, zero overflow, empty consoles                                                                                                                                                                                              |
