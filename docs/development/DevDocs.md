...
Ok so i added some comments at the bottom of the article src/blog/people/drafts/Jordi-Hays.md, please assess the comments and see if we should add some more or address some parts based on that feedback. Do more research as needed and make the blog better. Also trim things that are overdone or duplicated so that everything is fresh and well done.
