<!-- docs/instagram/post-ideas/2026-05-19_personality-series-intro-arc-lineup.md -->

# Personality Analysis Series — Intro Arc Lineup
...
- **Caption:** Stack 2–3 lore beats → the question the lore raises → CTA → engagement bait
  ...
  **Source material:** Tidbits curated from `docs/instagram/post-ideas/2026-04-29_top-tier-people-tidbits.md`. Sanity-check any specific dollar/date/quote before publishing.
  **Fact-check pass (2026-06-09):** All 40 claims verified — 17 confirmed, 18 corrected, 5 unverified/cut. Corrections applied below. Receipts + sources: [`2026-06-09_intro-arc-fact-check.md`](./2026-06-09_intro-arc-fact-check.md). Tim Ferriss rebuilt from deep-cut research: [`docs/content-research/2026-06-09_tim-ferriss-deep-cuts.md`](../../content-research/2026-06-09_tim-ferriss-deep-cuts.md).
...
**Held for arc 2** (once account is warm): Peter Thiel (existing 10-slide carousel can be re-cut to 2-slide), Mark Zuckerberg, Margot Robbie, Sofia Vergara, Anne Hathaway, Steve Carell, Tyler Cowen, Robert Oppenheimer, Stalin, Trump, Putin, AOC, Malcolm X.

---

# Post 1 — Tim Ferriss

**Schedule:** Week 1 Tuesday
**Lore hook:** Was a lab rat in Daniel Kahneman's experiments. His first product sold two copies — one to his mom.
...
# Post 2 — Sabrina Carpenter

**Schedule:** Week 1 Friday
**Lore hook:** Her dad turned the family's "Harry Potter closet" into her studio. Then she wrote Espresso in a French ghost town.
**Why she's post 2:** Maximum 2026 cultural pull, save-magnet for Gen Z, and the lore is the funniest in the roster. Sets the tone that the series will swing in energy week to week instead of staying heavy.
...
```
1. In 2024 she married Jeremy Dufrene, an alligator-tour captain she
   met by taking his swamp tour. (94 / shocker)

2. She was drinking daily and alone by 14. Her parents sent her to
   boarding school to get sober. (92 / deep)

3. She spent her $10K record advance moving into a New Jersey trailer
   park. (71 / shocker)

4. She majored in philosophy at Fordham because it "bridged the gap
   between God and science." (90 / deep)

5. Brian Williams privately emailed that her SNL debut was "one of
   the worst outings in SNL history." (98 / deep)

6. "Venice Bitch" runs nine and a half minutes. Her label released it
   as a single anyway. (84 / shocker)
```

**Rhythm:** 3 shockers + 3 deep, alternating S-D-S-D-D-S. Opens on the swamp-boat marriage (strongest hook), closes light.

**Hold for stories:** She brings a leather club chair into the studio and listens to mixes on the beach between takes. (96) [re-verify before use]
...
```
1. Before a single Brat song was recorded, she wrote a 20-page
   manifesto breaking down every element. (98 / deep)

2. Her grandparents fled Idi Amin's Uganda with their money rolled up
   inside toothpaste tubes. (89 / deep)

3. At 14 she played illegal warehouse raves in east London. Her mom
   chaperoned, terrified. Her dad loved it. (104 / shocker)

4. "Boom Clap" was rejected by Hilary Duff's team: "not cool enough
   for Hilary." (75 / shocker)

5. She sent Lorde a voice note the day before Brat dropped. The remix
   took three days to make. (88 / deep)

6. Collins Dictionary named "brat" its 2024 Word of the Year. (56 / shocker)
```

**Rhythm:** 3 deep + 3 shockers, alternating D-D-S-S-D-S. Heaviest beat second (the refugee lore), closes short and light.

**Hold for stories:**

- After "kamala IS brat," the campaign's banner went Brat green within hours. (72) [arc 2, when account is warm]
...
```
1. After Atlantic Records dropped her in 2020, she worked the counter
   at a donut shop. (81 / shocker)

2. She grew up in church three times a week in Willard, Missouri. Her
   uncle is a Republican state rep. (100 / deep)

3. "Call me hot, not pretty" came from the school lunch line: "she's
   pretty but she's not like hot." (97 / deep)
...
**Rhythm:** 2 shockers + 4 deep — heavier mix on purpose; she carries the most cost-of-persona lore in the arc. Opens on the donut counter, closes on the $25K power move.

**Hold for stories:** Her Midwest Princess Project raised $400K+ for trans youth and LGBTQ+ communities. (86)
...
5. A wasp sting on a Griffith Park hike likely seeded the clot. Weeks
   later, a stroke took his left side. (102 / deep)

6. Five months after the stroke: "I still can't make my own
   breakfast... I can't wash dishes." (88 / deep)
```

**Rhythm:** 2 shockers + 4 deep — he's the thinker slot; the weight is the point. Opens on the 80 jobs, closes on the breakfast quote.

**Hold for stories:** His car has roughly 9,000 miles on it. He meditates 35–40 minutes every morning in lotus position. (105) [re-verify before use]
**Cut 2026-06-09:** Father's secret journalist dream — unverified, AI-aggregator sourcing only. Don't run without the original interview.
...
**Corrections 2026-06-09:** "less than $7" → "down to $7" (canonical telling, plus the Buffy residual check that saved him); "20 years" of the anxiety pose cut (unverified — coverage calls it his signature pose without dating it); embassy timeline fixed (parents hid six months, then refuge via the embassy); $600K reattributed to the whole Protect the Dolls campaign, not his birthday moment.
**Cut 2026-06-09 (was tidbit 6):** "2025 smear campaign → posted Trevor Project / Doctors Without Borders links" — unverified. Source it before ever using.
...
- [ ] Pull profile portrait, apply 9takes brand styling (teal/orange, name overlay)
- [ ] Design slide 2 with selected tidbits (legible at thumbnail size)
- [ ] Caption pasted into post body (NOT first comment)
- [ ] Pinned first-comment ready within 5 min of publishing
- [ ] Confirm IG bio link points to the correct `/personality-analysis/[slug]` page
- [ ] Schedule for 11a–1p or 7–9p Eastern (per saved-posts analysis)
- [ ] First-hour reply window blocked (respond within 10 min)
- [ ] Seed 3–5 name suggestions ready in case CTA needs priming
- [ ] Log into `docs/instagram/daily-engagement/` after the post lands

---

## Status legend

- ✅ **Built** — slide 2 tidbits + caption + pinned comment finalized, ready for design
- 🟡 **Sketched** — surface/underneath framing locked, tidbit pool curated, needs final cut + caption write
- ⚪ **Roster only** — facts exist in tidbits doc but not yet sketched for this format

---

## Next actions (updated 2026-06-09)

1. ~~Finalize posts 3–8~~ ✅ Done — all 8 posts built, fact-checked, captions + pinned comments ready.
2. DJ reviews the rebuilt Tim post (all-new deep cuts) and the Sabrina rebuild (bumblebee cut as unverified).
3. Verify the two flagged [verify before use] story-holds if you want them: Sabrina's pink-handcuff roster, Greene's 9,000-mile car.
4. Fix the bumblebee claim in the 9takes Sabrina blog itself (it's the circular source).
5. Decide whether the intro 2-slide carousel runs the week before, or the day before post 1.
6. Hand portraits + tidbit text to design.

---

## Open questions

- **Bio link strategy:** Single static link to `/personality-analysis` index, or rotate per post to the specific person's slug? (Single static = easier; rotating = more direct, but requires updating the bio every post.)
- **Reel companions:** Should each carousel post get a 15–30s Reel companion pulling 1 tidbit + the resolution line? (Recommended for at least posts 1, 3, and 8 — the anchor moments.)
- **Engagement seeding:** Should DJ pre-seed 2–3 throwaway-account replies in the first 5 min to model the CTA behavior? (Standard tactic, low-risk, high-leverage on a cold post.)
