...
## Claim 1 — Gen Z Self-Diagnosis Rate

**Claim in blog**: "A 2025 survey found that half of Gen Z has self-diagnosed a mental health condition based on social media content."

**Source**: LifeStance Health / Researchscape International Survey (2025)

- Survey dates: January 30 – February 9, 2025
- Sample size: 1,110 U.S. adults
...
## Claim 3 — ADHD/Autism Traits as Spectrum (Not Binary)

**Claim in blog**: "A 2021 philosophical analysis of genetic research argues that the traits underlying ADHD and autism are distributed continuously across the entire population — not as binary categories but as spectrums."

**Source**: Koi, P. (2021). Genetics on the neurodiversity spectrum: Genetic, phenotypic and endophenotypic continua in autism and ADHD. _Studies in History and Philosophy of Science Part A_, 89, 52–59.

- DOI/URL: https://www.sciencedirect.com/science/article/pii/S0039368121001072

**Accuracy**: Verified with clarification. The paper exists and supports the claim. Important caveats:

- Author is Polaris Koi, not "Warrier et al." (a different researcher sometimes conflated with this topic)
- This is a philosophy-of-science paper that synthesizes and analyzes existing genetic research — it does not present new primary genetic data. The blog's phrasing "philosophical analysis of genetic research" accurately reflects this.

---

## Claim 4 — Psyche Essay on "Cognitive Continuity"

**Claim in blog**: "A 2025 essay in Psyche goes further, arguing we should think of neurodiversity the same way we think of personality: as 'cognitive continuity,' where neurodivergent traits and personality traits exist on the same sliding scale."

**Source**: Psyche / Aeon Media (published May 27, 2025)
...
**Accuracy**: Verified. The article exists at that URL, uses the phrase "cognitive continuity," and makes exactly the argument described.

---

## Claim 5 — Enneagram Systematic Review

**Claim in blog**: "A 2021 systematic review of 104 independent samples (Hook et al., Journal of Clinical Psychology) found measurable relationships between Enneagram types and established psychological constructs like the Big Five."
...
## Claim 6 — Enneagram and Ego Development
