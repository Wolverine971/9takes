<!-- docs/project-docs/9TAKES-REFERENCE.md -->

# 9Takes Book Reference Guide

book directory- /Users/djwayne/Desktop/book-pics

**Project:** 9Takes - Enneagram-based Reddit/community platform
**Focus:** Personality content, community building, user engagement

This document contains frameworks, concepts, and insights from the book collection relevant to 9Takes development and content.
...
4. **The Enneagram Workbook**
5. **The Story of You** (Ian Morgan Cron)
6. **The Enneagram** (Klaus Vollmar) - Comprehensive guide
...
- "To the part of you that fears being average" (Type 4)
- "To the part of you that fears depletion" (Type 5)
- "To the part of you that fears letting others down" (Type 6)
- "To the part of you that fears being trapped" (Type 7)
- "To the part of you that feels it must be strong" (Type 8)
- "To the part of you that feels it must be easy to get along with" (Type 9)
...
- Fundamental Attribution Error - Why we blame people, not situations
- Groupthink - Why groups make bad decisions
- Spotlight Effect - Why we think people notice us more than they do

**Content angle:** "How each Enneagram type falls for [X bias]"
...
- **Two kinds of belief** - Reality vs. mythology
- **The marshmallow experiment** - Present vs. future self conflict

**Content angle:** "Why Type [X] struggles with [cognitive bias]" - deeper psychological content
...
- Community norms matter - they shape beliefs
...
**For 9Takes:** Encourage scout mindset in discussions. Frame questions that invite exploration, not defense.
...
1. **Make War, Not Love** - Define an enemy/opposition
2. **Create Your Own Secret Society** - In-group identity
3. **Perfect Your Packaging** - Visual/brand consistency
4. **Give the Little Babies Their Milk** - Start with easy wins
5. **Become a Trickster** - Defy expectations
6. **Become a Magus** - Cultivate mystique
7. **Find a Void and Fill It** - Occupy uncontested space
8. **Make It Scientific** - Back claims with data
9. **Prayers, Spells, and Symbols** - Rituals and shared language
10. **Embrace Theater and Drama** - Make it memorable
11. **Set Down a Rock** - Give followers something to rally around
...
- "Make war" - Position against surface-level personality tests?
...
### Outsmarting the Sociopath Next Door (Folder: 38-Outsmarting-the-Sociopath-Next-Door)

**Content angle:** "Healthy vs. unhealthy expressions of each type" - without pathologizing, discuss when type patterns become problematic.

---

### Shadow Work Books (Folder: 04-A-Guide-to-Shadow-Work)

**Content angle:** Shadow work and the Enneagram - each type's shadow material, integration paths.
...
- Thursday: Type 4 content (deep dive day)
- Friday: Type 5 content (learning day)
- Saturday: Types 6-7 (social/fun content)
...
4. **"[Type]'s biggest blind spot"** - Growth-oriented
5. **"When [Type] is healthy vs. unhealthy"** - Nuanced takes
