...
let root = URL(fileURLWithPath: "output/personality-analysis-experiment/batch-type3-next-10")
let inputName = CommandLine.arguments.count > 1 ? CommandLine.arguments[1] : "source.jpg"
let people = CommandLine.arguments.count > 2 ? Array(CommandLine.arguments.dropFirst(2)) : allPeople
