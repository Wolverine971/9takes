// output/personality-analysis-experiment/batch-type4-next-10/key-green-sources.mjs
import sharp from 'sharp';

const root = 'output/personality-analysis-experiment/batch-type4-next-10';
const people = ['hunter-biden', 'maddie-phillips'];

for (const slug of people) {
	const input = `${root}/${slug}/source.jpg`;
	const output = `${root}/${slug}/cutout.png`;
