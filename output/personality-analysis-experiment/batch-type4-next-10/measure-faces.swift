...
let people = [
    "adam-driver", "colleen-hoover", "frank-ocean", "hunter-biden", "janelle-monae",
    "jonathan-groff", "machine-gun-kelly", "maddie-phillips", "nicholas-galitzine", "oscar-isaac",
]
let root = URL(fileURLWithPath: "output/personality-analysis-experiment/batch-type4-next-10")
...
for slug in people {
    let inputURL = root.appendingPathComponent(slug).appendingPathComponent("source.jpg")
