...
let people = [
    "christopher-nolan", "daniel-day-lewis", "steve-martin", "yang-zhilin", "zach-king",
    "daniel-radcliffe", "jimmy-kimmel", "john-krasinski", "noah-wyle", "sadie-sink",
]
let root = URL(fileURLWithPath: "output/personality-analysis-experiment/batch-types5-6-next-10")
let greenSources = Set(["daniel-day-lewis", "steve-martin", "yang-zhilin", "zach-king", "jimmy-kimmel", "sadie-sink"])
