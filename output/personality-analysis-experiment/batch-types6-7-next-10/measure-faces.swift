...
let people = [
    "samara-weaving", "volodymyr-zelensky", "zooey-deschanel", "florence-pugh",
    "jeff-goldblum", "julia-roberts", "ksi", "lele-pons", "lizzo", "marie-antoinette",
]
let root = URL(fileURLWithPath: "output/personality-analysis-experiment/batch-types6-7-next-10")
let greenSources = Set([
	"samara-weaving", "zooey-deschanel", "florence-pugh", "jeff-goldblum", "julia-roberts", "ksi", "lele-pons", "lizzo",
	"marie-antoinette",
])
...
for slug in people {
    let filename = greenSources.contains(slug) ? "source.png" : "source.jpg"
