// output/personality-analysis-experiment/batch-types7-8-next-10/build-portraits.mjs
...
const defaultPeople = [
	{
		...
		width: 941,
		height: 1672,
		left: [418.428, 525.977],
		right: [569.705, 531.087],
		correction: -1.935,
		eyeDistance: 160
	},
	{
		...
		width: 1024,
		height: 1536,
		left: [470.552, 409.382],
		right: [620.949, 424.412],
		correction: -5.707,
		eyeDistance: 160
	},
	{
		slug: 'stavros-halkias',
		name: 'Stavros-Halkias',
		width: 1024,
		height: 1536,
		left: [447.703, 527.62],
		right: [601.142, 522.617],
		correction: 1.867,
		eyeDistance: 160
	},
	{
		...
		width: 1023,
		height: 1537,
		left: [444.196, 524.178],
		right: [611.004, 526.751],
		correction: -0.884,
		eyeDistance: 160
	},
	{
	...
	},
	{
		...
		width: 1024,
		height: 1536,
		left: [438.494, 496.474],
		right: [569.842, 503.052],
		correction: -2.867,
		eyeDistance: 160
	},
	{
		...
		width: 1023,
		height: 1537,
		left: [406.045, 481.311],
		right: [578.155, 471.502],
		correction: 3.262,
		eyeDistance: 160
	},
	{
		...
		width: 1023,
		height: 1537,
		left: [449.963, 547.999],
		right: [610.238, 551.751],
		correction: -1.341,
		eyeDistance: 160
	},
	{
		...
		width: 1024,
		height: 1536,
		left: [423.887, 453.394],
		right: [587.205, 450.096],
		correction: 1.157,
		eyeDistance: 160
	},
	{
		...
		width: 1054,
		height: 1492,
		left: [460.159, 388.264],
		right: [621.659, 397.884],
		correction: -3.409,
		eyeDistance: 160
	}
];
const requestedPeople = process.argv.slice(2);
const people = requestedPeople.length
	? defaultPeople.filter(({ slug }) => requestedPeople.includes(slug))
	: defaultPeople;
