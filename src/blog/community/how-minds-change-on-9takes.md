---
title: 'How Minds Actually Change'
description: 'The psychology of why facts fail, what actually moves beliefs, and how conversation design makes the difference.'
author: 'DJ Wayne'
date: '2026-02-17'
loc: 'https://9takes.com/community/how-minds-change-on-9takes'
lastmod: '2026-02-18'
changefreq: 'monthly'
priority: '0.7'
published: true
type: ['idea']
blog: true
previewHtml: 'Why facts alone never win arguments — and the psychology of what actually does.'
pic: 'greek-statues-rethinking-together'
path: src/blog/community/how-minds-change-on-9takes.md
---

<!--
Midjourney prompt:
three classical Greek statues in active debate on marble steps, one pointing at a scroll (logic), one hand on heart (emotion), one writing in a wax tablet (reflection), subtle glowing thread connecting their heads to symbolize belief updating, warm sunset + cool blue contrast, dramatic chiaroscuro, cinematic depth, high-detail stone texture, hopeful intellectual atmosphere, editorial composition --ar 16:9 --stylize 700

Image intent:
Show mind change as a process with three layers: thought, relationship, and structure.
-->
...
<script type="application/ld+json">
{
  ...
  "@type": "BlogPosting",
  "headline": "How Minds Actually Change",
  "description": "The psychology of why facts fail, what actually moves beliefs, and how conversation design makes the difference.",
  "author": {
    "@type": "Person",
    "name": "DJ Wayne",
  ...
  "url": "https://9takes.com/community/how-minds-change-on-9takes",
  "image": {
    "@type": "ImageObject",
    "url": "https://9takes.com/blogs/greek-statues-rethinking-together.webp",
    "width": 1600,
    "height": 900
  },
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://9takes.com/community/how-minds-change-on-9takes"
  }
}
</script>
...
Grant opens _Think Again_ with an observation from psychologist Phil Tetlock that's so accurate it stings. When we think and talk, we unconsciously slip into the mindset of one of three professions: **preacher, prosecutor, or politician.**
...
<VisualMetaphor title="The Scientist Mode">
<p>Grant's alternative is the <strong>scientist mode</strong> — treating your beliefs as hypotheses instead of identities. In scientist mode, being wrong isn't failure. It's data. You actively look for reasons you might be mistaken. You separate your ego from your ideas. You ask yourself: <em>"What evidence would change my mind?"</em> and you mean it.</p>
<p>In preacher mode, changing your mind is weakness. In scientist mode, it's intellectual integrity. In prosecutor mode, being persuaded is defeat. In scientist mode, it's a step toward accuracy.</p>
</VisualMetaphor>
...
But personal rethinking only gets you halfway. What about the person across the table — the one whose eyes glazed over? How do you help _them_ update?
...
<div class="source-card">
  ...
  <div>
    <div class="source-card__title">How Minds Change by David McRaney</div>
    <div class="source-card__meta">Chapter 2: Deep Canvassing</div>
    <div class="source-card__note">"After more than fifteen thousand conversations, most recorded so they could analyze each exchange, the LAB had slowly honed a method so fast and reliable that social scientists began buying plane tickets to study it."</div>
  </div>
</div>
...
That was the moment. Not data. Not argument. A question that connected the abstract policy to a real person in her real life. The canvasser didn't lecture. Didn't correct. Just listened, and asked one more question: _"Have you ever been treated unfairly for being different? What did that feel like?"_

The results stunned political scientists. A study by researchers David Broockman and Joshua Kalla, published in _Science_, found that **a single 10-minute deep canvassing conversation changed approximately one in ten people's attitudes toward transgender rights.** The change wasn't superficial — it lasted at least three months, with no signs of backsliding. For context, that single conversation produced a shift larger than the average decrease in American homophobia from 1998 to 2012.
...
<InsightBox title="The Missing Layer" tone="info">
<p>Even brilliant personal rethinking and masterful conversation technique collapse when they happen inside a system designed to reward the opposite. You can be a perfect scientist in your own head and a compassionate deep canvasser in your approach — but if the platform you're on rewards dunking, mimicry, and performative certainty, your skills are swimming against the current.</p>
</InsightBox>
...
**Your own willingness to rethink** (the scientist mindset from _Think Again_). Without this, you're just performing — preaching, prosecuting, or politicking your way through conversations that were dead on arrival.

**The skill to create safe conversations** (the deep canvassing insight from _How Minds Change_). Reflect before rebutting. Ask "how" questions, not trap questions. Show genuine curiosity about how someone arrived at their view. Let them do their own updating.
...
Say a polarizing question gets posted. On most platforms, the default pattern is identity signal, outrage spiral, side-taking, zero movement. On 9takes, the pattern shifts: independent first response, slower comparison, less imitation, and better odds of arriving at something like _"I still disagree, but I see your logic."_
...
Here's where the [Enneagram](/enneagram-corner/beginners-guide-to-determining-your-enneagram-type) layer comes in, and probably not in the way you'd expect.
...
_Which mode am I in right now — preacher, prosecutor, or politician?_

_What is the other person protecting — and can I name it without judgment?_

_What evidence would actually change my mind about this?_
