...
The Greeks formed many aspects of western thought. However today we don't have a place to follow one of their most important practices. And that is openly talking about philosophy through asking questions. The Socratic method is sometimes still talked about in college classrooms but it remains an obscure relic from the past. We need to bring it back.

Plato used to ask open questions and talk through different trains of thought in the agora. The agora was the open marketplace where people congregated and ideas spread. Today we have Twitter and Reddit but open questions are not talked through like they were back in ancient Greece.
...
Twitter, Reddit, and Facebook were designed for engagement, not understanding. They optimize for:

| Social Media Optimizes For | Greeks Optimized For |
| -------------------------- | -------------------- |
| Quick reactions            | Deep reflection      |
| Winning arguments          | Seeking truth        |
| Tribal identity            | Individual reasoning |
| Content consumption        | Idea exploration     |
| Algorithmic curation       | Personal inquiry     |

The result? We're more connected than ever but understand each other less than ever.
...
Like Socrates, we believe the quality of your questions determines the quality of your understanding. Every conversation on 9takes starts with a question, not a statement or opinion.

### 2. Multiple Perspectives by Design

The Greeks understood that truth often lies at the intersection of competing viewpoints. The "9 takes" in our name refers to the nine Enneagram personality types—each offering a distinct lens on any question. You don't just see one take, you see how different types of minds approach the same issue.

### 3. Think Before Reacting

The Greek academy required students to listen and consider before responding. On 9takes, you must submit your own answer before seeing what others have said. This prevents groupthink and ensures every voice is genuinely independent.

### 4. Anonymous Discourse

In the agora, ideas were debated on their merits, not based on who said them. 9takes allows anonymous participation, letting your thoughts stand independently of your identity, status, or follower count.
...
### What Socrates Would Have Loved About 9takes

1. **Questions that reveal character**: The Greeks believed character determined destiny. On 9takes, questions reveal different personality types' approaches to the same situation.

2. **No rushing to consensus**: Socrates was famously unpopular because he wouldn't let conversations end prematurely. 9takes doesn't have upvotes or popularity metrics that force conformity.

3. **Emotional honesty**: The Greeks studied pathos (emotion) alongside logos (logic). 9takes embraces that our emotional responses to questions are valid data, not noise to be eliminated.

## The Modern Agora: Building Digital Spaces for Real Discourse

The physical agora served multiple functions:

- **Marketplace of ideas**: Where new concepts were tested against scrutiny
- **Democratic space**: Where every citizen (albeit limited by their standards) had a voice
- **Learning environment**: Where students encountered diverse teachers
- **Community hub**: Where relationships formed through shared inquiry

9takes attempts to recreate these functions digitally:

| Agora Function   | 9takes Implementation                                  |
| ---------------- | ------------------------------------------------------ |
| Testing ideas    | Submit your take before seeing others                  |
| Democratic voice | Personality type tags level the field                  |
| Learning         | See how other types think about your question          |
| Community        | Connect through shared inquiry, not tribal affiliation |
