---
title: 'Enneagram Social Styles: The Hornevian Triads, Decoded'
description: "Three social styles. Three core wants. Nine types. Read the field guide that turns Karen Horney's framework into a tool you can actually use."
author: 'DJ Wayne'
date: '2026-05-04'
loc: 'https://9takes.com/enneagram-corner/enneagram-social-styles'
lastmod: '2026-05-04'
changefreq: 'monthly'
priority: '0.7'
published: true
...
path: src/blog/enneagram/enneagram-social-styles.md
---
...
<script>
	...
	import HornevianMatrix from '$lib/components/blog/HornevianMatrix.svelte';
</script>

<QuickAnswer question="What are the Enneagram social styles?">
The Enneagram social styles — also called the Hornevian Triads — group the nine types by how they go after what they want. <strong>Assertive</strong> types (3, 7, 8) push into the world. <strong>Compliant</strong> types (1, 2, 6) work the rules. <strong>Withdrawn</strong> types (4, 5, 9) step back and process inside. The framework comes from psychoanalyst Karen Horney, who found that everyone runs all three moves — but each Enneagram type has a default.
</QuickAnswer>

**Read time**: 13 minutes | **Key insight**: Your social style is the move you keep making when you don't know what else to do.

<p class="firstLetter">Three people sit through the same tense meeting.</p>
...
In 1945, psychoanalyst Karen Horney published _Our Inner Conflicts_. She argued that everyone resolves the basic tension of being human in one of three ways. You move **against** people (assert yourself). You move **toward** people (comply with them). Or you move **away from** people (withdraw).
...
Inside each social style, the three types are each chasing a _different_ core need. Look at this grid:
...
Horney's term was "moves against," but that's misleading. They're not necessarily moving against _you_. They're moving against the resistance of the world. The world feels like a thing to be acted on.
...
**Type 3 — the Assertive who wants attention.** The Three performs the version of themselves the room is rewarding. When the room shifts, the performance updates. They're not lying. They're optimizing. The Three pushes by _being whatever is winning right now_.

**Type 7 — the Assertive who wants security.** Sevens buy safety with options. If this thing fails, three more are queued up. They push not by overpowering but by _outrunning_ — staying so far ahead of pain that pain can't catch up. Their assertion is forward motion.
...
<InsightBox tone="info" title="A note for the Assertive reader">
If this is your style: the people who go quiet around you are not agreeing with you. They are filing the moment for later. The room you think you won, you didn't. Build the habit of asking "What did you actually think?" — and waiting through the silence for a real answer.
</InsightBox>
...
Don't read "compliant" as "pushover." The technical term is **superego-driven** — they're listening to an internal voice of _should_, _ought_, _responsible_. That voice can be ferocious. A 1 in moral conviction or a 6 with their cause locked in is anything but soft.
...
**Type 2 — the Compliant who wants attention.** Twos believe that if they love hard enough, they'll be loved back. They earn attention by becoming indispensable to specific people. Under stress, the helping intensifies — and the resentment underneath quietly compounds. The 2's compliance is _relational_: they're meeting the unwritten rules of love.

**Type 6 — the Compliant who wants security.** Sixes believe that if they're loyal to the right authority, the authority will keep them safe. Their compliance is _systemic_: institution, doctrine, expert, leader, group. Under stress, they either double down on their loyalty or rebel against it and find a new authority — which is just the same pattern in reverse.

### How to spot it

Frequent invocation of _should_, _supposed to_, _the right way_, _responsible_, _fair_. Apologizes for resting. Mentions the rule before the want. Has a hard time saying "I just want this" without justifying it first.
...
Compliant types believe virtue is a currency. They've paid in. They expect the universe to pay out. When it doesn't — and it often doesn't — the resentment is quiet, structured, and corrosive. They become _bitter rule-followers_, which is a worse fate than the one they were trying to avoid.
...
<InsightBox tone="info" title="A note for the Compliant reader">
If this is your style: the rule isn't keeping you safe. It's keeping you small. Most of the rules running your day-to-day are not load-bearing. Audit them. Try a small one this week and see if anything actually breaks. Usually nothing does. That's information.
</InsightBox>
...
Withdrawn does not mean weak. A 4 in a fight, a 5 with a sharp idea, or a 9 who finally puts a foot down can flatten a room. The withdrawal is a _strategy_, not an absence of force.
...
<InsightBox tone="info" title="A note for the Withdrawn reader">
If this is your style: the world will not come find you. It will fill the silence with its own story about you, and that story is almost never accurate. Your underestimation of your own gravity is itself a problem. Pick one place this week to show up before you're ready and watch what happens.
</InsightBox>
...
| ----------------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------------- |
| **Social Styles / Hornevian Triads** _(this article)_ | How you go after what you want             | Assertive 3, 7, 8 · Compliant 1, 2, 6 · Withdrawn 4, 5, 9        |
...
Want a sharper read? [Take the full Enneagram typing flow](/enneagram-test) — it cross-checks your social style against your core motivations.

## The growth arc each style is hiding from

Karen Horney's original point — the one Enneagram pop culture often loses — was that all three moves are _resolutions of inner conflict_. They're how you avoid feeling the parts of yourself the move is hiding.

Reclaiming the buried part is the whole game.

<Checklist title="The reclamation, by style" items={[
'<strong>Assertive (3, 7, 8)</strong> — Risk feeling what you actually feel before the room sees it. Practice: one moment a day where you name an internal state before acting on it.',
'<strong>Compliant (1, 2, 6)</strong> — Catch yourself obeying a rule no one wrote. Practice: each evening, pick one "should" from your day and ask whose voice it was.',
'<strong>Withdrawn (4, 5, 9)</strong> — Show up before you are ready. Practice: pick one conversation this week where you say the unfinished version of your thought out loud.'
]} note="The practice is small on purpose. Big resolutions are also Assertive moves. Compliant moves. Withdrawn moves. The pattern follows you into the gym." />
...
The **Hornevian groups** sort types by _how they pursue what they want_ (Assertive / Compliant / Withdrawn). The **Harmonic groups** — also from Riso and Hudson — sort types by _how they cope with conflict and disappointment_: Positive Outlook (9, 2, 7) reframe and look on the bright side; Competency (3, 1, 5) detach and try to solve it; Reactive (4, 6, 8) feel it out loud and demand engagement. Two different lenses, both useful, frequently confused.
