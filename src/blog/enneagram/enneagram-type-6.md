...
1. Your security strategies fail
2. Anxiety exceeds what you can manage
3. Shift from "we" to "me" thinking
4. Image becomes armor against judgment
5. Your real concerns get buried under achievements
6. Isolation increases despite surface success
7. Core fears intensify behind the facade you're maintaining

This isn't vanity. It's desperation. When your usual support systems fail, vulnerability becomes unbearable. The unconscious logic: _If I can't trust anyone else, I'll become so successful, so competent, so impressive that I won't need to depend on anyone._
...
- _Phobic_: Builds alliances, seeks consensus, worries about job security, needs clear expectations, excels at risk assessment
- _Counterphobic_: Challenges authority publicly, takes on risky projects to prove something, becomes the whistleblower, pushes back against bad ideas even when it's politically stupid to do so

**In relationships:**

- _Phobic_: Asks "are we okay?" frequently, seeks physical proximity when anxious, shares worries openly, needs verbal reassurance
- _Counterphobic_: Creates distance when scared, picks fights instead of admitting fear, tests partners by withdrawing to see who pursues, mistakes intensity for intimacy

**Under stress:**

- _Phobic_: Becomes more clingy and dependent, seeks more reassurance, catastrophizes openly
- _Counterphobic_: Becomes more aggressive and confrontational, takes bigger risks, dismisses their own fear as weakness
...
**"Once I feel safe, I'll relax."** Safety isn't a destination. The conditions you're waiting for will never be perfect enough. Learning to relax _while uncertain_ is the skill. Waiting for certainty is infinite waiting.
...
This isn't distraction. It's anchoring. Your fear lives in projected futures. Your body lives in the present. Pull attention into immediate sensory experience, and you give your nervous system evidence that _right now_, you're safe. The catastrophe is in your mind. Reality is here.
...
**The Trust Practice**
Daily, take one small action without seeking reassurance. Order something without checking reviews. Make a decision without polling friends first. Notice that you survive. Build evidence that your judgment works.

**The Fear Inventory**
Write down what you're afraid of. Next to each fear: "What if I could handle this?" Not "this won't happen" but "what if I could navigate it if it did?" Shift from "prevent the worst" to "navigate whatever comes."

**The Body Check**
When anxiety rises, return to physical sensation. Where are your feet? What can you hear? Anchor in the present. Your fear lives in the future. Your body lives in now.

**The Courage Collection**
Keep a record of times you acted despite fear. Build evidence of your own bravery. You're more courageous than you give yourself credit for.
...
When you trust your own inner authority, you stop seeking external validation for internal knowing. Not the false security of guarantees (those don't exist) but the real security of knowing _you can handle this_. Vigilance becomes wisdom. Questioning becomes discernment. Fear transforms into faith.
...
`Routines, systems, and clear guidelines make you feel safer. Ambiguity feels threatening.`,
`Your inner circle is small but fiercely trusted. Getting in is hard. Staying in is easy.`
]}
note="If six or more of these resonate, you likely have strong Type 6 patterns. Everyone contains aspects of all nine types, but one or two usually dominate."
/>
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Person",
      "description": "Enneagram Type 6, The Loyalist, is characterized by vigilance, loyalty, and a complex relationship with authority. They seek security while constantly questioning what can be trusted.",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Growth involves developing inner authority and self-trust. Moving toward healthy Type 9 patterns means learning that the solid ground you seek externally exists within you. The journey is from fear to courage: not eliminating fear but learning to move despite it. Practice making small decisions without seeking reassurance. Build evidence of your own capability."
          },
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sixes make exceptional friends and partners because their loyalty is unconditional once trust is earned. They show up during hard times when others disappear. They remember what matters to you and check in without being asked. They defend you behind your back. They stay when staying is difficult. Their vigilance becomes protection for those they love."
          },
          "name": "Why do Sixes make such loyal friends?"
        },
        {
          "@type": "Question",
          "acceptedAnswer": {
...
<!--
## SECOND PASS REVIEW (Jan 2026)

### Completed Edits (Jan 29, 2026)

**Redundancies Fixed:**
✅ "100% survival rate" - Removed from Fear Inventory, kept in Holy Idea section where it lands better
✅ Counterphobic/8 mistyping - Removed from Phobic vs Counterphobic section, consolidated to Mistyping section
✅ Authority dynamics - Refocused Workplace section on leadership changes/recalibration, removed overlap with Authority Paradox

**Sections Trimmed:**
✅ "Voices from the Watchtower" intro paragraph - Removed filler, kept "In Their Own Words" heading
✅ Checklist - Trimmed from 12 to 9 items, consolidated overlapping items (reassurance, problem-spotting)

**Content Added:**
✅ Childhood section expanded - Added "Common Six Origin Patterns" with specific scenarios (unreliable protector, reversed roles, rule betrayal, sudden shift)
✅ "How You Love" section - Shows how Sixes express love positively (showing up, defending, staying, preparing)
✅ "For Partners of Sixes" expanded - Added what builds trust, what erodes trust, signs they truly trust you
✅ "The Holy Idea: Faith" section - Explained the spiritual/existential concept of Faith for Sixes
✅ "What Healthy Sixes Actually Do" - Concrete behavioral examples of integration
✅ Stress mechanism expanded - Added psychology explaining WHY Sixes go to 3 (vulnerability → self-sufficiency through achievement)
✅ "5-4-3-2-1 Grounding Protocol" - Specific body practice with explanation
✅ "What Sixes Get Wrong About Themselves" - Added after Projection section

**Minor Polish:**
✅ Wing section intro - Added explanation of naming convention (Defender = knowledge/self-reliance, Buddy = connection/alliance)
✅ FAQ schema - Added two new questions: "Why do Sixes make such loyal friends?" and "How can I tell if I'm a phobic or counterphobic Six?"

**Not Changed:**
- Article structure/order - Left as is; the current flow works well enough and reordering risks introducing new issues
- Ground metaphor at line 257 - Changed to "security map gets scrambled" instead

### Remaining Considerations for Future Passes
- Could add more about Six in leadership roles
- Consider adding a section on Six + specific relationship pairings
- Word count has increased; may need trimming if it feels too long
-->
