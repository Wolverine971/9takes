...
>
  <PopCard
		...
		showIcon={false}
		displayText=""
    altText="a greek statue representing someone being ghosted on dating apps"
    tint={false}
		subtext=""
	/>
</div>
...
>
  <PopCard
		...
		showIcon={false}
		displayText=""
    altText="greek statues looking at phones representing modern dating and ghosting culture"
    tint={false}
		subtext=""
	/>
</div>
...
<svelte:head>
 ...
 <script type="application/ld+json">
  ...
  "keywords": ["ghosting", "Enneagram types", "dating rejection", "online dating", "relationship problems", "healing from ghosting", "personality types", "modern dating", "dating apps", "emotional healing"],
  "mentions": {
              "@type": "Thing",
