---
title: 'How Each Enneagram Type Self-Sabotages Success (And How to Stop)'
...
<QuickAnswer question="Why do I keep sabotaging my own success?">
Every Enneagram type has a predictable self-sabotage pattern rooted in childhood protection mechanisms. Type 1s paralyze themselves with perfectionism. Type 7s start everything but finish nothing. Type 9s procrastinate into oblivion. Understanding your specific pattern is the first step to breaking it.
</QuickAnswer>

<p class="firstLetter">You scrapped a project the night before launch because one section wasn't right. You said yes to everyone else's priorities and forgot your own existed. You researched the "best approach" until the opportunity vanished.</p>
...
Your [Enneagram type](/enneagram-corner/beginners-guide-to-determining-your-enneagram-type) predicts the exact way you shoot yourself in the foot. Type 1s rewrite the email five times, then don't send it. Type 3s achieve everything on the checklist and feel nothing. Type 6s prepare so thoroughly for failure that they never risk success. Each pattern made sense in childhood. Each one costs you now.

This guide maps the specific sabotage loop for all nine types, then gives you the interrupt. If you want a practical system to pair with this awareness, start with [productivity systems by Enneagram type](/how-to-guides/productivity-systems-by-enneagram-type).
...
- Power _with_ others produces more than power _over_ others
...
| ---- | ---------------------- | ---------------------- | ------------------------------ | ----------------------------- |
| 1    | Being bad/corrupt      | Perfectionism          | Paralysis by perfectionism     | "Done is better than perfect" |
| 2    | Being unloved          | People-pleasing        | Martyrdom, burnout             | Non-negotiable self-time      |
| 3    | Being worthless        | Achievement-chasing    | Workaholism, identity collapse | Practice just "being"         |
| 4    | Having no identity     | Emotional intensity    | Comparison, creative blocks    | Create on a schedule          |
| 5    | Being incompetent      | Knowledge hoarding     | Analysis paralysis             | Ship before you're ready      |
  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "Which Enneagram types are most prone to self-sabotage?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "All types self-sabotage, but the patterns are more visible in some than others. Types 4, 5, 6, and 9 often show clearer patterns because their defenses involve withdrawal or avoidance. Types 1, 3, and 8 may sabotage through overwork and rigidity. Types 2 and 7 through over-extension and scattered focus."
          }
        },
        {
          "@type": "Question",
          "name": "How do I actually stop self-sabotaging?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "First, identify your type's specific pattern. Then practice the opposite behavior in small doses. Type 1s should practice intentional imperfection. Type 7s should finish something before starting anything new. Type 9s should state a preference without qualifying it. Small pattern interruptions build new neural pathways."
          }
        },
        {
          "@type": "Question",
