...
| ---------- | --------------------- | ---------------- | ------------------------- | ---------------------------------------- |
| **Type 1** | Perfectionist anxiety | Making mistakes  | Jaw clenching, tension    | Do something intentionally imperfect     |
| **Type 2** | Rejection anxiety     | Being unneeded   | Heart palpitations        | Identify one of YOUR needs               |
| **Type 3** | Failure anxiety       | Public failure   | Insomnia, chest tightness | Name a quality unrelated to achievement  |
| **Type 4** | Identity anxiety      | Feeling ordinary | Fatigue, appetite changes | Name the emotion without a story         |
| **Type 5** | Depletion anxiety     | Mental overwhelm | Tension, disconnection    | Move your body for 2 minutes             |
| **Type 6** | Security anxiety      | Uncertainty      | Muscle tension, scanning  | Name one thing that is certain right now |
| **Type 7** | Constraint anxiety    | Boredom, pain    | Restlessness              | Sit with one feeling for 60 seconds      |
| **Type 8** | Vulnerability anxiety | Loss of control  | High blood pressure       | Clench everything, then release          |
| **Type 9** | Conflict anxiety      | Confrontation    | Fatigue, numbness         | State one preference out loud            |
...
That's Type 1 anxiety. Not panic. Not catastrophizing. A relentless internal pressure that says _you haven't gotten it right yet_.
...
Five anxiety is resource anxiety. Not money (though maybe that too) — time, energy, mental bandwidth. Fives fear depletion, intrusion, and being caught unprepared. The anxiety lives in the head, which is ironic because Fives already live there. The body barely gets consulted.
...
1. Identify one thing that is certain right now — not probably, not likely, _certain_
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Type 6 is most associated with anxiety because their pattern maps closely onto generalized anxiety disorder. But every type has a high-anxiety version. Type 1s, 2s, and 4s show comparable anxiety levels when measured by different criteria."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Your core type doesn't change, but you may exhibit traits of your stress direction. Under anxiety, Type 1s can look like unhealthy 4s, Type 6s like unhealthy 3s, and Type 9s like unhealthy 6s. These are predictable stress responses, not type changes."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For Body types (8, 9, 1): Offer physical grounding. For Heart types (2, 3, 4): Validate emotions without fixing, remind them of their worth beyond performance. For Head types (5, 6, 7): Give information and time, don't dismiss concerns, help them return to present reality."
          }
        },
        {
          "@type": "Question",
          "name": "Should I consider medication for anxiety? Does Enneagram type matter?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Anxiety medications work on neurochemistry, not personality type. However, your type may shape the concerns you bring to that conversation. The Enneagram is a self-awareness tool, not a clinical framework, so let your doctor guide medical decisions."
          }
        }
      ]
    }
