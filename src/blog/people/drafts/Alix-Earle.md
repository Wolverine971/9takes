...
production_pretext:
  ...
  reviewed_notes: 'Fresh-eyes reader feedback incorporated: added Tyler Wade (first merger pattern), Ashtin Earle, plastic surgery candor, Hot Mess format, Hi babes voice, Ashley Dupré relationship depth. Trimmed Princeton GEO line, Cooper from intro, Tom Brady from lede, Spitzer re-mention, redundant DWTS clinical line. Sorority point not adopted (Sigma Kappa unconfirmed in research).'
...
Current-tense anchor: May 12, 2026 Today show appearance ("No, it's exaggerated. I love everyone.") — two days before publication.
...
The visible half is the achievement: Forbes 30 Under 30 in 2024, the inaugural TIME100 Creators list in 2025, a brief Spotify #1 that knocked Cooper's own podcast to second, second place on _Dancing with the Stars_. Most analysts read that résumé and reach for Type 3, the Achiever. It's an understandable read. It also explains nothing about the texture.
...
That same month, on _DWTS_'s Dedication Night, Alix and Izabel performed a contemporary dance together. The judges scored it 35 out of 40. The audience felt it was higher. The grievance about the score — almost universal on TikTok — was carried by other people. Alix herself did not lead the complaint.
...
<!-- FACT-CHECK VERIFICATION PASS — 2026-05-14
Surgical corrections after primary-source verification:
- Opening rebuilt: dropped unsourceable "I also have no idea what's going on" Unwell-tied quote. Replaced with sourceable WSJ quote "behind the scenes, a little bit of a hot mess" — same phrasing as her show title, strengthens the self-observation framing.
- Spotify claim corrected: Hot Mess pushed Cooper's Call Her Daddy to #2, NOT Joe Rogan (Tubefilter, Sep 26 2023). Added "three years before the two would feud publicly" callback.
- Forbes 30 Under 30: 2024 (announced Nov 2023), not 2023.
- Removed unverified Poppi "early investment" claim (no primary source for her equity stake; she was a paid promoter).
- TIME100 Creators: noted as "inaugural" (July 9 2025).
- Forbes earnings de-specified: dropped "lifestyle-and-beauty" qualifier; $8M is total earnings figure, not category-sliced.
- Gymshark reframed: lawsuit filed 2024 (not 2023), Gymshark CUT the deal over her pro-Israel post following October 7, settled $1M early 2025. Previous "unpaid sponsorship" framing was factually misleading.
- Veneers quote: actual verbatim "I regretted it right away" (not "I really regretted it, like right away"). Added "she went in wanting two" detail (sourced HuffPost/Today, July 2025).
- Cooper TikTok: removed unverifiable "fifteen-minute" length qualifier.
- Today show quote: replaced paraphrase with verbatim "Why ruin such a good day with something not so great?" (NBC/Today, May 12 2026).
- DWTS: removed unverifiable "six days a week" training detail.
- Dedication Night: Oct 14 2025, concurrent with the October babysitting clip (not "a few weeks after").
- Tyler Wade: utility player, not infielder.
- Culpo: Sophia (not Sofia); softened "betrayal" paraphrase to "publicly suggested Berrios had cheated on her."
- Tom Brady NYE: disambiguated to "New Year's Eve heading into 2026"; added Palm Tree Crew callback to 2023 Ivanka/Art Basel party (same orbit, two years apart — reinforces merger thesis).

Verified-clean (no edits needed): breast augmentation specifics (Jan 2022, 275cc saline, self-paid), Izabel "twelve-year-old half-sister born of the affair," ask.fm slur 2024 surfacing + apology quote, Ivanka Trump Art Basel 2023, DWTS Season 34 + finale outcome + perfect 30s + Val Chmerkovskiy partnership, Val's 20 seasons, Today show date/interviewer, Cooper April 13 2026 video, Ashtin Earle Tulane 2025 psych, Berrios Houston Texans 2025.

Sources file: see research brief and verification pass conversation logs.
-->
