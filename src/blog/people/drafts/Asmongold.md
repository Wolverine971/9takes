---
title: 'Asmongold: An Enneagram Type 5 Analysis'
meta_title: 'Why Asmongold Lived Like an Animal for 13 Years'
...
content_quality:
  ...
  overall: 9.4
  letter: 'A'
  graded_at: '2026-04-17'
path: src/blog/people/drafts/Asmongold.md
---
...
FEEDBACK (2026-04-17):
- EXCEPTIONAL HOOK: Cockroaches on stream (16M views) vs. pulling mother from burning house — "The same hands. The same man." Immediate, specific, devastating juxtaposition that forces the reader to stay. Top-tier.
- SIGNATURE DETAIL: "He had planned to end his life after high school. Then World of Warcraft: Wrath of the Lich King launched in 2008. He said he 'forgot.'" — Paris Hilton-nightmares-level signature moment that makes the whole Type 5 thesis click.
- FRESH LANGUAGE: "Observer, monetized," caretaking-as-"infrastructure," "The body is what they let go first," and the 5-vs-6 framing against Hasan ("not a political answer… a Five answering a question about the self while pretending to answer a question about Gaza") all feel person-specific, not recycled typology.
- ENDING CUTS TO BLACK: "The observer is still sitting very still, conserving energy, taking notes, waiting for something to be worth the cost of looking up." No summary, no CTA, peak insight. Exactly right.
- EVIDENCE IS SOURCED HARD: Dexerto, Sportskeeda, Aftermath, Dot Esports, Media Matters, SullyGnome, Dr. K podcast, the 'About my mom' video, dated tweets. Voice is heard, not summarized.

NEEDS WORK:
- CORE EMOTION DEPTH: Type 5 is fear-triad, but the piece describes fear behaviorally (conserving attention, neglecting body) rather than putting the reader *inside* the fear the way Greta sits inside anger or Dax sits inside shame. One scene painted from the inside of the fear — the texture of it, not just its consequences — would push this to A+.
- "The observer" framing is the thesis, but it gets restated in several section closers ("the observer is still sitting," "observation, monetized," "the watcher"). Tighten one or two of these so the final line lands cleaner.

TO REACH A+ (9.5+):
(1) Add one emotionally immersive scene where the reader feels Five-fear from the inside — e.g., the morning panic attacks he won't broadcast, described in sensory detail rather than summary ("The first four or five hours of every morning were spent in small panic attacks" is told, not shown). The cupcakes-with-mother scene is the closest you get; a second interior moment would balance it.
(2) Minor: cut one restatement of the "observer" motif mid-piece so the ending's "still sitting very still" hits fresh.
-->

> "I am a degenerate and I wouldn't have it any other way." — Zack Hoyt, Twitter, 2021

<p class="firstLetter">In February 2024, cockroaches crawled on Zack Hoyt while he livestreamed. The clip, shared by DramaAlert on X, passed 16 million views in six months. Three years earlier, he had pulled his mother out of a burning house and held a hand she would not survive.</p>
...
<details>
<summary class="accordion">TL;DR: Why Asmongold is an Enneagram Type 5</summary>
<div class="panel">
<ul>
<li><b>The Observer, monetized:</b> Asmongold built a career watching World of Warcraft, Reddit, politics, and other streamers — a Type 5's inner life turned into a business.</li>
<li><b>The body as tradeoff:</b> Years of squalor were not laziness. A Five preserves attention for the mind by neglecting the body that houses it — and neglects the bank account for the same reason.</li>
<li><b>One person broke the pattern:</b> He spent seven years as his mother's live-in caregiver. When she died in 2021, the scaffolding went with her.</li>
<li><b>Disintegration to Seven:</b> His stress pattern runs to unhealthy Type 7 — 13-hour Diablo sessions, hypochondria, emergency-room panic attacks.</li>
<li><b>No team, no tribe:</b> Fives refuse ideological capture. Asmongold holds UBI, abortion rights, anti-woke takes and "no weight on principles or morality" in the same sentence on purpose.</li>
</ul>
</div>
</details>
...
In October 2024, Zack uploaded a 35-minute video titled _"I've been living like an animal for 13 years. So here's why."_ It passed a million views.
...
He had planned to end his life after high school. Then _World of Warcraft: Wrath of the Lich King_ launched in 2008. He said he "forgot."
...
For a [Type 5 — the Observer](/enneagram-corner/enneagram-type-5) — the core belief is that the world will take everything from you if you give it a chance, so you learn to live on less. Less food. Less sleep. Less social contact. Less stimulation. You trade bodily comfort for mental quiet. You keep your inner world intact by keeping the outer world small.
...
Classic Type 5, in his own words on Dr. K's _Healthy Gamer_ podcast (released 2021):
...
Zack did not stream for a week. On November 4, he uploaded a 30-minute video called _"About my mom."_ Most of it is him talking directly into a camera, losing the thread, finding it, losing it again. The whole thing is quotable. Two passages matter more than the rest.
...
He had played _Diablo 4_ for thirteen hours, fallen asleep, and woken up with a feeling in his leg. Then a feeling on his neck. By the time he reached the hospital, he had convinced himself he was dying.
...
A Five in sustained stress does not become a calmer Five. The disintegration arrow runs from Five to [Seven — the restless Enthusiast](/enneagram-corner/enneagram-type-7). Fives in collapse start behaving like unhealthy Sevens: chasing stimulation, unable to sit still inside their own head, throwing a thirteen-hour _Diablo_ run at a pressure that fourteen years of _World of Warcraft_ could not out-run.
