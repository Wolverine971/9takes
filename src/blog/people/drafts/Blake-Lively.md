...
<!-- REVISION 2026-04-23 — addressing fresh-eyes reader feedback below:

ADDRESSED:
- Filmography added: The Shallows, A Simple Favor, Another Simple Favor integrated into "What She Controls" section as evidence of the thesis (woman-keeping-it-together-on-surface roles, control-minded casting).
- Taylor Swift friendship depth: opening hook now names the daughters (James/Inez/Betty) and godmother-to-all-four status. Added a dedicated "The Friend Who Couldn't Find Her" section.
- Woody Allen blind spot: added as the closing beat of "What She Controls" — reframed as the blind spot of a curator, not hypocrisy.
- Met Gala 2022 co-chair / Atelier Versace transformation gown: added as curation's purest form. Statue of Liberty copper-to-oxidation frame preserved.
- Kids as curation project: woven into "Two Curators, One Marriage" section. Names trickling out on her schedule (Olin at Deadpool premiere) covered.
- Ryan's counter-curation: Aviation Gin ($610M to Diageo), Mint Mobile ($1.35B to T-Mobile), Maximum Effort — reframed the marriage as two curators rather than Type 7 chaos balancing Type 1 rigidity.
- Preserve detail: added the toxic workplace + brother-as-oversleeping-creative-director context to explain why Betty Buzz got three years of solitary perfecting.
- Ryan-Scarlett timeline: now stated plainly (met Blake on set in July 2010 while still married to Scarlett; double-date origin story came a year later).
- Mother's attempted murder moved forward: now load-bearing in "From the Hospital to the Set" section as the emotional spine, not an afterthought.
- "Brought from hospital to the set" detail strengthened as the explicit origin of the control pattern.
- Trims: Gossip Girl / Leighton feud compressed ~40%. Lawsuits subsections collapsed from 4 into 1 denser block. "Both stories can be true" setup cut to one sentence. "This isn't cruelty" self-flinch removed.
- "Ryan as chaotic Type 7" reframe: explicit correction to the reader — two commercially curated humans, not one chaotic one.

NOT ADDRESSED (deliberate):
- TL;DR accordion kept as-is; already strong.
- Wikipedia-procedural lawsuit detail trimmed but not deleted — the unsealed texts are load-bearing evidence and removing the framing leaves them orphaned.
-->

<!-- FRESH-EYES READER FEEDBACK (2026-04-23)

Read this as someone who knows Blake the way a normal reader does: Gossip Girl,
married to Ryan Reynolds, best friends with Taylor Swift, Met Gala icon, and
whatever the hell happened with Justin Baldoni. Here's what jumped out as a
regular reader — not a Type 1 analyst.

--- WHAT'S MISSING (the stuff I kept waiting for and never got) ---

1. HER ACTUAL MOVIES ARE GHOSTS.
2. TAYLOR SWIFT FRIENDSHIP IS UNDERCOOKED.
3. WOODY ALLEN / CAFE SOCIETY IS A GIANT BLIND SPOT.
4. MET GALA / FASHION ICON STATUS.
5. THE KIDS AS A CURATION PROJECT.
6. RYAN'S COUNTER-CURATION.
7. THE PRESERVE FAILURE IS TOO QUICK.

--- WHAT'S OVERDONE OR DUPLICATE ---

1. THE CURATION THEME IS HAMMERED.
2. GOSSIP GIRL / LEIGHTON FEUD IS LONG FOR LIMITED PAYOFF.
3. THE IT ENDS WITH US SECTION IS FOUR SUBSECTIONS DEEP.
4. "BOTH STORIES CAN BE TRUE" SETUP IS TOO LONG.

--- WHAT SHOULD BE EXPANDED ---

1. Brought-from-hospital-to-set is the origin story, treat it as such.
2. Mother surviving attempted murder is the emotional spine; move it forward.
3. "Rabid pig" and Taylor texts deserve more weight as evidence.

--- STRUCTURAL / TONE NOTES ---

1. TL;DR accordion is great. Keep it.
2. The piece flinches at its own sharpest observations — trust the reader.
3. No mention of Ryan/Scarlett timeline despite the curation thesis inviting it.

--- BOTTOM LINE ---
A-minus draft a tight edit from A+. Biggest upgrades: acknowledge the
filmography, cut 25% of the middle, don't flinch.

(Full detailed feedback preserved in git history commit prior to 2026-04-23.)
-->
...
<details>
<summary class="accordion">TL;DR: Why Blake Lively is an Enneagram Type 1</summary>
<div class="panel">
<ul>
<li><b>Control as identity:</b> She styles herself, edits her own films, spent three years perfecting drink recipes, and curates every public appearance down to the stitch. No delegation, ever.</li>
<li><b>The inner critic made visible:</b> Brought from the hospital to a film set as a newborn. She never learned how to be watched without performing.</li>
<li><b>Sharpness under pressure:</b> Her humor turns cutting when she feels challenged. The Kjersti Flaa incident, the domestic violence deflection, the "rabid pig" texts. Same pattern across decades.</li>
<li><b>The persona that won't turn off:</b> Even Taylor Swift noticed the mask. The question is what it costs.</li>
</ul>
</div>
</details>
...
This isn't diva behavior. This is what Enneagram [Ones](/enneagram-corner/enneagram-type-1) look like when they're running at full speed.

Ones carry an internal compass that never stops pointing. They see the world through how things _should_ be, and the gap between that ideal and reality creates relentless pressure. At their best: principled, disciplined, deeply committed to improvement. At their most stressed: rigid, uncompromising, convinced that letting anything slide is a moral failure.
...
- Presented a **17-point list of non-negotiable demands** to Sony during _It Ends With Us_ production, threatening to walk if they changed a word
- Led the creation of **her own edit** of the film, bringing in editors from her husband's _Deadpool_ team
...
Under [stress](/enneagram-corner/enneagram-types-in-stress), Ones move toward Type 4's unhealthy patterns: withdrawal, isolation, the conviction that no one truly understands them. Watch Blake during the _It Ends With Us_ fallout and you see this in real time.
...
Her brother Eric changed the trajectory. During a European vacation when Blake was a sophomore, he mapped out career possibilities for her. When nothing appealed, he contacted his own talent agents and asked them to find auditions. She went, as she later put it, "to pacify him." That's how she landed _The Sisterhood of the Traveling Pants_ at sixteen. Her first role had come earlier: age ten, in a low-budget film called _Sandman_, directed by her father.
...
_Gossip Girl_ made the split visible. For six seasons, Blake played Serena while dating her on-screen love interest, Penn Badgley, wearing her character's clothes in real life, and doing fashion shoots that rehearsed the exact image the show was selling. "I was wearing the same clothes and doing fashion shoots, and dating the same person as my character was dating," she later admitted. The producers wanted them to date because "it fed their whole narrative."

Badgley, on _Call Her Daddy_ in April 2025, admitted he "struggled to separate his real life from Dan Humphrey's." Blake didn't struggle with the blur. She mastered it. If the audience couldn't tell where the character ended and the person began, the person was performing correctly. That lesson shaped everything after.

Her relationship with Leighton Meester was the exception that proved the rule. Executive producer Joshua Safran told _Vanity Fair_ they "were not friends" but "the second they'd be on set together, it's as if they were." _New York Magazine_ reported they "avoided each other like the plague" between takes.
...
In 2016, Norwegian journalist Kjersti Flaa sat down to interview Blake and co-star Parker Posey for _Café Society_. Flaa congratulated Blake on her pregnancy. She was visibly showing.
...
The _It Ends With Us_ saga is what happens when a person built for total control encounters a situation that refuses to be controlled.
...
Then the lawsuits hit. On December 20, 2024, Blake filed a California Civil Rights Department complaint accusing Baldoni of sexual harassment during filming and a coordinated smear campaign afterward. The _New York Times_ broke the accompanying investigation the same day: _"We Can Bury Anyone": Inside a Hollywood Smear Machine_.
...
That's the actual architecture. One curator who admits it and one who hides it behind self-deprecation, raising four children whose names trickle out on their own schedule — James, Inez, Betty, and Olin, the last revealed at the _Deadpool & Wolverine_ premiere in July 2024. The kids are almost never photographed. Taylor Swift, godmother to all four, once asked permission to use the first three names in a _folklore_ song. Ryan called it his favorite track of hers.
...
Taylor Swift and Blake Lively became close around 2014. The friendship is the kind that gets documented in _Vogue_ tributes and New Year's Eve photos from Australia; in songs that use a couple's children as proper nouns; in godmother status for four kids.
