...
<p class="firstLetter">On January 2, 2018, Corinna Kopf wrote the rawest thing she'd ever post online. Not a thirst trap. Not a sponsored take. A confession.</p>
...
<details>
<summary class="accordion">TL;DR: Why Corinna Kopf is an Enneagram Type 7</summary>
<div class="panel">
<ul>
<li><b>The running started early:</b> Crippling anxiety since childhood, a brother lost to suicide at twelve, and a career built on making sure the fun never stops.</li>
<li><b>The persona is a strategy:</b> The "Pouty Girl" who plays ditzy on camera runs one of the most ruthlessly efficient creator businesses in the industry.</li>
<li><b>Nothing lasts because it's not supposed to:</b> Platform after platform, relationship after relationship — the pattern isn't flightiness, it's a fear of what happens when the motion stops.</li>
<li><b>The money is a cage:</b> She hates what OnlyFans did to her reputation but can't walk away from $300K a month, because for a girl who learned at twelve that everything can disappear, enough money might mean nothing bad can ever happen again.</li>
</ul>
</div>
</details>
...
## What is Corinna Kopf's personality type?
...
A consistent battle with herself. Not a business decision. Not a strategic pivot. A war between the part of her that hates what the platform did to her reputation and the part that cannot — physiologically, psychologically _cannot_ — walk away from $300,000 a month.
...
She's running the same math she's been running since she was twelve: _if I have enough, nothing bad can ever happen to me again._
...
Biggest issues:
- The brother's suicide is referenced five times (intro, childhood section, Enneagram section, gambling section, conclusion). It's the emotional core and it should recur — but by the gambling section it's starting to feel like the draft is leaning on one fact to do all the emotional work. The childhood and intro treatments are powerful; the later mentions could be less explicit and still land.
- The $67 million figure appears four times and "running" as a metaphor appears in the intro, the Enneagram section, the gambling section, and the conclusion. Both are strong frames but they're overworked. Trust the reader to hold them.
- The Twitch ban → Facebook Gaming deal → return to Twitch → Kick migration pipeline is completely absent. This is arguably the single best real-world illustration of the "platform to platform" running pattern the draft keeps asserting. She didn't just casually hop platforms — she was banned, signed an exclusive deal elsewhere, came back, got banned again, and left for Kick. That's not flightiness, it's the exact "running from constraint" narrative the piece is built on. Major missed opportunity.

What to expand:
- The Logan Paul relationship gets roughly the same word count as Toddy Smith, but it's doing 10x the psychological work. She publicly condemned him over a suicide video that echoed her brother's death, then dated him. That deserves more than a paragraph — it's the most loaded relationship in the piece and the strongest evidence for the Seven's "running toward the source of pain" pattern.
- The OnlyFans content leak shortly after launch. For someone with lifelong anxiety, having her content stolen and distributed without consent is a significant violation. The draft talks about reputation damage in abstract terms but never mentions the concrete event that made it real.
- The $7 million, 13,000 sq ft estate she's building — the draft says "building a home" as if it's a modest project. The actual scale (golf simulator, movie theater, tennis court, four-car garage) is a perfect concrete detail for the Seven's "if I have enough, nothing bad can happen" thesis.

What to trim:
- The Sammy Wilk paragraph adds little. "They dated, it seemed happy, then posts stopped." Unlike the other three relationships, there's no psychological hook here. Cut it or fold it into a single sentence so the relationship section stays sharp.
- The "What the Camera Sees / What the Spreadsheet Sees" contrast panel repeats information already covered in the surrounding paragraphs (the $67M, platform list, Ferrari). Either let the panel carry the information and trim the prose, or cut the panel. Both saying it feels redundant.
- "Because for a Seven, deprivation is the real enemy" in the OnlyFans section restates the Enneagram explanation from two sections earlier almost verbatim. The reader already has the framework; at this point, let the story do the work.

Structural suggestions:
- Consider adding a brief section or paragraph about her actual fanbase / community. Who follows Corinna and why? What do they get from her? The draft treats her audience as a number (7 million) but never as people. For a piece about connection and avoidance, the nature of her relationship with her audience is a missing dimension.
- The gambling section ending and "The Girl Who Never Lands" conclusion feel slightly disconnected. The gambling section ends with the "inner thought" about the quiet, then the conclusion jumps to tattoos and the father callback. A single transitional beat — even one sentence — would smooth that landing.

What's already working:
- The opening is exceptional. The Logan Paul tweet → brother's death → then dating Logan Paul sequence is a genuinely startling hook that earns the reader's attention without being clickbait.
- The father teaching distraction as a coping mechanism is the best structural insight in the piece. It connects childhood, career, and the Enneagram framework in a single thread. The final line ("She just got better microphones") pays it off perfectly.
- The gambling section's observation about "the moments between spins" is sharp and original. Most coverage of her gambling is moral judgment; this reads the behavior as psychology. That's the piece at its best.
- The OnlyFans "retirement" sequence with the ellipsis before "stupid" is excellent close reading of her own language. More of that kind of attention throughout would elevate the whole piece.
-->

<!-- SECOND PASS NOTES (2026-04-09)
Addressed:
- Fixed factual error: "$4.2 million in a single month" was wrong — that was first 6 weeks total. Corrected to "In her first six weeks, she earned $4.2 million" with monthly peak/floor figures separated
- Removed duplicate earnings figures: $1M/48hrs and $680K/$2.3M appeared in both "Plays Dumb" and "$67M Trap" sections. Consolidated all specific numbers into the trap section
- Replaced "Fluent in German" with "Speaks German" — she was fluent as a child but self-reports her skill has rusted
- Replaced "golf simulator" with "tennis court" — golf simulator unverified; tennis court confirmed in David Dobrik house tour
- Rewrote symmetrical AI phrasing ("Being seen means being still. Being still means being alone...") — replaced chain with single direct sentence
- Cut "$67 million" from Enneagram section ("built an empire" vs "built a $67 million empire") — figure now appears 3x instead of 4
- Trimmed Enneagram bullet list from 5 items to 3 — old list recapped the article; new list is tighter
- Cut "in permanent ink on her body" (redundant with "tattoo")
- Cut "no psychological hook worth naming" from Sammy Wilk line — meta-commentary broke voice
- Trimmed inner-thought "One more" from 5 repetitions to 3 — 5x read as AI pattern
- Replaced "drug of choice" cliché
- Tightened conclusion opening: fragments instead of full summary sentence

Kept as-is:
- Opening hook, father/distraction thread, "between spins" observation, Toddy Smith question mark, OnlyFans ellipsis close reading — all still the strongest material

Still open:
- $67M figure appears 3x (intro, contrast panel, retirement question). All three serve distinct purposes. Probably fine now.
- "No Nut November" detail still cut. Could be restored if editor wants the specificity.
- Piece is ~2400 words. Tight for the depth, but not a problem.
-->
