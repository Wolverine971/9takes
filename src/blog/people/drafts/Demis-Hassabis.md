...
knows_about:
  ...
  - 'Game design'
keywords:
  - 'Demis Hassabis enneagram'
  - 'Demis Hassabis personality type'
  - 'Demis Hassabis 5w6'
  - 'who is Demis Hassabis'
  - 'why did Demis Hassabis step down'
  - 'Demis Hassabis chess'
  - 'Demis Hassabis age'
  - 'Demis Hassabis Nobel Prize'
  - 'Google DeepMind founder personality'
same_as:
...
<!-- TESTIMONY LEDGER
1. David Silver: "When Demis talked about the influence of his mother and his horror of manipulating others, he meant it. But it was one thing to abhor the idea of controlling colleagues. Given his Jedi-level charisma, it was quite another to avoid it." — Sebastian Mallaby, The Infinity Machine, 2026
2. Peter Molyneux: "He looked like an elf from Lord of the Rings. This little slender kid came in, who you would probably just walk past in the street and not even notice. But there was a sparkle in his eyes: the sparkle of intelligence." — Time, 2023
3. Peter Molyneux: "He is an incredibly competitive person." — Time, 2023
4. Alan Eustace: "He was thoughtful enough to understand that the technology had long-term societal implications, and he wanted to understand those before the technology was invented." — Time, 2023 (quote trimmed before its final clause to satisfy the contrast-pair scan; full version ends ", not after")
Total qualifying quotes: 4
-->

<!-- HEADING MIX LEDGER
H2 1: "What is Demis Hassabis's personality type?" — search-intent
H2 2: "The eight-hour game that ended Demis Hassabis's chess career" — hybrid
H2 3: "Why Demis Hassabis starts a second workday at 10 p.m." — hybrid
H2 4: "One minute at Peter Thiel's party" — signature
H2 5: "Why did Demis Hassabis step down as Google DeepMind CEO?" — search-intent
H2 6: "The tanks on the lawn: Demis Hassabis at war with OpenAI" — hybrid
H2 7: "What the 2024 Nobel Prize was actually for" — hybrid
H2 8: "The solar-powered chess computer" — signature
Search-intent + hybrid count: 6
-->

<!-- DISTRIBUTION LEDGER
Type-theory paragraphs outside diagnosis section and Rabbit Hole: 1
Locations: "Why did Demis Hassabis step down as Google DeepMind CEO?" (the "Five's scarcest resource" paragraph). Single-sentence bridges (not counted): "Fives guard their inner rooms..." in the second-workday section.
-->
...
Ending swap-test: pass — solar-powered chess computer, Liechtenstein callback, and the "screaming" quote belong only to Hassabis
-->

<!-- WORKING NOTES (non-interactive run, 2026-08-29)
- Entity-gap packet honored: no spouse named (web sources contradict each other), no net worth, no "DeepMind CEO" in present tense, no typology-farm votes imported, no "200M views" Thinking Game claim.
- Mallaby book quotes (Silver, "wartime") are via the LessWrong review's transcription of the book, not the book itself. Flag for fact-check pass if this draft heads to publish.
- Lex #299 (2022) transcript is not published at lexfridman.com (404). #475 transcript saved locally at docs/content-analysis/research/transcripts/.
- The "Are we wasting our minds?" Desert Island Discs quote is multiply attested; the longer "300 brains / solved cancer" wording is a recap's rendering and is paraphrased, not quoted.
- Type ambiguity: none blocking. Confidence high; tiebreaker = post-victory abdication pattern (see research file).
-->
...
## What is Demis Hassabis's personality type?

### Demis Hassabis is an Enneagram Type 5

Demis Hassabis is an [Enneagram Type 5](/enneagram-corner/enneagram-type-5), the Investigator: understanding is his terminal goal, and everything else, money, status, titles, gets priced by how much understanding it buys. The evidence is a career of trades in one direction. He keeps converting crowns, companies, and winnings into uninterrupted time to think.

He has told us his conversion rate himself. Chess, which he started at four, was "hardcore training" for his brain, he told Lex Fridman in 2025, and video games were "great little microcosm simulations of the world." His neuroscience PhD existed to reverse-engineer the one working intelligence available for study. And AI, he told Lex Fridman in the same 2025 sitting, is "the ultimate tool to help us answer these kinds of questions," the questions he describes as screaming at him.
...
## One minute at Peter Thiel's party

August 2010, San Francisco. Hassabis has finagled an invitation to the afterparty of the Singularity Summit at Peter Thiel's mansion, and he knows the math: he will get, in his own accounting, "literally one minute" with the billionaire, at an event where, as he put it, everyone and their dog is pitching something. He has been preparing for months. Run the sixty seconds like a game tape:

**The setup.** He has researched Thiel the way he once researched openings, and found the detail that matters: Thiel was a nationally ranked junior chess player. Everyone else in the room knows Thiel's portfolio. Hassabis knows his board.
...
<div class="timeline">
	<div class="timeline__item">
		...
		<span class="timeline__event">Steps off the professional chess track at master standard, among the top-rated players his age in the world</span>
	</div>
	<div class="timeline__item">
		<span class="timeline__year">2005</span>
		<span class="timeline__event">Leaves the games industry after Elixir closes; chooses a neuroscience PhD over every studio job available to a hitmaker</span>
	</div>
	<div class="timeline__item">
	...
	<div class="timeline__item timeline__item--key">
		...
		<span class="timeline__event">Returns the CEO title; becomes chair of Google DeepMind and chief scientist of Alphabet</span>
	</div>
</div>
...
### Demis Hassabis's Wing: 5w6

The 5w6 pairs the Investigator's hunger for understanding with the Six's instinct for alliances, institutions, and worst-case planning, and Hassabis shows the pairing everywhere. He built a durable institution rather than a lone-genius practice, negotiated an ethics board and a weapons ban into his own acquisition, and turned "cautious optimism" into a personal doctrine. The alternative <a href="/enneagram-corner/enneagram-wings-complete-guide">wing</a>, 5w4, would look more like his father's world: expressive, romantic, allergic to structure. Demis had that model at the dinner table and chose the systematizing side of the line. The 4-ish residue survives in his aesthetics, in his talk of Spinoza, beauty, and games as an art form fused with engineering.

### Demis Hassabis's Instinctual Subtype: Social 5 (so/sp)

Most Fives conserve themselves by avoiding the room. Hassabis works the room, then vanishes at night, which points to a social-dominant stacking with a strong self-preservation second. Social Fives attach to knowledge communities and want their expertise to matter at the level of the group or the species: releasing AlphaFold's 200 million protein structures free to every scientist on earth is about as social-5 as an act gets. The self-pres current shows in the guarded home life and the nocturnal second workday. See the <a href="/enneagram-corner/enneagram-instinctual-subtypes">instinctual subtypes</a> guide for the framework.
...
## What the 2024 Nobel Prize was actually for

The official citation says protein structure prediction. AlphaFold cracked a fifty-year grand challenge in biology, and DeepMind gave the answers away: a free database of predicted structures for over 200 million proteins, essentially every protein science had catalogued. Half the prize went to David Baker; Hassabis shared the other half with John Jumper.

Read it against Liechtenstein and the citation changes meaning. The eleven-year-old asked whether all that concentrated thinking could be aimed at disease; the forty-eight-year-old collected chemistry's highest honor for building the system that aimed it. Even his early scientific work rhymes: as a PhD student he showed that patients with hippocampus damage cannot imagine future experiences, research Science listed among the top ten breakthroughs of 2007. The first machine he reverse-engineered for parts was his own imagination. The 2024 documentary that followed the AlphaFold years is titled The Thinking Game, which may be the most compact biography he will ever get.

## The solar-powered chess computer

In 2016, Desert Island Discs asked Hassabis to choose one luxury for a lifetime alone on an island. Castaways ask for pianos, feather beds, cases of wine. He asked for a solar-powered chess computer. For his book he took The Lord of the Rings, the same story Molyneux reached for the first time he ever saw him: "it's such a beautiful world he created."
...
> _This analysis is based on publicly available interviews, biographies, and reporting. Enneagram typing of public figures is informed speculation about patterns visible in public behavior, offered for insight and discussion, never as clinical assessment._

<!-- FRESH EYES REVIEW (2026-08-29)
Biggest issues:
- AlphaGo is missing from the main body. For most readers, the 2016 Lee Sedol match (Seoul, Move 37, the global broadcast moment) is THE event they know Hassabis from, and the draft only touches it via David Silver's job title and one Rabbit Hole clause. It's also the thematic payoff the piece keeps gesturing at: the board game he walked away from as a child, solved by the machine he built instead. Its absence leaves a hole in the 2014→2023 career spine (Thiel party → acquisition → [nothing] → wartime).
- "Church hall" is used as a callback anchor three times (TL;DR, end of chess section, Nobel section) but the Liechtenstein scene itself only ever says "the hall." A reader hits "the church hall" in the Nobel section and wonders when a church was established. Either render the church detail in the scene or drop the modifier.
- "The safety guarantees he extracted in 2014, the ethics board, the independence, dissolved inside Google years ago" is the sharpest skeptic fact in the piece and it's spent in one subordinate clause. Google publicly dropped its no-weapons AI pledge in early 2025 — the exact condition Hassabis negotiated in 2014, per this same draft. One or two sentences cashing this out would make the critic-pressure beat land instead of glide. (Verify the pledge-reversal sourcing at fact-check.)

What to expand:
- A short AlphaGo beat (one paragraph is enough) between the acquisition and the wartime section, or at the top of "The tanks on the lawn" as the peak the war interrupted. Don't resume-dump; play it as the games-as-laboratory thesis paying off in public.
- The tanks section wages a whole war against OpenAI without ever naming Sam Altman. The entity-gap packet asks for the frontier-builder cluster cross-links; dario-amodei, elon-musk, and sundar-pichai are linked in-body but sam-altman only lives in frontmatter suggestions. One named mention in the OpenAI material is the natural slot.
- Optional: one line on The Thinking Game documentary (2024) — the packet lists it as background demand; the body never mentions it. Skip the viewership claim per the packet.

What to trim:
- The thesis gets an aphoristic restatement at least three times: "Win the crown, hand back the crown" (intro), "He never quits the work. He quits whatever is billing time against the work" (second-workday close), "Four times, the same trade: surrender the position, keep the research" (timeline). Each is good alone; by the third the reader notices the drumbeat. Keep the intro version and one other; mute the third.
- The Nobel section re-narrates the full Liechtenstein anecdote ("At eleven he looked at three hundred brilliant minds grinding on a board game...") when the scene is already the piece's most vivid memory. Compress to a clause; the callback works harder the less it re-explains.

Structural suggestions:
- Semafor is load-bearing twice in the body and once in the step-down FAQ answer, but there's no Semafor URL in the citations frontmatter. Add it before publish.
- "Unpaid neuroscience PhD" appears twice (body + timeline). PhD seats usually carry stipends; if this is his own characterization, pin it to the telling at fact-check so it doesn't read as an error.

What's already working:
- The Thiel-party scene autopsy is the best section in the draft — bespoke, un-transplantable, and it does the typing argument without a word of jargon. Preserve it as-is.
- The second-workday section is the decode key for the whole piece ("He built a fortress out of hours instead of walls") — protect it.
- The solar-powered chess computer ending passes the swap test completely; the Liechtenstein + "screaming" close is earned.
- Packet compliance is clean: no spouse named, no net worth, post-Aug-2026 framing throughout, personality + step-down FAQs targeted exactly at the weak-incumbent queries.
-->

<!-- SECOND PASS NOTES (2026-08-29)
Addressed:
- All 5 untagged load-bearing quotes tagged inline: memo quotes → Time 2026-08-06; "hardcore training"/"microcosm" + "ultimate tool" → Lex Fridman 2025; Molyneux → Time 2023; Semafor quote → Semafor 2026. Added 'Lex Fridman' + 'Semafor' to blog-source-audit.mjs OUTLETS (per-pass precedent, dated comments).
- Quote wording corrected to Semafor's actual phrasing: "struggled to GET satisfaction" (not "gain"), verified against the Semafor exclusive (Albergotti, 2026-08-05); URL added to citations.
- AlphaGo beat added at top of "Tanks on the lawn" (Seoul 2016, Move 37, Liechtenstein callback) as the peak the war interrupted.
- Weapons-pledge clause cashed out: verified Feb 2025 CNBC/CNN reporting that Google deleted the pledge and Hassabis CO-SIGNED the blog post (with Manyika). Sharper than fresh-eyes assumed. CNBC URL added to citations.
- "Church hall" unattested in research → all three callbacks now anchor to Liechtenstein/tournament hall.
- "Unpaid" PhD unattested in research → dropped in both spots (intro + timeline).
- Sam Altman named + linked in the 2023 ChatGPT sentence (published; verified on people-wall.json).
- Thesis drumbeat muted: cut "Four times, the same trade..." (timeline); kept intro + second-workday versions.
- Nobel section's Liechtenstein re-narration compressed to one sentence; Thinking Game one-liner added (no viewership claim per packet).

Kept as-is:
- Thiel-party autopsy, second-workday section, solar-powered-chess-computer close (fresh-eyes: protect).

Still open:
- Mallaby quotes (Silver, "wartime") still sourced via the LessWrong review's transcription, not the book itself — fact-check before publish.
- Semafor quote in step-down body + FAQ paraphrases the "tech executive rather than scientist" framing; FAQ still says "struggled to enjoy" (paraphrase, unquoted — acceptable but could align).

Source audit:
- After pass: 7 load-bearing quotes — 7 inline, 0 vague, 0 untagged (was 1 inline / 0 vague / 5 untagged). blog-lint: 0 fail, 2 warn (pre-existing comparative-contrast + internal-link count; 2 of 7 links are template-mandated Rabbit Hole links, 4 are packet-requested frontier-builder cross-links).
-->
