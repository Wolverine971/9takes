...
<div class="panel">
<ul>
<li><b>Fear as engine:</b> Grew up in genuine instability — food insecurity, alcoholic father, generational trauma. Every major decision traces back to the need for solid ground.</li>
<li><b>The counterphobic flip:</b> A conflict-averse child who learned in therapy to stop suppressing, then couldn't stop fighting. The political warfare isn't anger — it's fear with a platform.</li>
<li><b>Earnestness as trust signal:</b> The #1 quality he looks for in founders is authenticity. Sixes don't just value trust — they need it for survival.</li>
<li><b>Structure over chaos:</b> Posthaven, YC, Initialized, GrowSF, Garry's List, and now gstack — every chapter is the same move, engineering the institutional safety he never had at home.</li>
</ul>
</div>
</details>
...
<!-- EDITOR PASS NOTES (2026-04-23)
Addressed fresh-eyes review feedback:

Trimmed repetitions:
- "One-bedroom apartment in Fremont" cut from 4+ instances to 2 (intro pivot + direct quote).
- "The kid who [X]" construction reduced; replaced "next kid in Fremont" echo with "next misfit with a laptop and a reason."
- "Counterphobic" trimmed from 4-5 uses to 3 (FAQ, TL;DR, political-section punch).
- "Build the structure nobody built" list of six collapsed to shorter run-through with a cleaner close.
- Tupac/1 AM callback not double-told — trusted reader memory.

Added / beefed up:
- YouTube beat in "That's My Mask" expanded with Type 6 frame: controlled trust channel vs. chaotic X presence.
- Posterous upgraded: Twitter shutting it down in 2013, Posthaven launched with a "never sell, never shut down" pledge — perfect Type 6 story.
- Ohanian split expanded with Seven Seven Six / 2020 board-partner framing / 2022 full exit.
- Founder Mode added as loyalty-to-tribe move inside YC — Paul Graham essay amplification.
- Garry's List expanded with national-politics-adjacent framing (Musk/Sacks/Thiel orbit, H-1B/tech-friendly immigration).
- NEW SECTION: "G-Stack: A Type 6 Ships His Nervous System as Open Source."
  Covers the 23 role-based slash commands, 10K LOC / 100 PRs / 50 days productivity claim,
  "tests make vibe coding safe instead of yolo coding" quote, viral GitHub reception,
  and the clean Type 6 read (structure over chaos, named officers for every worry,
  evangelizing a safety protocol to the tribe, metabolizing the father's unrealized
  technical potential).

Fact-tightened:
- Coinbase "first check" reframed to accurate "YC partner on the deal, first check at Demo Day seed round" — avoids the common conflation.
- "19 unicorns" softened to "a long roster of unicorns" since public count drifts.
- "Five supervisors" specific count removed since sourcing varies.

Intentionally left alone:
- Parenting beat for the two sons. Reviewer asked for a concrete quote; I don't have
  a clean on-the-record one, and asserting without a source would weaken the piece.
- YC batch expansion. Available word count better spent on G-Stack + Founder Mode.
- Crypto-post-2022 posture. Tight on space; could be a follow-up beat if reader demand shows up.

Tightening pass (same day, second pass):
- Cut "A small detail. The kind of thing you mention casually in a podcast. But think about it:" set-up — quote now lands directly into the payoff line.
- Compressed the journalism quote in high school beat; kept only the sharper line.
- Palantir logo paragraph trimmed; removed "Simple and iconic / Garry was good at that" filler and two rhetorical questions in the founder-eval paragraph.
- Coinbase closing: cut the "designer who became an engineer who became a builder…" nested clause.
- "What is Garry Tan's personality type" — compressed the quicksand intro and the three-beat list of his failed authority figures into tighter sentences; reduced the four-example role-recitation to a single inline list.
- "That's My Mask" — removed a redundant interpersonal-dynamics quote and one of two nearly identical inner-work quotes. Cut "The kid who bought them a house at fourteen is still building ground…" callback.
- Political section: trimmed supervisor responses from three quotes to two (kept Peskin + Chan; cut Preston's overlapping line). Compressed the money-machine paragraph.
