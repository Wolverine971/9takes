---
title: "Gary Vee's Enneagram Type 3w2: The Achievement Machine With a Heart"
meta_title: "Why Gary Vee Can't Stop Hustling (The Psychology Behind His Drive)"
persona_title: 'The Hustle King'
...
<!-- QUALITY GRADE: A (9.0) — EDITORIAL PASS 2026-04-23
Fresh-eyes reader feedback addressed:
- ✅ Added Mom (Tamara) as origin of the Two wing: "blind optimism," "every accolade I get is yours not mine," empty-cup vs. ocean framing. Balances Dad-heavy psychology.
- ✅ Promoted "insecurity is makeup" quote to its own dedicated mini-section — this is the article's thesis, no longer buried.
- ✅ Expanded the school beat: dyslexia, teachers saying he'd go nowhere, why the scoreboard had to be money instead of grades for a Three without traditional intelligence markers.
- ✅ Added Macro Patience, Micro Speed as companion framework to Clouds and Dirt.
- ✅ Added The Content Machine (DailyVee / #AskGaryVee) as a Type 3 artifact in its own right.
- ✅ Added The Positivity Discipline — gratitude-vs.-complaint as Two-wing emotional regulation.
- ✅ Added Misha and Xander paragraph inside Two-wing section: what he wants for them vs. what he modeled.
- ✅ Fact-checked Empathy Wines date (2019, not 2021) and tightened hook so the contradiction is inescapable.
- ✅ Cut The Scorecard section entirely — merged unique VeeFriends detail into the sports-cards full-circle beat.
- ✅ Cut Jets from TL;DR and VaynerMedia lead-in; its dedicated section does the work.
- ✅ Cut duplicated "generosity engine + achievement machine" restatements from 4 to 1 strategic placement.
- ✅ Trimmed schedule block from standalone subsection to 2 sentences inside self-awareness beat.
- ✅ Replaced "psychological architecture" with Gary-register phrasing; killed generic "Type 3s never stop."
- ✅ Varied repeated section openers ("Through the Type 3 lens...", "If you've only seen the clips...").
-->

<p class="firstLetter">In 2019, while his YouTube clips were still looping the phrase "sacrifice your twenties" and his keynotes still ended with "you need to work harder," Gary Vaynerchuk launched a wine brand and named it Empathy Wines.</p>
...
<details>
<summary class="accordion">TL;DR: Why Gary Vee is an Enneagram Type 3</summary>
<div class="panel">
<ul>
<li><b>Achievement-Obsessed:</b> From selling baseball cards as a kid to building a $60 million wine business, Gary's identity is wrapped around accomplishment. Type 3s need to succeed. It's how they know they matter.</li>
<li><b>Image-Conscious Shapeshifter:</b> Gary can be both the screaming hustle guy and the soft-spoken empathy advocate. Type 3s naturally adapt their presentation to what the room needs to see.</li>
<li><b>The 3w2 "Helper Achiever":</b> The Two wing shows up in his "jab jab jab right hook" generosity, his obsession with EQ, and his insistence that "every accolade I get is yours, not mine" about his mom.</li>
<li><b>Two Operating Systems:</b> Dad installed the achievement template ("work ethic proves worth"). Mom installed the self-esteem that lets the engine run without self-destructing ("you are the greatest thing"). Most Threes only get one of those.</li>
<li><b>Fear of Worthlessness:</b> The relentless work ethic isn't ambition alone. Gary's own line: "When you're deeply insecure, you might create massive success because you're using it as makeup." Very few Threes say that out loud.</li>
</ul>
</div>
</details>
...
[Enneagram Type 3](/enneagram-corner/enneagram-type-3) is called "The Achiever." Type 3s read rooms, map what success looks like in any context, and transform themselves into whatever it takes to get there.
...
This is a Type 3 confession disguised as advice. Threes are wired to chase quick scoreboards, to convert today into a visible result. The "macro patience" half is the part Gary had to _install_ on top of his native settings. It's why he can shrug off a bad quarter and obsess over a bad hour.
...
Every correct call is another data point for the belief a Three needs to maintain: _I see what others don't._ It's not diversification. It's pattern recognition as identity.
...
Modern Gary Vee talks about empathy, kindness, and emotional intelligence. He wrote _Twelve and a Half_ about emotional skills. He coined "kind candor." He sounds more like a therapist than a hustle preacher.
...
The kid who memorized the Beckett price guide now makes the cards other kids collect. That's a Type 3 story with a Two-wing payload: the scoreboard went up _and_ the content turned into emotional education. Both wings fired on the same move.
...
He's said, repeatedly, that he's "obsessed with driving self-esteem into my children." That he wants them to pursue _their_ passion, not inherit his. That the greatest gift he can give them is what his mom gave him: unconditional love that isn't contingent on output. After the 2022 separation, co-parenting has become the place where his actual values and his public values have to match.
