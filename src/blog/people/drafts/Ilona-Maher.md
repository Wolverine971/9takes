...
This is the part that doesn't fit the imposter-syndrome clip and *does* fit the type. The 8 stress arrow points to Type [5](/enneagram-corner/enneagram-types-in-stress) — withdrawal, isolation, energy conservation, a sudden need to be left alone. You see it in the depression episode after Tokyo, when she stopped sleeping well and started breaking down before matches. You see it in the DWTS Week 4 collapse. You see it in the *wrung dry* admission. You see it in the tearful Bristol farewell, when the supposedly armored alpha cried so hard she could barely speak. The fortress, when it has too many people inside it, eventually drains the person who built it.
