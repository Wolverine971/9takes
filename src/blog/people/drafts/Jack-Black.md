...
path: src/blog/people/drafts/Jack-Black.md
content_quality:
  hook: 8.5
  enneagram: 8
  evidence: 8
...
<!-- QUALITY GRADE: B (8.1)
Hook: 8.5 | Enneagram: 8 | Evidence: 8 | Writing: 8 | Originality: 8

FEEDBACK (2026-02-18):
- STRONG HOOK: The Judith Love Cohen birth story is genuinely surprising — "Oh, and somewhere in there, she had a baby" is a memorable line that earns the reader's trust immediately.
- EXCELLENT STRESS/GROWTH ARROWS: The Kyle Gass incident is the best section in the piece. The analysis of Jack's overnight tour cancellation as Type 1 stress behavior is genuinely insightful and well-evidenced with Kyle's own "marriage" quote.
- GOOD EVIDENCE DENSITY: Strong mix of direct quotes (cocaine admission, divorce reflection, school counselor breakthrough) and collaborator testimony (Jordan-Claire Green, Miranda Cosgrove, Thandiwe Newton, Roger Ebert). The 32-takes Shallow Hal detail is a killer specific.
- NEEDS WORK — STOCK ENNEAGRAM LANGUAGE: "Classic Type 7 shadow territory," "textbook Type 7 stress behavior," "pure Type 5 territory" — these phrases appear throughout and weaken the analysis. Replace with person-specific vocabulary. What's Jack's unique version of 7 avoidance? The piece hints at it ("cocaine became comedy") but doesn't commit to a signature framework. Give it a name.
- NEEDS WORK — ENCYCLOPEDIC ACCOMPLISHMENTS: The voice acting, Peaches, and Jumanji sections read like a filmography rather than psychological analysis. Cut or restructure so every section answers the central question about Jack's energy.
- TO REACH B+: (1) Replace all stock Enneagram phrases with Jack-specific language — invent a vocabulary for his pattern (the "cocaine became comedy" line is a start; build on it). (2) Deepen core emotion exploration — fear is mentioned but never immersive. Put the reader in the room during the school counselor breakdown or Howard's death. (3) Cut the ending's final explanatory paragraph — let the Kevin Hart hospital observation be the last image. "He kept on saying that he was going to take this opportunity to breathe and slow down and appreciate his family" IS the ending. (4) Trim the accomplishments section by 40% — keep Peaches and Anaconda for psychological insight, cut or compress voice acting empire and Jumanji to brief mentions.
-->

<p class="firstLetter">On August 28, 1969, Judith Love Cohen went into labor with her fourth child. She was one of the only female aerospace engineers in the country. She'd helped design the Abort-Guidance System for the Apollo Lunar Module — the backup navigation computer that, eight months later, would guide the crippled Apollo 13 spacecraft through two critical mid-course corrections on its way home. On her way to the hospital that morning, Judith stopped at her office, picked up a computer printout of an engineering problem she'd been working on, solved it during labor, and called her boss to share the solution.</p>
...
<details>
<summary class="accordion">TL;DR: Why Jack Black is an Enneagram Type 7</summary>
<div class="panel">
<ul>
...
[Enneagram Type 7s](/enneagram-corner/enneagram-type-7) are called "The Enthusiast" for a reason. They're driven by a need to experience life's pleasures and avoid pain at all costs. Their minds race with possibilities, plans, and ideas. They're the life of the party, the ones who make everything feel like an adventure.
...
Beyond Tenacious D, Jack has collaborated with serious musicians: he sang "Burn the Witch" with Queens of the Stone Age, contributed vocals to Eagles of Death Metal's _Death by Sexy_ album, and recorded a duet on Meat Loaf's _Hang Cool Teddy Bear_.
...
Critics compared it to Meat Loaf's _Bat Out of Hell_. Comic Book Resources called it "the best part of the film," noting that "Jack Black sounds like he's giving the performance of his life as the love-struck Koopa King."
