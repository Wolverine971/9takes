...
Aisha Chottani, founder of Moment (LAUNCH Cohort 21), <a class="external-link" target="_blank" rel="noopener" href="https://www.boringbusinessnerd.com/post/what-its-like-to-work-with-jason-calacanis-in-the-launch-accelerator-with-aisha-chottani">described her experience</a>:
...
When called out, Jason <a class="external-link" target="_blank" rel="noopener" href="https://geekfeminism.fandom.com/wiki/Jason_Calacanis">responded by tweeting</a> a photo of women at a separate event for female founders, implying that female representation existed, just elsewhere. He also claimed four women speakers had canceled, which didn't explain why the remaining lineup was 100% male.
