...
suggestions: ['Adam-Sandler', 'Amy-Poehler', 'Ryan-Reynolds', 'Steve-Carell']
wikipedia: 'https://en.wikipedia.org/wiki/Jason_Sudeikis'
wikidata_qid: 'Q14539'
imdb_id: 'nm0837177'
...
knows_about:
  ...
  - 'Ensemble improv'
keywords:
  - 'Jason Sudeikis enneagram'
  - 'Jason Sudeikis type 9'
  - 'Jason Sudeikis personality'
  - 'Jason Sudeikis 9w1'
  - 'Ted Lasso enneagram'
  - 'Peacemaker enneagram'
  - 'Jason Sudeikis Olivia Wilde'
  - 'Jason Sudeikis be a goldfish'
same_as:
  - 'https://en.wikipedia.org/wiki/Jason_Sudeikis'
  - 'https://www.wikidata.org/wiki/Q14539'
  - 'https://www.imdb.com/name/nm0837177/'
...
faqs:
  - question: "What is Jason Sudeikis's personality type?"
    ...
    anchor: 'what-is-jason-sudeikis-s-personality-type'
  - question: 'Why did Jason Sudeikis make Ted Lasso so kind?'
...
2. Donnie Campbell (HS basketball coach, Ted Lasso inspiration): "When he got between the lines, he was a really good competitor, and he was a terrific teammate." — KSHB, 2021
3. Donnie Campbell: "He liked putting a little pastry on his game that I didn't always like, and he didn't always play the kind of defense that I wish he'd play." — KSHB, 2021
Total qualifying quotes: 3 (Waddingham + 2x Campbell; named speakers, direct quotes, attributed, all commenting on Sudeikis)
-->

<!-- HEADING MIX LEDGER
H2 1: "What is Jason Sudeikis's personality type?" — search-intent
H2 2: "The straight man from Overland Park" — signature
H2 3: "The decade Jason Sudeikis played the jerk" — signature
H2 4: "Why Jason Sudeikis turned kindness into a system" — hybrid (strong search-intent)
H2 5: "How Jason Sudeikis fights when he can't be a goldfish" — hybrid
H2 6: "What it is like to be in the room with Jason Sudeikis" — hybrid
H2 7: "The ten-second memory" — signature (ending)
Search-intent + hybrid count: 4
-->

<!-- DISTRIBUTION LEDGER
Type-theory paragraphs outside diagnosis section and Rabbit Hole: 3 (limit 4)
Locations: "Why Jason Sudeikis turned kindness into a system" (2 short two-sentence theory beats), "What it is like to be in the room with Jason Sudeikis" (1 two-sentence beat). Rest of body is single-sentence bridges inside narrative paragraphs, which do not count.
-->

<!-- FORMULA FINGERPRINT LEDGER
Contrast-pair sentence engines: 2 — intro ("both things are true"), and the goldfish line. Kept deliberately, not repeated as an engine.
Counter-typing ladders in main body: 0 — none (Type 2 counter-case quarantined in Rabbit Hole)
Critic-pressure anchor: the CinemaCon custody-papers serving (April 2022) + the on-set reputation for last-minute rewrites (Waddingham), in "How Jason Sudeikis fights..." and "What it is like to be in the room..."
Empathy turn: the custody-papers serving reframed through a conflict-avoider's failure to fight cleanly, in "How Jason Sudeikis fights when he can't be a goldfish"
Current-tense / legacy-now anchor: Wrexham/soccer cultural moment + ongoing Ted Lasso season 4 development discussion (2024-2026) referenced in "What it is like to be in the room..."
Interior beat: <p class="inner-thought"> in "How Jason Sudeikis fights when he can't be a goldfish"
...
The answer lives in how he handles a fight he did not choose.

<details>
<summary class="accordion">TL;DR: Why Jason Sudeikis is an Enneagram Type 9</summary>
<div class="panel">
<ul>
<li><b>The Peacekeeper:</b> Sudeikis built a career, and a worldwide phenomenon, out of defusing conflict and keeping the room together. That is the Type 9 gift.</li>
<li><b>The straight man by choice:</b> He calls himself "the boring one." For nine seasons on SNL he made flashier comedians funnier. Nines support other people's shine and forget their own.</li>
<li><b>Kindness as a system:</b> Ted Lasso is the Type 9 ego-ideal made flesh. "Be a goldfish." Forget the bad thing. Keep moving.</li>
<li><b>The buried anger:</b> Nines disown anger until it leaks sideways. Sudeikis has said so almost word for word.</li>
<li><b>The cost:</b> peace kept on the surface can hide a fight that never gets had cleanly.</li>
</ul>
</div>
</details>

## What is Jason Sudeikis's personality type?

### Jason Sudeikis is an Enneagram Type 9

Most people see the warmest man in show business. A coach who hands out compliments and biscuits and second chances. If you understand the [Enneagram Type 9](/enneagram-corner/enneagram-type-9), you see something more specific and more poignant: a man whose deepest instinct is to keep the peace, even when the peace costs him the truth.
...
## The straight man from Overland Park

Daniel Jason Sudeikis grew up in Overland Park, Kansas, the affable kid in a warm Midwestern house. His mother was a travel agent who rose to run a national association. His maternal uncle was George Wendt, the actor who played Norm on <em>Cheers</em>, the man a whole bar shouts hello to the second he walks in. The everyman everyone is glad to see. It is in the bloodline.
...
At SNL he spent nine seasons, from 2005 to 2013, as the cast's great utility player. He could be Mitt Romney, Joe Biden, the bland boyfriend, the second banana to Kristen Wiig or Bill Hader. He was rarely the breakout. He made the breakouts funnier, which is its own kind of talent and its own kind of self-erasure. People like [Amy Poehler](/personality-analysis/amy-poehler) became the face of their era at SNL. Sudeikis became the floor.

## The decade Jason Sudeikis played the jerk

His movie career ran the other way. For about ten years, it was the photo negative of Ted Lasso. He was the relentless horndog Kurt in <em>Horrible Bosses</em>. He was David, the small-time pot dealer faking a family in <em>We're the Millers</em>. He was the husband cashing in a week off his marriage in <em>Hall Pass</em>, and the charming commitment-phobe in <em>Sleeping with Other People</em>. The man audiences would later crown the nicest guy in comedy spent a decade getting cast as exactly the guy you would not want near your wife, your stash, or your feelings.

This is where it fits the Nine instead of breaking it. He could reach the edge. The appetite, the selfishness, the casual cruelty were all available to him, but only inside a script, where they belonged to a character and hurt no one real. Give a Nine someone to play and he can play anything, including a jerk. Ask him to invent a person from nothing and watch which way he reaches.

## Why Jason Sudeikis turned kindness into a system

When Sudeikis finally built something with his name on the front of it, he did not build a showcase for himself. He built a machine for making people feel better.
...
There is real generosity in this, and it is not an act. After the entertainment writer Mike Ryan lost his father, Sudeikis, barely an acquaintance, sent him an unprompted email: "I'm so sorry for your loss. And I thank you for feeling comfortable enough with me to share." The legacy of a parent, he wrote, "might actually be living inside of you. And through you." Ryan made it public because it stunned him. The kindness is the real thing. The question is what it is also protecting.

## How Jason Sudeikis fights when he can't be a goldfish

Then his own life handed him the bad play he could not forget.

In November 2020, two months after Ted Lasso premiered, Sudeikis and Wilde ended a seven-year engagement with two young children between them. Weeks later, photographs appeared of Wilde holding hands with Harry Styles. The kindest man on television had been left, publicly, for a pop star, while the world watched.

It was not the first time a partnership of his had quietly come apart. He and the screenwriter Kay Cannon, married in 2004, separated in 2008 and divorced in 2010 with so little spectacle that most people never knew it happened. He knows how to close a chapter without a sound. The difference this time was that he could not control how the story got told.

Watch how a conflict-avoider metabolizes that. Slowly. Sideways. With enormous effort and very little speed.
...
His instinct organizes around the group. He came up in ensemble formats where the team is the unit, built his masterpiece around a locker room, and repeatedly frames his own gifts in terms of what they do for the collective. The social Nine fuses with the group's harmony and loses track of personal position inside it, which fits a man who keeps calling himself the floor other people stand on. More on this lens at <a href="/enneagram-corner/enneagram-instinctual-subtypes">instinctual subtypes</a>.

### Stress and Growth Arrows

Under stress, Nines move toward Type 6: anxious, doubting, looking for reasons. You can see it in the GQ rumination, the careful effort to understand "what role I played," the slow forensic processing of a betrayal. In growth, Nines move toward Type 3: focused, productive, willing to take the stage. Ted Lasso itself is the integration story. A man who spent a decade as the straight man finally stood at the center of his own creation, did the relentless work of show-running it, and accepted the Emmy. The Nine who learns to show up looks a lot like a healthy Three.
...
## What it is like to be in the room with Jason Sudeikis
...
His coach gave him the line about the goldfish, and Sudeikis gave it to the world, and the world took it as wisdom. Maybe it is. Forgetting the bad play is a real skill on a basketball court and a real mercy in a hard life.

But a goldfish does not forgive. It just forgets. The same ten-second memory that lets you let go of an insult also lets you avoid the reckoning that an insult might require. Sudeikis built an entire philosophy, and a Type 9's entire life, on the gentlest version of looking away.

The doodle, the schedule for understanding, the anger held to a polite little toot, the fight routed quietly through lawyers while he says he would never condone it. A man trying, with everything he has, to be a goldfish. And the thing about the bad play is that it remembers you even when you have decided to forget it.

<!-- FRESH EYES REVIEW (2026-06-17)
Biggest issues:
- FACTUAL RISK in "What it is like to be in the room": "He shows up for Wrexham... the real-world Richmond." Wrexham is Ryan Reynolds and Rob McElhenney's club, not Sudeikis's. He's a longtime Man City fan; the AFC Wimbledon/Richmond link is geographic. He has *commented* on the Wrexham story paralleling Ted Lasso ("Good timing with Ryan Reynolds"), but the draft makes him sound personally involved with the club. Rewrite to "he watches the Wrexham story mirror his own" or cut — as written a soccer-literate reader will catch the conflation and it weakens the close.
- Missing the biggest contradiction available: his pre-Ted-Lasso film career. For a decade Sudeikis played cads, sleazes, and jerks — Horrible Bosses (coke-addled boss), We're the Millers, Hall Pass, Sleeping with Other People. The "kindest man on TV" spent years playing not-kind men. That's a sharper, more specific tension than the draft's current material, AND it strengthens the Nine read (he could access edge only inside safe, scripted comedy). Right now the body jumps SNL → Ted Lasso and skips the whole film run. A reader who knows him from those movies will feel the gap.

What to expand:
- The pattern of divorce. Sudeikis was married to screenwriter Kay Cannon (2004–2010) before Wilde. The draft frames the Wilde split as his one defining wound; noting an earlier marriage that also ended would deepen the "fights routed sideways / ruptures handled quietly" thesis rather than resting it on a single event.

What to trim:
- "Be the floor" / "the floor other people stand on" recurs in the intro-diagnosis, the SNL section, the room section, and the ending — four times. It's a strong image; one or two fewer hits would keep it from reading as a refrain.
- The goldfish/ten-second-memory appears in TL;DR, twice in body, and as the closing motif. Intentional callback, mostly earned, but the body's second mention is the most expendable.

Structural suggestions:
- A short film-career beat belongs between "The straight man from Overland Park" and "Why Sudeikis turned kindness into a system" — it's the natural bridge from utility-player SNL to author of Ted Lasso, and it's where the playing-jerks-on-screen contradiction pays off.

What's already working:
- The CinemaCon custody-papers open and the "both things are true" frame is excellent — concrete, unresolved, and it sets the real question (how one person produces both) instead of smoothing it.
- The empathy turn on the custody serving is genuinely earned, not pasted on: reading cruelty as a conflict-avoider's failure to fight cleanly is the strongest paragraph in the piece.
- "Pastry on his game" (Coach Campbell) is a perfect, specific, period-stamped detail. Keep it untouched.
- The Waddingham "control that never has to raise its voice" reading is the smartest non-obvious insight here — it's where the analysis earns its keep beyond the nice-guy surface.
- The Type 2 counterargument in the Rabbit Hole is handled well and correctly subordinated.
-->

<!-- SECOND PASS NOTES (2026-06-17)
Addressed:
- Wrexham factual risk fixed. Verified: Sudeikis is a longtime Man City fan and only commented on the club ("Good timing with Ryan Reynolds"); he has no involvement. Rewrote as him watching the real-world echo of his show belong to someone else, and named the Man City allegiance so a soccer-literate reader can't catch a conflation.
- Added new H2 "The decade Jason Sudeikis played the jerk" between Overland Park and kindness-as-system. Covers the womanizer/cad/drug-dealer film run (Horrible Bosses, We're the Millers, Hall Pass, Sleeping with Other People) and uses it to STRENGTHEN the Nine read: he can reach the edge, but only inside a script where it's someone else's. NOTE: fresh-eyes called Sudeikis's Horrible Bosses character a "coke-addled boss" — that's Colin Farrell's role; Sudeikis plays Kurt the horndog. Did not propagate the error.
- Added Kay Cannon marriage (2004, sep. 2008, divorced 2010) to the fights section to deepen the ruptures-handled-quietly thesis and to set up why Wilde was different (he couldn't control the narrative this time).

Kept as-is:
- Goldfish/ten-second-memory motif kept across body and close. It's the spine of the piece and the body's "when a Nine cannot be a goldfish" line earns the section-title callback. Trimming it would weaken more than it tightens.
- CinemaCon open, empathy turn, "pastry on his game," and the Waddingham "control that never has to raise its voice" reading all left untouched — they're the strongest material.

Still open:
- "Be the floor" trimmed from 4 hits to 2 (SNL line + one skippable rabbit-hole mention). Could drop the rabbit-hole one too, but it's low-visibility.
-->

<!-- EDITOR PASS NOTES (2026-06-17)
Cleaned up:
- Killed a stacked negative-parallelism cluster in the kindness-as-system section ("That is not naivety. That is a choice..." + "A Nine does not believe... A Nine decides...") — three AI contrast engines in one paragraph, now one direct statement.
- Broke the repeat of that same engine in the room section ("The Nine does not bark orders. The Nine simply...") into plain prose; kept the "control that never has to raise its voice" landing.
- Removed image-doubling in the SNL beat ("foundation other people stood on" + "became the floor" in three sentences); kept the "became the floor" punch.
- De-duplicated the "Here is the part..." section opener (used at two H2s); varied the first one.

Left untouched (earned, not tells):
- The intro "both things are true" / "not which one is real, but how one person produces both" frame.
