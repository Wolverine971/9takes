...
> "I have a greater drive from not wanting to fail than the drive of wanting to succeed. The fear of failure drives me more than greed or whatever it is."
>
...
Jensen's aunt and uncle, themselves recent immigrants trying to make sense of an unfamiliar country, found a school in Kentucky that sounded prestigious. The Oneida Baptist Institute. They enrolled the boys.
...
## "We Just Hit the Wall with a Splat"
...
Cleaned up:
- Removed all 8 body em-dashes (replaced with commas, colons, or period+sentence)
- Cut redundant closing paragraph ("He built the world's most valuable company not by conquering fear...") — the final 3 lines already do that work better
- Removed "By most measures," opener in management section (hedge)
- Removed "genuinely," from management section
- Fixed "essentially nonexistent" → "nonexistent"
- Broke "He gets X — the Y pattern" construction into two clean sentences

Still rough:
- The Type 6 intro section still opens with "Most people see Jensen Huang as a fearless visionary" which is a soft contrast opener; serviceable but not sharp
- The Enneagram type header ("Jensen Huang is an Enneagram Type 6") is slightly generic as a subhead

Production-ready: Yes. Strong draft with clear thesis, specific evidence throughout, original insights.
-->

<!-- SECOND PASS NOTES (2026-04-15)
Addressed:
- Removed false AGI claim from Rogan intro (was Lex Fridman, not Rogan)
- Near-death section rewritten with accurate 1996/1997 timeline: NV1 failure → 60% layoffs → $5M from Sega CEO → RIVA 128 launched with one month's payroll → "30 days" phrase born 1997. The draft had conflated these into one vague 1996 event and fabricated a separate 1998-1999 crisis I couldn't verify.
- Added new "The Bet Nobody Asked For" CUDA section between near-deaths and management architecture — covers 2006 CUDA launch, free to researchers, NVIDIA-only, 6-year bet before deep learning existed. Best evidence of Type 6 vigilance-as-strategy.
- Trimmed bullet list in Type 6 section (was 5 bullets duplicating TL;DR; replaced with 2-sentence prose that points to the same evidence without restating it)
- Reordered: moved Stanford speech after Tattoo/loyalty (both are about what Jensen transmits outward; management architecture section is about internal surveillance — grouping by theme creates more momentum)
- Sharpened closing: cut soft rhetorical question ("is he running toward something, or has the running become the point?"), replaced with declarative close ("The fear didn't shrink with the wins. It scaled with them.")
- Small Stanford speech edit: removed "three times" claim at the end (draft had it as "three times" but accurate count is two clearly documented near-deaths)

Kept as-is:
- Oneida Baptist Institute section — every word (best section in draft)
- Stephen Witt biographer quote + source card (good credibility work)
- 60-direct-reports reframed as surveillance architecture (most original insight)
- Full Rogan opening quote (correctly sourced)

Still open:
- Geopolitical vigilance angle (AMD, TSMC dependency, China export controls) not added — would require a new section and the draft is already well-paced. Could be an editor addition if the article needs more contemporary texture.
- Third "near-death" (CUDA-era mobile market retreat ~2007) not added — search results were vague; kept to two clearly documented crises rather than add a fuzzy third.
-->

<!-- FRESH EYES REVIEW (2026-04-15)
Biggest issues:
- The core thesis (fear is the engine) is fully stated by the end of the intro, restated in the TL;DR, restated again in the Type 6 section, and restated verbatim in the final section. The Joe Rogan "30 days" quote surfaces multiple times. By the final section, a reader has heard the same insight 4-5 times without it deepening — it starts to feel like padding around a single idea rather than a case being built.
- CUDA is completely absent. The 2006 decision to launch CUDA and essentially give it away free to researchers — over a decade before the AI boom validated it — is THE defining bet of Jensen's career and the strongest possible evidence of Type 6 vigilance (preparing for a threat/opportunity that hadn't arrived yet). A reader who knows Jensen's story will notice this gap immediately.

What to expand:
- The three near-death experiences: the draft promises them but only fully delivers one (the 1996 Sega story). The 1998-1999 section is two vague sentences. A reader wants the specifics — what was the third near-death? What did Jensen actually do each time? These are the best proof-of-concept moments for the fear-as-fuel argument.
- The AGI claim: the intro mentions Jensen told Rogan he'd "achieved AGI" and then completely drops it. This is a provocative act for a man supposedly gripped by fear and humility — the tension is interesting and deserved at least one sentence.
- Competitor/geopolitical vigilance: AMD, Intel, and Taiwan (TSMC dependency) are the real external threats Jensen tracks obsessively. Skipping these makes the vigilance feel abstract. The Section 232 export controls, the China market tension — these are live fears for a man who says he feels like he's 30 days from bankruptcy.

What to trim:
- The final paragraph's closing question ("is he running toward something, or has the running itself become the point?") is fine but soft given how sharp the setup was — it reads like a safe landing after a bold flight.
- The Type 6 explainer in "What is Jensen Huang's Personality Type?" runs long. The Peter Thiel comparison is a good hook, but the bullet list of evidence overlaps heavily with the TL;DR bullets. Either consolidate or cut one.

Structural suggestions:
- The draft currently flows: hook → type explanation → childhood → early NVIDIA struggles → management style → Stanford speech → tattoo/loyalty → closing thesis. Consider moving the Stanford speech closer to the tattoo/loyalty section — they're both about what Jensen transmits to others, while the management architecture section is about internal control. Grouping by theme rather than rough chronology might give more momentum.
- The CUDA story (if added) would fit best between the early near-deaths and the management architecture section — it's the bridge between "surviving" and "building a surveillance system because threats never stop."

What's already working:
- The Oneida Baptist Institute section is the best thing in the draft. The roommate exchange (Jensen teaches reading, roommate teaches bench pressing) is specific, vivid, and earns the Type 6 framing without having to explain it. Keep every word of it.
