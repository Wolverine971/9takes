...
keywords:
  ...
  - 'Logan Paul type 3'
  - 'Logan Paul Enneagram Type 3'
  - 'Logan Paul personality'
  - 'Logan Paul personality type'
  - 'Logan Paul analysis'
  - 'Achiever enneagram'
same_as:
  - 'https://en.wikipedia.org/wiki/Logan_Paul'
  - 'https://www.wikidata.org/wiki/Q24451685'
  - 'https://www.imdb.com/name/nm6982686/'
  - 'https://loganpaul.com/'
citations:
  - 'https://en.wikipedia.org/wiki/Logan_Paul'
  - 'https://www.wikidata.org/wiki/Q24451685'
  - 'https://www.imdb.com/name/nm6982686/'
  - 'https://www.foxnews.com/sports/logan-paul-suffers-serious-knee-injuries-wwes-crown-jewel-loss-roman-reigns'
...
FEEDBACK (2026-02-24) — RE-GRADE after revisions:
- Crown Jewel opening is a major improvement. "He tears his MCL, his meniscus, and possibly his ACL. He finishes the match." — specific, visceral, embodied. The bridge ("That image is the whole story. The phone is still out.") earns the thesis that follows.
- Counter-typing remains the analytical centerpiece: "A Type 7 avoids suffering. Logan volunteers for it." The "craft" vs. "explore" word-choice tell at the end is a nice addition. The "scoreboard" metaphor runs consistently and never feels forced.
- Evidence is the strongest dimension: 15+ attributed quotes, 5+ collaborator testimonies (Orton, Rollins, Triple H, Cody Rhodes, Nina), Bloomberg/Fox News/Bleacher Report sourced figures. Logan's voice is heard, not just summarized.
- The Janko vs. Majlak contrast remains the piece's signature structural insight — "He's still the co-host." lands like a punchline because it IS the argument.
- NEEDS WORK: The opening blockquote before the Crown Jewel scene slightly dilutes the hook — consider cutting it or relocating it to later in the piece. Some mid-piece sections (Puerto Rico tax paragraph, Prime business metrics) still read like report summaries rather than narrative.
- TO REACH B+: (1) Cut the opening blockquote — let Crown Jewel be the first thing the reader sees. (2) Compress or cut the Puerto Rico tax paragraph (it's contextual but disrupts narrative flow). (3) Find a sharper ending — the depression disclosure ("For the first time in my life, I was having suicidal thoughts") or the daughter quote ("I would die for these women") would cut to black at peak insight instead of the conventional "open question" close. (4) One more genuinely novel observation — something about the public/private gap or the brain scan section that reveals a non-obvious truth.
-->
...
<div class="panel">
<ul>
<li><b>Life as a scoreboard:</b> Followers, views, headlines, belts, deals. He builds his identity around wins.</li>
<li><b>Reinvention as reflex:</b> When one platform peaks or turns hostile, he pivots (YouTube → boxing → WWE → consumer products) without losing momentum.</li>
<li><b>Image repair as strategy:</b> When reputation collapses, he doesn't hide. He engineers a comeback storyline and tries to outwork the shame.</li>
<li><b>Legitimacy hunger:</b> He keeps chasing arenas with stricter rules (sports, business, live performance) where respect feels harder, and therefore more real.</li>
</ul>
</div>
</details>
...
In _Paul American_ (the HBO docuseries), Jake explicitly framed their upbringing as abuse. Logan resisted: "Jake will use the word 'abusive.' I will not because I don't believe we were abused." Same home, two different ways of making sense of pain.
...
Years later, on _The MMA Hour_, his reflection was more honest than any apology video: "Japan was the biggest blessing of my life. I needed a reset. I needed life to check me, and it did." He admitted he'd been chasing "clout, money, fame, wealth, which is all just superficial bullsh\*t, and it doesn't make a person great."
...
Cody Rhodes, [asked about Logan on The Undertaker's podcast](https://wrestlingheadlines.com/cody-rhodes-says-logan-paul-isnt-just-a-celebrity-experiment-says-undertaker-wouldve-loved-him/), offered a compliment that doubles as a character read: "He really doesn't have a reason... You don't have to do this." The implication: this isn't a publicity stunt anymore. He's here because he wants to be.
...
He titled the video "I have holes in my brain" and framed it as an explanation for everything: the controversies, the focus issues, the relationship patterns. For someone who'd just been called the worst person on the internet, finding a biological reason for bad judgment offers narrative relief: _maybe I'm not fundamentally broken. I'm injured, and I can fix it._
...
In _Paul American_ (the HBO docuseries), Nina described it as "the most traumatic experience of my life" and admitted she was "in such a dark place... I wanted to do things to myself I don't even want to talk about." Logan said simply: "It really took a piece of her soul."
