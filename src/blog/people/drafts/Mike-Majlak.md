...
production_pretext:
  ...
  requires:
    ...
    - image_check
  blockers: []
path: src/blog/people/drafts/Mike-Majlak.md
---
...
<details>
<summary class="accordion">TL;DR: Why Mike Majlak is an Enneagram Type 7</summary>
<div class="panel">
<ul>
<li><b>The escape artist:</b> A decade of cycling through OxyContin, heroin, cocaine, and crack. One substance after another, never sitting still long enough to feel what's underneath</li>
<li><b>Relentless reinvention:</b> After recovery, the same energy that drove his addiction powered a 100-lb weight loss, a bestselling memoir, and a podcast empire</li>
<li><b>The pain reframer:</b> His entire philosophy centers on transforming suffering into purpose, the signature move of a healthy Seven</li>
<li><b>The depth he almost missed:</b> His greatest work came from doing what Sevens resist most: sitting in the pain long enough to write about it</li>
</ul>
</div>
</details>

## The Brainiac Who Became the Dealer
...
A broken bone. A bottle of pills. A pharmaceutical industry that had decided pain was something to be eliminated rather than understood. For Mike Majlak, smart, restless, already drawn to the edge, the deck was stacked from the first pill.
...
That line reads like philosophy. It was written in blood.

---

## The Year Everything Screamed

2010 was, by Mike's own account, "the worst year of my life."

His grandfather was dying of Parkinson's and dementia, stuck in a recliner downstairs, screaming for help. Mike was upstairs, on parole, failing drug tests. The old man screaming below. The young man drowning above. Two people trapped in the same house, neither able to save the other.
...
Milligrams. Timelines. Exact protocols. Even in recovery, he processes the world as problems to be solved, systems to be optimized. The wiring never shuts off. It just found better coordinates.

## 285 Pounds and a Bucket List

Mike Majlak walked out of rehab weighing 285 pounds.

He started cycling. Then the gym. Then running. Within a year, he had lost over 100 pounds. The physical work tracked with something internal. A body that had carried a decade of poison, deliberately rebuilt.

But the detail that matters most came next. He made a bucket list.

Not a vague "someday" list. A concrete, specific, written-down inventory of everything he wanted to experience now that he was alive enough to want things again. And then he started checking items off. One by one. Marketing career. Move to a new city. Build something.

"Looking back," he's said, "I've checked off pretty much every single one of them."

A person who just escaped a decade of darkness, and the first thing his brain generates isn't rest, isn't stillness. It's _what's next?_ The hunger that nearly killed him simply changed targets.
...
That campaign brought the two of them closer. Mike became part of Logan's inner circle, then his co-host. In November 2018, they launched [Impaulsive](https://youtube.com/impaulsive), which would grow to over 900 million YouTube views and regularly top the podcast charts. By 2025, the show had joined the WWE and Fanatics digital content network. Mike was still at the desk.
...
- **The immediate pivot to reinvention:** The bucket list. The weight loss. The marketing career. The podcast. The book. The speaking circuit. Most people who survive a decade of heroin addiction take years to stabilize. Mike came out swinging. The same brain that generated "what if I tried heroin?" generated "what if I lost 100 pounds and moved to LA?"
...
- **The pros and cons list:** When his relationship with [Lana Rhoades](/personality-analysis/lana-rhoades) became complicated, Mike didn't sit with the ambiguity. He made a literal pros and cons list, organized into "Major Dealbreakers That Require Deep And Radical Change" and "Minor Issues That Some People Would Consider Dealbreakers." He systemized his feelings. He turned emotional complexity into a spreadsheet. That's a Seven trying to think their way out of feeling.
...
The Enneagram makes something click here that otherwise wouldn't: Mike's addiction and his success aren't different chapters. They're the same chapter, written in different ink. The mind that burned through every substance in Connecticut is the same mind that sold two million beanbags, built a podcast empire, and wrote a bestselling memoir. Same hardware. Different direction.
...
But he didn't quit cleanly. They broke up. Got back together. Planned to move in. He backed out the day he was supposed to move in. They rebuilt. Planned to move in again. He bailed a second time.
...
During one of those splits, he hooked up with Ava Louise, the reality TV personality from Dr. Phil. The tabloid chaos that followed was predictable. But the pattern was the point: in the gap between one version of the relationship and the next, the Seven didn't sit with the loss. He filled the space.
...
After Lana, the pattern continued at lower volume. He dated Sara Maughan, an influencer, going public in mid-2023. By 2024, she had quietly disappeared from his content. As of 2026, he keeps his romantic life private. The Seven who once played out every relationship on camera learned, eventually, that some things work better without an audience.
...
His advocacy work (Shatterproof speaking engagements, recovery podcasts like The Big Silence, _The Fifth Vital_ hitting the USA Today bestseller list its first week and distributed to prisons and rehabs worldwide) represents something specific in Enneagram terms. It's the Seven integrating toward [Type 5](/enneagram-corner/enneagram-type-5): trading scattered breadth for focused depth. Fifteen years clean and counting. Instead of chasing the next experience, he's going deeper into the one experience that defines him. His pain. His recovery. The story he tells not because it's exciting, but because it saves lives.

He talks to his audience the way a sponsor talks to a newcomer at a meeting. Direct, specific, no bullshit. "Start a taper TODAY." "You're still here for a reason." He treats his followers like adults who need concrete information, not inspiration porn. That directness is why people trust him.

> **Disclaimer:** This analysis of Mike Majlak's Enneagram type is speculative, based on publicly available information, and may not reflect the actual personality type of Mike Majlak.

## The Fifth Vital

There's a moment in recovery literature that addicts call "the gift of desperation." It's the point where the pain of staying the same finally exceeds the pain of changing. For Mike Majlak, that moment came in 2010, in a house where his grandfather screamed downstairs and his parole officer waited on the other end of a phone line.

But the Enneagram suggests something sharper. For a Seven, the gift isn't desperation. It's _stillness_. The moment you stop generating alternatives, stop reframing, stop pivoting to the next possibility. And just sit in what is.

Mike sat at that keyboard writing _The Fifth Vital_ and his tears hit the keys and he stayed. He sat in a rehab for 90 days when every nerve ending was screaming _leave_. He sat in therapy when his brain was generating seventeen reasons why he didn't need it. He sat with the story of his worst decade and turned it into the thing that would help the most people. And he sat back down at his mother's table, the same mother who kicked him out years earlier, and rebuilt something he'd burned to the ground. Today his family is close again. His mom, his sisters. The relationships that addiction hollowed out, filled back in.

The fifth vital sign is pain. Purdue Pharma invented the concept to sell more drugs. Mike Majlak's entire life is an argument that they got it exactly backwards. Pain isn't something to be eliminated. It's something to be sat with, understood, and transformed. He's still moving, of course. New Night Shift episodes. Impaulsive on the WWE network. New collaborations. But now there's a depth underneath the motion. The keyboard covered in tears, the mic in front of his face, the truth about the worst years of his life offered to anyone who needs to hear it.
...
WHAT'S STRONG:
- The opening image (tears on the keyboard) is genuinely arresting. Best hook in a while.
- The Purdue Pharma / "fifth vital sign" thread tying the memoir title to the systemic cause is well done and gives the piece real-world weight.
- The Lana Rhoades section is the strongest Enneagram work here — the pros/cons list decoded through the Seven lens is specific, concrete, and actually illuminating. That's the kind of thing a fan reads and goes "oh damn, I never saw it that way."
- The "engine didn't change, the fuel did" framing is a clean thesis that holds the whole piece together.

WHAT'S MISSING / SHOULD EXPAND:
1. The Logan Paul relationship gets surface treatment. Mike was Logan's co-host for YEARS and the split/departure from Impaulsive is a huge part of his story that fans care about. Why did he leave? How does a Seven handle the end of a partnership that defined his platform? There's Enneagram gold in that departure and it's completely skipped.
2. No mention of the Ava Louise situation or any of the other public dating controversies post-Lana. His pattern with women is arguably the most visible expression of the Seven escape pattern, and you only cover one relationship.
3. His current trajectory — what's he actually doing NOW? The Night Shift mention is vague. Is he still tight with Logan? What's his relationship to the broader creator ecosystem in 2025-2026? The piece feels like it ends in ~2022.
4. His relationship with his family post-recovery. His mom kicked him out. His dad coached basketball. You set up the family dynamics early but never close that loop. Did he reconcile with his mom? What's that relationship like now? A reader who knows Mike's story would want that resolution.
5. The book's actual impact could use one more beat — you mention it was distributed to prisons and rehabs but a sales number or a specific reader story would make that land harder.
6. His fitness/body transformation content is a huge part of his brand and barely gets a paragraph. The cycling obsession, the gym content — this is the Seven's replacement addiction playing out in real time and it deserves more than a passing mention.

WHAT'S OVERDONE / COULD TRIM:
1. The "engine" metaphor is used about 6-7 times (possibility engine, the engine never stops, same engine, content engine, anxiety engine, the engine never stops again in the conclusion). It's a good metaphor but it's doing too much work. Cut at least 2-3 instances and let other language carry some sections.
2. The rehab/detox specifics (80mg methadone, 2mg taper, 5mg inpatient) — the tactical detail is interesting but the paragraph then tells us "the tactical specificity reveals something about how his mind works." You don't need to explain the device you just used. Let the reader feel it. Cut the meta-commentary.
3. The conclusion retreads ground. "He's still running, of course" and the keyboard tears image are both callbacks to earlier sections and the piece starts to feel circular rather than building to something new. The last two paragraphs could be tightened into one.

DUPLICATE / REDUNDANT:
- "The engine never stops" appears almost verbatim in both the recovery section and the conclusion.
- The bucket list anecdote is introduced ("But the detail that matters most came next") and then explained ("That bucket list is the most Seven thing..."). The explanation paragraph is doing work the anecdote already did. Trust the reader more.
- "Always the next substance" appears in both the intro and the TL;DR. Minor but noticeable.

TONE CHECK:
- The Purdue Pharma line "Mike Majlak — smart, restless, already drawn to the edge — never stood a chance" is strong but borders on removing his agency. Given that the whole piece is about him RECLAIMING agency, you might want to soften that to something like "the deck was stacked against him" rather than "never stood a chance."
- "That line reads like philosophy. It was written in blood." — This is a great line but it's doing a lot of heavy lifting for what is essentially a restatement of the Purdue critique. Might land harder if the preceding quote was more philosophically surprising.

WHAT A MIKE MAJLAK FAN WOULD WANT:
- More on the Impaulsive exit and what that cost him
- His perspective on Logan's WWE/Prime trajectory vs his own path
- The specific addiction recovery resources/orgs he works with (beyond just "Shatterproof")
- His relationship with his audience — he's unusually candid with his followers and that dynamic is part of what makes him compelling
- Any mention of his comedy/entertainment side — the guy is genuinely funny and that's part of the Seven charm that's mostly absent from this piece
-->

<!-- SECOND PASS NOTES (2026-04-10)
Addressed:
- Engine metaphor: cut from ~7 uses to 3 (all in the Enneagram analysis section where "possibility engine" is the actual term). Replaced others with "wiring," "momentum," "fear circuitry."
- Methadone meta-commentary: trimmed the "tactical specificity reveals" paragraph to two punchy sentences. The detail speaks for itself now.
- Bucket list over-explanation: cut the "most Seven thing" paragraph. Reader gets it from the anecdote.
- Conclusion: merged last two paragraphs into one, added family reconciliation beat, replaced "engine never stops" with "He's still moving." Conclusion now builds forward instead of circling.
- "Never stood a chance": changed to "the deck was stacked against him from the first pill" — preserves systemic critique without stripping agency.
- "Always the next substance" TL;DR duplicate: changed to "one substance after another."
- Added Ava Louise beat in relationships section (strengthens the Seven escape pattern with a second data point).
- Added post-Lana dating (Sara Maughan, current privacy) to close the relationship arc.
- Added Impaulsive joining WWE/Fanatics network (2025) — updates the piece to current.
- Added humor/comedy note in the Logan dynamic paragraph.
- Added audience candor paragraph in advocacy section (sponsor-to-newcomer directness).
- Added USA Today bestseller detail, The Big Silence podcast, "fifteen years clean" to advocacy section.
- Added family reconciliation in conclusion (mother's table, rebuilt relationships).

Kept as-is:
- "Written in blood" line — the review suggested it might be overwrought but it lands as a gut-punch one-liner after the Purdue Pharma quote. Cutting it would flatten the transition.
- Fitness/body transformation section was not expanded into its own section. The cycling/gym content gets mentioned in the bucket list section, the Lana pros/cons list, and the replacement-addiction framing. A dedicated fitness section would dilute the Enneagram focus without adding analytical value.

Still open:
- The fresh-eyes review wanted more on a Logan/Mike "split" from Impaulsive. Research confirms Mike is still co-hosting as of 2025 — there was no departure. If future events change this, the podcast section should be updated.
- Logan's WWE/Prime trajectory vs Mike's own path: interesting contrast but would require speculative framing that doesn't fit the evidence-based approach. Could be a sidebar if the piece ever needs expansion.
- Specific reader stories or copy-count for The Fifth Vital: not publicly available. USA Today bestseller status is the strongest available proof point.
-->

<!-- EDITOR PASS NOTES (2026-04-10)
Cleaned up:
- Removed all em-dashes from body text (13 instances). Replaced with periods, commas, colons, or parentheses depending on context.
- Reduced "engine" metaphor from 5 uses to 2 (kept "possibility engine" in the Enneagram definition only). Replaced with "brain," "mind," "wiring" where appropriate.
- Converted evidence bullet separators from em-dashes to colons (consistent with TL;DR formatting).
- Tightened fitness paragraph: cut "mirrored an internal one" and "rebuilt from the inside out" (both stock phrases).
- Fixed clunky quote attribution in relationships section ("he said, 'and a relationship...'").
- Cut "There's an irony there that" down to "An irony."
- Changed "at scale" to "top creators" (clearer).
- Summary paragraph: "Same hardware. Different direction." replaces "The wiring is identical. The direction changed." (varies the metaphor register).

Still rough:
- Title still has one em-dash (frontmatter convention, left as-is).
- The "This isn't optimism. It's architecture." line is technically negative parallelism but earns its keep as a one-off analytical punch. Left it.
-->
