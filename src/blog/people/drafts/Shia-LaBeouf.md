...
keywords:
  ...
  - 'Shia LaBeouf type 8'
  - 'Shia LaBeouf Enneagram Type 8'
  - 'Shia LaBeouf personality'
  - 'Shia LaBeouf personality type'
  - 'Shia LaBeouf analysis'
...
path: src/blog/people/drafts/Shia-LaBeouf.md
---
...
<p class="firstLetter">When Shia LaBeouf was three years old, his father Jeffrey stole a maid's cart from a Best Western, painted it with streamers, loaded it with hot dogs and shaved ice, and dressed the entire family in full clown regalia. They went to Echo Park to perform for strangers and sell food from the sidewalk.</p>
...
<details>
<summary class="accordion">TL;DR: Why Shia LaBeouf is an Enneagram Type 8</summary>
<div class="panel">
<ul>
<li><b>Performing to survive since age 3:</b> His childhood was built on making strangers pay attention — clown family, stand-up comedy at ten, Disney by twelve — and the pattern never stopped.</li>
<li><b>Confession as control:</b> Every public apology is as loud and intense as the destruction that preceded it. The vulnerability is real. It's also a power move.</li>
<li><b>Love and violence from the same source:</b> His father was the origin of all trauma and all celebration. Shia wrote a film exposing the abuse, then recanted everything.</li>
<li><b>The cycle that won't break:</b> Genuine monastic conversion, daily AA, desire to become a deacon — then headbutting a stranger at Mardi Gras and dancing on Bourbon Street with jail paperwork in his mouth.</li>
</ul>
</div>
</details>
...
When this energy collapses under extreme [pressure](/enneagram-corner/enneagram-types-in-stress), it inverts. He doesn't rage louder — he goes silent. The #IAMSORRY installation. Four months in a monastery with Capuchin friars. Long stretches of public invisibility after each crisis. The explosion gives way to isolation and internal processing. Then the cycle restarts.

At his best, the same force reverses direction and builds. A free theater company for South Central LA. A sixty-person daily recovery group. A film made for no salary because the spiritual experience mattered more than the money. When the engine that destroys turns toward [service](/enneagram-corner/enneagram-type-2), it can build things that matter.
...
<!-- Future improvement: Add FKA Twigs' own words about why women don't leave abusive relationships. Her 2022 interview would provide a powerful counterpoint voice. -->
...
<div class="source-card">
  ...
  <div>
    <div class="source-card__title">Bishop Barron Interviews Shia LaBeouf</div>
    <div class="source-card__meta">August 2022 · Word on Fire · ~80 min</div>
    <div class="source-card__note">"At this point, I am so nuclear, even my own mother won't talk to me."</div>
  </div>
</div>

<div class="pull-quote">
"Shame like I had never experienced before — the kind of shame that you forget how to breathe. You don't know where to go. You can't go outside and get like, a taco."
</div>
...
<div class="contrast-panel">
  <div class="contrast-panel__side contrast-panel__side--left">
    <div class="contrast-panel__label">February 7, 2026</div>
    <p>Shia was filmed on a New Orleans street talking to strangers about church. Asking if they attended. Discussing faith with passersby.</p>
  </div>
  <div class="contrast-panel__side contrast-panel__side--right">
    <div class="contrast-panel__label">February 17, 2026</div>
    <p>Arrested outside R Bar in the Faubourg Marigny at 12:45 AM. Headbutted a man. Punched bar patrons. Allegedly shouted homophobic slurs at a man wearing eye makeup and lipstick. Two counts of simple battery.</p>
  </div>
</div>
