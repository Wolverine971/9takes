...
keywords:
  - 'Theo Von enneagram'
  - 'Theo Von type 7'
  - 'Theo Von Enneagram Type 7'
  - 'Theo Von personality'
  - 'Theo Von personality type'
  - 'Theo Von analysis'
  - 'Enthusiast enneagram'
same_as:
  - 'https://en.wikipedia.org/wiki/Theo_Von'
  - 'https://www.wikidata.org/wiki/Q7781503'
  - 'https://www.imdb.com/name/nm0961918/'
...
citations:
  ...
  - 'https://www.theovon.com'
faqs:
  - question: 'What is Theo Von''s Personality Type?'
    answer: 'Start here: "Sometimes you always feel eight years old, don''t you?" Theo told Dax Shepard. "I have to actively remind myself I''m not. It''s like a mantra." The forty-five-year-old podcast host, fronting one of the biggest shows on the planet, still has to run a daily checklist to convince himself he isn''t the tiny kid he once was.'
    anchor: 'what-is-theo-vons-personality-type'
  - question: 'Why is Theo Von typed as an Enneagram Type 7?'
    answer: 'The Type 7 case rests on the reframing-as-survival pattern that runs through his life: a childhood that should have broken him became his comedy goldmine, every wound got transformed into a bit before it could settle, and his deepest fear shows up as commitment terror — the 7''s anti-trap reflex misfiring inside relationships. His current crisis — quitting antidepressants to feel something real — is exactly the move a 7 spends a lifetime avoiding.'
    anchor: 'why-is-theo-von-typed-as-an-enneagram-type-7'
twitter: 'TheoVon'
instagram: 'theovon'
tiktok: 'theovon'
...
<!-- ============================================================
OUTREACH-PASS REVIEW — 2026-05-19 (DJ emailed Theo Von)
Full editorial doc: docs/content-analysis/dillon-von-outreach-review-2026-05-19.md
============================================================

CRITICAL CONTEXT:
- Two quotes that previously appeared in this profile ("I liked cocaine…" and "The main gift God had given me was my voice…") were also showing up word-for-word in Tim Dillon's profile. They live here legitimately (the voice quote is rooted in Theo's Opie & Jim Norton / Darryl Strawberry arc). They've been removed from Tim's draft. If either subject reads both profiles, the duplication risk is gone.

LIGHT FIXES APPLIED THIS PASS:
- Antidepressant timeline reconciled. Earlier this draft said "nearly twenty years" in the opener and "got on antidepressants when I was 20" later — Theo is 45, so that's nearly 25 years. Opener now reads "for most of his adult life" to avoid pinning a number.
- The Dax Shepard mantra quote that included "you're 49" has been trimmed. Theo is 45; the "49" in the YouTube auto-transcript (theo-von-dax.md:179) is almost certainly a transcription error or Theo misspeaking a mantra-number. The psychological point of the quote doesn't need the age.
- "What he's described as bipolar symptoms" softened to "what he's described as depression, anxiety, and mood swings" — local transcripts have no Theo mention of "bipolar." He has said "mildly manic" once. If a direct "bipolar" quote can be cited, restore.
- The FAQ answer in the frontmatter (`what-is-theo-vons-personality-type`) was also using the "49" version of the mantra; it now matches the body.

FOLLOW-ON TWEAKS (same-day improvement pass):
- "Trump talked about his brother Fred's death from addiction" tightened to "his older brother Fred Jr.'s death from alcoholism — the loss that has shaped his lifelong refusal to drink." More precise, and the editorial aside lands the point Trump kept making to Theo about why he doesn't drink.

STILL OUTSTANDING (needs DJ verification before next push):
1. ALL September 2025 specifics need external news citations or softened language:
   - Beacon Theatre disaster: "a third of the audience walked out," the suicide-adjacent comment, "I'll eat failure for breakfast"
   - Charlie Kirk assassination Sept 10, 2025 at Utah Valley University
   - DHS reposting the "Heard you got deported dude, bye" clip on Sept 23, 2025
   The piece reads them as factual; the local transcripts file `youtube-transcripts-people/theo-von-review.md` already flagged them as `[MEDIUM] not found in direct transcripts.` If any specific is wrong, Theo will notice immediately.
2. Father Roland's biography (born ~1910 Bluefields Nicaragua, alleged CIA/Contra ties, married Gina Capitani 36 years his junior) is load-bearing for the whole piece. Flagged HIGH in the existing review file. Verify against Wikipedia / Theo's own podcast tellings.
3. Specific numbers to verify: "4th biggest podcast globally on Spotify" by 2024; Trump episode "16 million views"; TIME100 Creators inaugural list July 2025; "won twice" on The Challenge.
4. "Trump talked about his brother Fred's death from addiction" — Trump's brother was Fred Jr. ("Freddy"). Worth being precise.
============================================================ -->

<!-- ============================================================
DEPTH-EXPANSION PASS — 2026-05-19 (post-outreach)
============================================================

GOAL: Take the B+ piece and deepen the lore so that the analysis feels
irreplaceable, not generic. Address the April-2026 unresolved feedback that
the Type 7 framework fades after the first three sections.

CHANGES MADE THIS PASS:

1. Roland (father) section expanded with authentic Theo anecdotes pulled from
   the Pete Davidson interview (youtube-transcripts-people/pete-davidson-theo-von.md):
   - The Cutlass with bass-cranked Rush Limbaugh / Paul Harvey
   - Roland dozing off in the carpool line ("driving 9/11")
   - "His eyes would like leak... gaskets get bad"
   - Theo: "I was prepared that things weren't going to go well"
   Half-siblings from Roland's prior marriage (one was 57 when Theo was 8) added
   from theo-von-dax.md.
   Re-threaded the 7's wound explicitly into Roland's parenting failure.

2. MTV → stand-up decade reframed with Type 7 psychology:
   - The MTV decade as the perfect 7 format (constant motion, no settling)
   - Stand-up grind as the FIRST place Theo did the opposite of his pattern
   - Comedy Store Belly Room third spot added (from theo-von-joe-rogan.md)
   - "Gang Gang" lore tied back to "first audience was a mother who couldn't
     look at him" — payoff for the Tim Fletcher quote earlier in the piece

3. Type 7 framework re-threaded through three later sections (was the April
   feedback's #1 unresolved note):
   - Fuse Monkey: explicit naming of the 7's core fear (being trapped),
     reframes cheating/commitment-terror as anti-trap reflex misfiring inside
     intimacy
   - Convergence: explicitly names that Theo at the Beacon was DOING THE
     OPPOSITE of what a 7 does (sitting in pain instead of reframing it).
     Closing line: "The cage door was open. The cage turned out to be the only
     thing he knew how to live inside."
   - Nashville: new dedicated section "What Nashville Was For" that frames the
     move as the 7→5 integration arc (depth, repetition, presence over novelty)

4. Nashville expanded from one paragraph at the end into its own section:
   - The "expectations are resentments under construction" quote (from
     theo-von-dax.md line 1235) added as the 7's mantra for arriving without
     chasing
   - Bible study reframed as the 7→5 integration practice
   - Oak Hill detail preserved

5. SEPT 2025 specifics softened where unverified:
   - "On September 10th" → "In early September"
   - "Shot by a gunman positioned on a nearby rooftop" — removed
   - "On September 23rd" → "A few weeks later"
   - "A third of the audience walked out" → "A large portion of the audience
     walked out"
   - "He left the stage repeatedly. The set fell apart. People walked out." →
     "He left the stage more than once. The set fell apart. Reviews of the
     night were unsparing."
   - Removed brittle "4th biggest podcast globally on Spotify" and "over 16
     million views" — softened to "one of the largest podcasts in the world"
     and "an audience in the tens of millions"
   - Antidepressant timeline ("nearly two decades") aligned with rest of piece

STILL OUTSTANDING:
- TIME100 Creators inaugural list July 2025 specific kept; flag for DJ verify
- Roland Bluefields/CIA/Contra biography still needs Wikipedia cross-check
============================================================ -->

<!-- ============================================================
FACT-VERIFICATION PASS — 2026-05-19 (third pass, post-depth-expansion)
============================================================

GOAL: Cross-check every factual claim against external sources (Wikipedia, TIME,
CNN, NBC News, Variety, Rolling Stone, Christian Post, news coverage of the
Beacon Theatre taping and DHS clip).

CORRECTIONS APPLIED:

1. Roland's birth year was WRONG. Draft said "around 1910" and "70 years old"
   when Theo was born. Per Wikipedia and multiple secondary sources, Roland
   was born in 1912 and was 67 when Theo was born in March 1980. Theo himself
   rounds it up to 70 when telling the story (see Pete Davidson interview),
   which is why the error existed. Now corrected to "67 years old" with an
   explicit note that Theo rounds to 70. The Pete Davidson direct quote
   ("So he was 86 at that time") is left verbatim since it's Theo speaking.

2. Removed "Duke graduate" from Gina Capitani description — unverified.
   Wikipedia and secondary sources say she was born/raised in Wyoming, IL;
   no Duke connection found. Kept "Irish-Italian descent" (confirmed).

3. Roland's CIA/Contra ties and mahogany farming explicitly attributed to
   Theo's own telling, with the caveat that they are "not independently
   verified" — accurate framing of the public record.

4. RESTORED specifics that had been over-softened in the earlier pass, now
   that they're verified:
   - Beacon Theatre date: September 27, 2025 (Saturday)
   - "Around a third of the audience walked out" (reported in coverage)
   - Exact quote: "I'm having a long month. I'm trying not to take my own
     life" (Theo to fans outside Beacon)
   - Exact quote: "I eat failure for breakfast, brother" (Rolling Stone /
     Variety, This Past Weekend follow-up episode)
   - Charlie Kirk: September 10, 2025 at Utah Valley University, shot in the
     neck by a sniper from a rooftop ~142 yards away (FBI / news coverage)
   - DHS clip: posted September 23, 2025; taken down September 25, 2025
     (CNN, NBC News, Deadline, Hollywood Reporter)
   - Trump podcast: over 16 million YouTube views (TIME confirmed)
   - Spotify: 4th-biggest podcast globally in 2024 (Wikipedia / Spotify
     announcement)
   - TIME100 Creators: confirmed, inaugural list announced July 9, 2025,
     Leaders category
   - This Past Weekend launched December 2016
   - Hasan Piker episode #567, March 7, 2025

5. Bible study quote replaced with better-sourced version: "I'm gonna see
   him tomorrow, Bible study, actually" + "I'm not sure what chapter we're
   on. I shouldn't have said that." (Christian Post / Whiskey Riff coverage,
   from his exchange with Leanne Morgan).

6. Bernie Sanders "very disarming" framing corrected — the quote is Sanders
   describing TRUMP (not Theo) during his own Theo Von episode #524 (August
   14, 2024). Reworded to "Sanders, on the same show, gave Trump the rare
   political compliment that he was 'very disarming.'"

7. Nashville move + house purchase: Wikipedia says Theo moved in September
   2020; news reporting says the Derek Mason house purchase was March 2021
   for $1.64M. Both timings now present in the section. "Oak Hill" preserved
   as Theo's own description of where he lives (Dax interview), though news
   reports describe the property location loosely (Green Hills / Lealand
   Lane area, ~20 minutes from downtown).

REMAINING UNVERIFIED (Theo's own claims, not independently confirmed):
- Roland's CIA / Nicaraguan Contras / smuggling background — now framed as
  Theo's own telling rather than asserted fact
- The half-sibling-was-57-when-Theo-was-8 detail (from Theo's Dax interview,
  consistent with documented half-siblings from Roland's prior marriage)
- "Fawning... a Bambi in Memphis" quote
- "I've cheated in every relationship I've ever been in" quote — these are
  Theo's own statements on his podcast; not externally fact-checkable but
...
<details>
<summary class="accordion">TL;DR: Why Theo Von is an Enneagram Type 7</summary>
<div class="panel">
<ul>
<li><b>The reframing machine:</b> A childhood that would break most people became his comedy goldmine. The cost? He's only now confronting it.</li>
<li><b>The charm that disarms everyone:</b> Politicians, podcasters, and strangers all open up to him in ways they don't with anyone else. The kid who earned his keep by being entertaining never stopped performing.</li>
<li><b>The fuse monkey:</b> Cheating, commitment terror, and late-night self-sabotage loops. His relationship patterns reveal the wound his comedy hides.</li>
<li><b>The night the armor cracked:</b> What happened at the Beacon Theatre tells you more about Theo Von's psychology than any interview ever could.</li>
</ul>
</div>
</details>
...
The Bible study with [Morgan Wallen](/personality-analysis/morgan-wallen) is the part of the new life that signals the deepest shift. "I'm gonna see him tomorrow, Bible study, actually," Theo casually mentioned on his podcast — then, when asked what they were studying: "I'm not sure what chapter we're on. I shouldn't have said that." So perfectly Theo — even his faith has an exit door; he keeps the tone light, undercuts the sincerity before it can land too hard. But he keeps showing up. For a man whose survival strategy has always been to leave before he can be left, the act of returning, week after week, to the same room, with the same people, for something he can't spin into a punchline, may be the most quietly radical thing he does. It's exactly the kind of slow, repetitive, depth-over-novelty practice that a 7 integrating toward 5 has to learn.
