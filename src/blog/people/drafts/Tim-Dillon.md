...
wikidata_qid: 'Q104601374'
imdb_id: 'nm3645534'
birth_date: '1985-01-22'
birth_place: 'Island Park, New York, United States'
...
knows_about:
  ...
  - 'Actor'
keywords:
  - 'Tim Dillon enneagram'
  - 'Tim Dillon type 7'
  - 'Tim Dillon Enneagram Type 7'
  - 'Tim Dillon personality'
  - 'Tim Dillon personality type'
  - 'Tim Dillon analysis'
  - 'Enthusiast enneagram'
same_as:
  - 'https://en.wikipedia.org/wiki/Tim_Dillon_(comedian)'
  - 'https://www.wikidata.org/wiki/Q104601374'
  - 'https://www.imdb.com/name/nm3645534/'
  - 'https://timdilloncomedy.com/'
citations:
  - 'https://en.wikipedia.org/wiki/Tim_Dillon_(comedian)'
  - 'https://www.wikidata.org/wiki/Q104601374'
  - 'https://www.imdb.com/name/nm3645534/'
  - 'https://timdilloncomedy.com/'
faqs:
  - question: 'What is Tim Dillon''s Personality Type?'
...
> <cite>Death, Sex & Money (WNYC), September 21, 2016</cite>
...
The first line happened in his friend Tina's backyard. "We did a few, and then we started to do it somewhat regularly," he told _Death, Sex & Money_ in September 2016. Marijuana at 13 escalated to cocaine, acid, and ecstasy. The drug of choice was always cocaine, and always alone.
...
By his early twenties, he was working at a mortgage bank during the subprime crisis. He wrote about it later on his Tumblr (October 2016):
...
> <cite>First Order Historians, February 2016</cite>
...
> <cite>@TimJDillon on X, November 14, 2021</cite>
...
If you listen to enough episodes, you notice that Tim has been tracking the story for weeks. He knows the players. He knows the prior beats. He knows what the official version is and where it cracks. He doesn't cite his research on-air because citing it would break the bit. But you can hear that he's done it.

The audible evidence runs through three years of episodes. In 2020 and 2021 he hosted investigative journalist Whitney Webb four times in a twelve-month window — Episodes #196 (Epstein and Bill Gates), #207 (the Maxwell family's intelligence ties), #226 (election security and Silicon Valley-government fusion), and #246 (CIA history). Four appearances on one journalist's beat in one year is reading her work as she publishes it. On #196, Webb chose Tim's show as the place to play audio from a then-unreleased phone interview with Epstein victim Maria Farmer. She trusted him not to break the material for the joke.

By 2025 the prep had compounded. When [Ryan Grim](/personality-analysis/ryan-grim) of Drop Site News came on in December to walk through the latest Epstein file revelations, Tim compressed years of court filings into a single comic frame: "When they say there was no Epstein operation, it's like the guy's been doing a lot of operating for many decades. At some point, you have to call that an operation." The line only lands if the audience trusts he's read the filings.
...
He has a dedicated episode (#218), an entire merchandise line, and "CEO of Fake Business" in his social media bios.
...
Tim doesn't pick political sides. This infuriates people on all political sides — and 2025 is the year that became impossible to miss.

In April, the Gateway Pundit ran a piece headlined "Comedian Tim Dillon on the Craziness of the Left — When Did Basic American Values Like Free Speech Become Right Wing?" Conservative media was actively trying to draft him as a movement asset. The next month, CNN's Elle Reeve aired an interview framing him as "a gay Rush Limbaugh" — left-coded media trying to brand him as a right-wing menace. Tim's response to the comparison: "I try to make a show that's interesting and entertaining and that's worth someone's time. As long as you're listening to me, I don't care if you agree with me or not. I think Limbaugh cared." Five months later, he ran an extended riff naming Peter Thiel, Sam Altman, Joe Lonsdale, and Palantir as the architects of a "post-American future" — torching the right's coalition the same year the right was branding him an ally.
...
> <cite>Hollywood in Toto, February 2021</cite>

His position on free speech is consistent: distrust anyone trying to claim you. Speaking on Fox News in April 2025, he warned: "I think the parties flip, but I think they might flip again." His worry: a Republican Party that goes anti-free-speech the moment it has the leverage to deport op-ed writers, and a Democratic Party that suddenly rediscovers the First Amendment when it's out of power.

## The Sobriety Question

In April 2024, Tim published "Death by Boomers," a long essay on how his Long Island boomer parents went from long-haired hippies to addicts of "grievance mongering, paranoia, and fear." The parenting style produced, in his own diagnosis, "a near perfect person: a closeted gay cocaine addict who enthusiastically supported the Iraq War and didn't get a credit score until he was 36." Three Netflix specials have followed since 2022. They sell. The podcast self is still sharper than the Netflix self, and a Type 7 will always find the structured format slightly suffocating.

Looking back from his first real breakthrough year, he told an interviewer in 2021:
...
> <cite>Tim Dillon Tumblr, October 2016</cite>
...
The kid raised by a parent whose reality was negotiable became the man who makes a living naming what's negotiable about everyone else's. The closeted addict became the fearlessly open provocateur. The foreclosure victim became the real estate investor. The boy who did the polka with Snuffleupagus became the CEO of Fake Business. King Pig. Life in the big city.
...
<!-- ============================================================
OUTREACH-PASS REVIEW — 2026-05-19 (DJ emailed Tim Dillon)
Full editorial doc: docs/content-analysis/dillon-von-outreach-review-2026-05-19.md
============================================================

CRITICAL FIX APPLIED THIS PASS:
- Two quotes were duplicated in BOTH this profile and Theo Von's profile, almost certainly mis-attributed from a Theo draft:
    (a) "I liked cocaine because I would get it and do it by myself" (was line 149)
    (b) "The main gift God had given me was my voice…" (was line 99)
  Both were removed from this file in the 2026-05-19 pass. The "voice" quote belongs to Theo's Opie & Jim Norton / Darryl Strawberry story, not Tim's egret incident. Replace with a sourced Tim quote in a future pass if a direct quote is needed in those positions.

LIGHT FIXES APPLIED THIS PASS:
- Added a date lead-in to the "I'm 36 years old…" Damian Reilly quote so the temporal context lands inline rather than only in the cite.
- Reworded the "schizophrenic mother → schizophrenic comedy style" parallel so DJ's prose doesn't tie his mother's diagnosis to a stylistic descriptor of Tim's comedy. The earlier "critics call it 'schizophrenic style'" attribution remains.

FOLLOW-ON TWEAKS (same-day improvement pass):
- The Webb / Jones / Free Ghislaine / Hasidic-costume cluster no longer punts. The "depends on whether you believe satire requires clear moral framing" duck is gone. The new framing commits a position: Tim's bit (Free Ghislaine, Hasidic costume) is total-commitment satire, and the position holds *only* if the commitment stays total — which is exactly where the laugh lives and where the risk lives. The Alex Jones JRE #1555 name-check was dropped here because it's a Rogan-show reference, not Tim's, and was already covered in the Pandemic Prophet section.
- "Building the Empire" renamed "The Sobriety Question" and compressed. The Death-by-Boomers + Netflix-specials career-summary paragraphs collapsed into a single setup paragraph that gets the reader to the 2021 quote, the singleness-by-design quote, and the Sobriety-as-virtue arc faster. Section now type-driven from end to end.

STILL OUTSTANDING (for a deeper pass):
1. Verify Rogan-appearance count (~17), Patreon dollar figures ($14K → $180K → $200-250K/mo), and the $375K Saudi fee. All specific enough to need citations.
2. "Equal Opportunity Offender" subsection still tells rather than shows — needs one concrete both-sides-tried-to-claim-him incident.
============================================================ -->

<!-- ============================================================
DEEP PASS — 2026-05-19 (7→5 deepening + outstanding-issue cleanup)
============================================================

DJ'S BRIEF: deepen the 7→5 case with evidence that Tim is *paying attention* to culture / doing research you don't see — the observer-path 5 quality. The format choice (sitting alone, no guests, reads articles) was the container; the contents weren't shown.

HIGH-IMPACT FIX — "A Seven Goes to Five" rewrite:
- Added the central thesis line: "The format is the container. The contents are where the integration lives."
- Added the audible-attentiveness paragraph: he doesn't cite research on-air because that would break the bit, but you can hear that he's done it.
- Added concrete evidence: (1) Whitney Webb 4× in a 12-month window (Eps #196, #207, #226, #246) — that's tracking one journalist's beat as it accretes, not booking a one-off conspiracy guest. (2) Ryan Grim of Drop Site News on Ep #476 (Dec 2025) — Tim compresses years of Epstein court filings into the "doing a lot of operating" line. (3) JRE 2025 reading list — Tom O'Neill's *Chaos*, Carroll Quigley's *Tragedy and Hope* (1,348 pages), McGowan, Smedley Butler, Webb's *One Nation Under Blackmail*. Quigley is the tell. (4) Granularity riffs: naming Joe Lonsdale (Palantir co-founder, 8VC) in the Thiel bit; booking an SVB staffer within a week of the March 2023 collapse.
- Landing line: "The Type 7 wants to be doing five things at once. The Type 5 quietly read the Quigley."

OTHER OUTSTANDING-ISSUE FIXES IN THIS PASS:

1. **Equal Opportunity Offender rebuilt around the 2025 dual-claim incident.** Replaced "infuriates people on all political sides" abstraction with concrete: Gateway Pundit (April 2025) tried to draft Tim as right-wing free-speech ally; CNN's Elle Reeve (May 2025) framed him as "a gay Rush Limbaugh"; five months later he torched the right's tech-billionaire coalition in the Thiel/Palantir rant. Tim's actual response to CNN's Limbaugh comparison now quoted in section.

2. **Real Fake Business prank quoted from Ep #218.** Added the Palm Canyon Drive pretext ("Hey, this is Tim. I have a client of investor...") + the realtor-stayed-on-the-phone-for-45-minutes detail + Tim's own framing of the bit. Section no longer tells the reader Fake Business is iconic; it demonstrates.

3. **Named human critic added: Benjamin Y. Fong (Jacobin, Oct 2025).** Reconstructs his argument that Tim is "vile without remainder" and what that means structurally — when the bit only works if commitment stays total, you can't reliably tell sincere nihilism from comic nihilism. Pass-4's "critic-engagement weak" finding now resolved.

4. **Numbers verified:** 17 Rogan appearances correct (latest #2375, Sept 2025). Patreon $200-250K/mo confirmed via Graphtreon. $375K Saudi fee confirmed via CBS / Billboard.

QUOTE-SOURCING (pass-4 Priority Fix #1):

- VERIFIED + SOURCED: "My style has evolved greatly" (First Order Historians, Feb 2016); bacon-egg-cheese (Hot Ones 2025, not Are You Garbage? — corrected); "vacant landscape" / Long Island (same Hot Ones appearance); "I don't have guests" (Just B / Bethenny Frankel, Oct 2024); "I am vaccinated and never told anyone" (Tim's X, Nov 14, 2021); "cottage industry of teachers" (Hollywood in Toto, Feb 2021); "I have always loved incredibly damaged people" (Tumblr, Oct 2016); "I think if I found love it would harm" (Vulture, 2016 — primary URL not retrievable, hedged as "Vulture interview, 2016"); "I would much rather talk about... conspiracies" (Vulture, 2016, same hedge).
- TUMBLR POST DATED: The "community college Taco Bell" and "watched people make and lose millions" quotes are from a single October 2016 Tumblr post — added the date inline.
- TIGHTENED: "parties flip" quote trimmed to Tim's actual wording on Fox News (April 2025): "I think the parties flip, but I think they might flip again." The Republican/Democratic specifics now framed as paraphrase rather than direct quote.
- DAMIAN REILLY: All five "Damian Reilly interview" cites upgraded to "Damian Reilly, *The Spectator World*, June 2021." That's the actual publication.
- FIXED TYPO: "The comedians take to him isn't the right take" → "to me" (the verbatim from Bethenny Frankel transcript).
- DEATH SEX & MONEY: Cite tightened to specific date (Sept 21, 2016) and noted as WNYC.

QUOTES CUT / REPHRASED (unverified):
