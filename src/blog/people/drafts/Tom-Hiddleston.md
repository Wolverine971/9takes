...
wikidata_qid: 'Q295803'
imdb_id: 'nm1089991'
birth_date: '1981-02-09'
birth_place: 'Westminster, England, United Kingdom'
nationality: 'British'
occupation:
  - 'Stage Actor'
  - 'Film Actor'
...
keywords:
  ...
  - 'Tom Hiddleston Enneagram Type 2'
  - 'Tom Hiddleston personality'
  - 'Tom Hiddleston personality type'
  - 'Tom Hiddleston analysis'
  - 'Helper enneagram'
same_as:
...
path: src/blog/people/drafts/Tom-Hiddleston.md
---
...
<p class="firstLetter">Tom Hiddleston trained for three months to play Thor. He hit the gym, grew out his hair, practiced holding a hammer like a god. Marvel's audition brief was simple: over six feet, blond, come have a go at it. Hiddleston wanted the golden son. He got the shadow brother instead.</p>
...
<div class="panel">
<ul>
<li><b>The childhood bargain:</b> Parents' divorce at boarding school taught him that being helpful and composed earned warmth; having needs made you a burden</li>
<li><b>Empathy as craft:</b> His entire acting method is built on feeling what others feel — and he chose a career that rewards this</li>
<li><b>The giving that almost consumed him:</b> Fan interactions, UNICEF work, relentless generosity — until public exposure during the Swift era revealed the cost</li>
<li><b>The helper's nightmare:</b> The Golden Globes speech where his attempt to connect his platform to humanitarian work was called self-serving</li>
<li><b>Growth through boundaries:</b> Learning to protect his internal world after years of making it available to everyone</li>
</ul>
</div>
</details>
...
There it is — the same confession we opened with. Not therapy. Not rebellion. Acting. A permission structure for feeling. The only arena where a boy at Eton could be devastated and have it be _valued_.
...
There is something almost unbearably Type 2 about this sequence. The giving. The clumsy execution. The public shaming. The immediate apology. The need to be understood as good even while accepting blame. Every beat follows the Two's [stress pattern](/enneagram-corner/enneagram-types-in-stress) with textbook precision.
...
<h4>Thor (2011)</h4>
<p>"I could have done it, Father. I could have done it for you, for all of us."</p>
<p><em>Desperation. A child begging to be worthy.</em></p>
</div>
<div class="contrast-right">
<h4>Loki Season 2 (2023)</h4>
<p>"I know what I want. I know what kind of god I need to be. For you. For all of us."</p>
<p><em>Purpose. A man who chose what to give.</em></p>
</div>
</div>
