...
keywords:
  - 'SZA enneagram'
  - 'SZA type 4'
  - 'SZA Enneagram Type 4'
  - 'SZA personality'
  - 'SZA personality type'
  - 'SZA analysis'
...
Addressed:
- Added sonic description paragraph before Enneagram analysis ("her voice sounds like it was left outside overnight") — gives readers who don't know her music a landing pad before the framework section
- Added "Kill Bill" as a proper anchor: chart facts (#1 Hot 100, 21 weeks R&B/Hip-Hop record, diamond), and the central contradiction (murder fantasy as biggest pop hit of the year)
- Added SZA name etymology (S/Z/A from Five-Percent Nation Supreme Alphabet, Wu-Tang cues) folded into the TDE signing section — connects her Muslim childhood, the hijab removal, and her chosen name
- Added early EPs paragraph (See.SZA.Run 2012, S 2013, SoundCloud/Tumblr origin) — closes the gap between dropping out and TDE signing
- Added TDE creative control pattern in SOS section (2020 "ask Punch" tweet, Punch split after SOS) — the hard-drive story was presented as a one-time event; now it reads as a career-long climate
- Trimmed TL;DR CTRL bullet to a pointer ("the anxiety never resolved — it just pressed into the grooves") since the full story opens the piece
- Trimmed TL;DR BBL bullet and evidence list BBL bullet — full story lives in the body section
- Removed Grammy paragraph from conclusion (was a duplicate of SOS section)
- Removed "She is still neurotic" from conclusion (already in evidence section)

Kept as-is:
- "Wherever you go, there you'll be" closing the body section — reviewer was right, don't touch it
- Hot Ones scene — perfect as written
- NPR Tiny Desk apology-hugging detail — strongest specific in the piece
- Childhood section — dense and working

Still open:
- Section reorder suggestion (body/relationship earlier, closer to CTRL) was rejected — chronological flow is working and a reorder would risk disrupting the NPR scene and the "nobody gets me" relationship section, which land best near the end; the reviewer's underlying concern (those sections feel like addenda) is partly addressed by the Kill Bill and TDE tension additions, which give the SOS section more heft
- Collaborator quote about working with SZA (reviewer note still in main body) — would strengthen the "testimony from people around her" angle but finding a specific, quotable source without padding the piece is an editor-pass problem
-->

<!-- EDITOR PASS NOTES (2026-04-12)
Cleaned up:
- Removed all em-dashes from article body (24 instances); replaced with commas, colons, semicolons, or periods depending on clause type
- Broke the uniform **Bold label:** template in evidence bullets: 3 of 7 now open directly with a quote or claim, 2 retain bold headers, leaving 2 shortened/restructured; eliminates the most obvious AI structural tell
- Trimmed TL;DR BBL bullet: removed the "I'm so mad I did that shit" quote, which is preserved in the dedicated body section
- Fixed frontmatter description em-dash
- "SOS went wider and stranger" sentence split at the colon to avoid triple-colon paragraph
