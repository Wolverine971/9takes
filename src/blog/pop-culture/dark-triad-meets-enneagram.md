...
A documented act does not reveal an Enneagram type. An Enneagram type does not establish a Dark Triad score. A Dark Triad score does not diagnose a personality disorder, prove a motive, or predict a violent act.

This article therefore uses the two frameworks differently:
...
The three traits overlap substantially. A 2017 meta-analysis and critical review found that they were associated with multiple negative psychosocial outcomes, but it also questioned whether the constructs are sufficiently distinct and whether brief measures capture malevolent personality with enough complexity. ([Muris et al., 2017](https://doi.org/10.1177/1745691616666070))

That gives us several limits:

1. Dark Triad scores are **continuous traits**, not three kinds of monsters.
2. Most studies report **associations**, not inevitable outcomes.
3. A questionnaire is not permission to diagnose someone from a distance.
...
The review did not establish a Dark Triad mapping. A broader search for research connecting the two frameworks did not identify a validated type-by-trait crosswalk.

| Source of information | What it can support                       | What it cannot establish                    |
| --------------------- | ----------------------------------------- | ------------------------------------------- |
| Dark Triad scale      | A score on defined research traits        | A remote diagnosis, motive, or future crime |
...
**Possible distortion:** "The rule is morally necessary, so my method is justified."

**Behavior to watch:** Selective enforcement, humiliation framed as correction, escalating punishment, or refusing the same scrutiny imposed on everyone else.

**Accountability question:** _Would I consider this fair if someone used the same method against me?_
...
**Possible distortion:** "My care gives me a claim on your time, loyalty, or choices."

**Behavior to watch:** Unwanted intervention, conditional generosity, guilt after a boundary, keeping a ledger of favors, or using private disclosures as leverage.

**Accountability question:** _Can the other person decline my help without being punished?_
...
**Possible distortion:** "If the result is impressive, the method does not count."

**Behavior to watch:** Fabricated metrics, hidden failures, taking credit, blaming downward, changing the story for each audience, or treating people as props for an image.

**Accountability question:** _What fact am I tempted to hide because it would change how people evaluate me?_
...
**Possible distortion:** "Because my pain is profound, ordinary limits should not apply."

**Behavior to watch:** Threatening collapse when someone leaves, using vulnerability to prevent disagreement, turning every conflict into proof of abandonment, or demanding that suffering outrank another person's boundary.

**Accountability question:** _Can my pain be real without giving me control over someone else?_
...
**Possible distortion:** "Because I understand the system, I am entitled to use it."

**Behavior to watch:** Privacy invasion, secret monitoring, withholding crucial information, treating people as data, or using expertise to make meaningful consent impossible.

**Accountability question:** _Did the person affected understand and agree to what I am doing?_
...
**Possible distortion:** "The danger might be real, so preemptive control is justified."

**Behavior to watch:** Loyalty tests, surveillance, accusations built from ambiguity, isolating people from alleged threats, or retaliating against questions as though they prove disloyalty.

**Accountability question:** _What evidence would change my mind, and have I allowed anyone to present it safely?_
...
**Possible distortion:** "My need for possibility matters more than the consequences others inherit."

**Behavior to watch:** Repeated promises abandoned after the exciting phase, risks shifted onto other people, charm used to escape repair, or minimizing harm because dwelling on it feels unpleasant.

**Accountability question:** _Can I stay present long enough to repair a consequence I helped create?_
...
**Possible distortion:** "If I can impose the outcome, I have the right to."

**Behavior to watch:** Intimidation, punishing disagreement, ignoring a clear "no," controlling resources, threatening exposure, or describing fear in others as respect.

**Accountability question:** _Can people disagree with me without fearing what I will do next?_
...
**Possible distortion:** "If I do not act, I am not responsible for the outcome."

**Behavior to watch:** Withholding information to avoid conflict, chronic stonewalling, agreeing without follow-through, enabling abuse, or waiting until someone else absorbs the cost.

**Accountability question:** _Who pays for the peace created by my silence or delay?_

Calm can be restorative. It can also conceal a decision not to intervene.
...
- deception that changes when confronted with evidence
- entitlement to exceptions and special access
- exploiting private information or known vulnerabilities
- boundary violations after a clear refusal
- coercive control over money, movement, work, or relationships
- intimidation, stalking, threats, or retaliation
- isolating someone from support
- refusing repair while demanding immediate forgiveness
- escalating violations after smaller ones produce no consequence

One selfish act does not establish a personality profile. A repeated pattern, its impact, the person's response to accountability, and any escalation matter more than the label.
...
- **Humanism:** valuing each person's dignity and worth
- **Faith in Humanity:** believing people are fundamentally good

Across four studies with 1,518 participants, Light and Dark Triad scores were moderately negatively correlated (`r = -0.48`). They were not simple opposites, and the study was correlational; it did not establish a treatment program or prove that adopting three beliefs causes harmful traits to disappear. ([Kaufman et al., 2019](https://doi.org/10.3389/fpsyg.2019.00467))

The practical value is not another label. It is a set of behavioral questions:

- Am I treating this person as a person or as an instrument?
- Do I preserve their ability to say no?
- Do I tell the truth when deception would benefit me?
- Can I accept scrutiny from the people affected by my decisions?
- After harm, do I repair, retaliate, rationalize, or disappear?
