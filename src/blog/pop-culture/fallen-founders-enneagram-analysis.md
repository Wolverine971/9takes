...
description: "Same personality engines that built Nvidia, Microsoft, and OpenAI can also build Theranos, WeWork, and FTX. Holmes (3w2), Neumann (3w2), SBF (5w6) — and Sam Altman (4) is the live experiment. Here's the cautionary-tale pattern tech keeps missing."
author: 'DJ Wayne'
date: '2026-05-07'
...
Three founders running the same broken loop — building the founder before the product — and three different prison terms because of which kind of substrate the costume was wrapped around. Neumann is a Type 3w2, the founder-as-product performer; he walked free because WeWork's underlying real-estate business could be repriced as a feeling. Holmes is a Type 3w2, the achievement engine with the helper wing, who collected Henry Kissinger and James Mattis as patrons before the blood-test device worked; she went to prison because the gap between her image and her product was 100%. SBF is a Type 5w6, the systems-mastery rationalist who builds from first principles; he got 25 years because juries hate cold rationalists who explain their fraud with arithmetic. Charlie Javice (3w2, 7 years) and Do Kwon (5w6, 15 years) are the 2025 sequels that confirm the pattern. Sam Altman is a Type 4 in the same structural position right now — and the only thing keeping him from this list is that GPT actually works.
</QuickAnswer>
...
> _"You start to realize, you are looking in the eyes of another Bill Gates, or Steve Jobs."_ — Channing Robertson, Fortune, 2014
