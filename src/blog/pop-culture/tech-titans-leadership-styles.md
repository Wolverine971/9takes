...
Google under Pichai has been criticized for slow AI responses (letting OpenAI get ahead with ChatGPT, built on Transformer architecture that was invented _at Google_). Indecisive product strategy (killing products, launching half-baked ones). A culture that avoids hard decisions.
