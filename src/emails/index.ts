                          ...
                          <table border="0" cellpadding="0" cellspacing="0">
                            <tr style="display:flex; justify-content: center;">
                              <td align="center" bgcolor="#1a82e2" style="border-radius: 6px; margin: 3px; max-width: 119px">
                                <a href="https://www.instagram.com/9takesdotcom/" target="_blank" style="display: flex; justify-content: center; padding: 16px 36px; font-size: 18px; color: #ffffff; text-decoration: none; border-radius: 6px;">
                               ...
                               <td align="center" bgcolor="#1a82e2" style="border-radius: 6px; margin: 3px; max-width: 119px">
                                <a href="https://twitter.com/9takesdotcom" target="_blank" style="display: flex; justify-content: center; padding: 16px 36px; font-size: 18px; color: #ffffff; text-decoration: none; border-radius: 6px;">
                  ...
                  <div
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr align="center">
                        <td valign="top" width="50%">
                          <a href="https://9takes.com/blog/enneagram/enneagram-types-at-party" style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                              ...
                              <img style="border:0;line-height:100%;outline:none;text-decoration:none;background:#d7d7d7;margin:10px; object-fit: cover; width: 230px; height: 230px; filter: sepia(100%) hue-rotate(160deg); border-radius: 5px;"
                                src="https://9takes.com/blogs/party-in-street-color.webp">
                            </a>
                        </td>
                        <td valign="top" width="50%">
                        ...
                        <img style="border:0;line-height:100%;outline:none;text-decoration:none;background:#d7d7d7;margin:10px; object-fit: cover; width: 230px; height: 230px; filter: sepia(100%) hue-rotate(160deg); border-radius: 5px;"
                          src="https://9takes.com/blogs/communication-tips-color.webp">
                      </a>
                        </td>
                      </tr>
                      <tr>
