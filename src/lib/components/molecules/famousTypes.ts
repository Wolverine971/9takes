...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	9: [
		...
		{ name: 'lionel-messi', link: false, hasImage: true, lastmod: '2026-04-10', personaTitle: 'Football\'s Quiet Volcano', contentGrade: 9 },
		...
		{ name: 'steve-carell', link: false, hasImage: true, lastmod: '2026-04-08', personaTitle: 'Comedy\'s Invisible Lead', contentGrade: 9.1 },
