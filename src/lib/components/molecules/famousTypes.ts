...
export const famousTypes: { [index: number]: FamousTypePerson[] } = {
	1: [
		...
		{ name: 'caitlin-clark', link: false, hasImage: false, lastmod: '2026-08-05', personaTitle: 'Basketball\'s Uncompromising Crusader', contentGrade: 8.6, types: ['celebrity', 'athlete'] },
	...
	3: [
		...
		{ name: 'chase-infiniti', link: false, hasImage: false, lastmod: '2026-08-11', personaTitle: 'Hollywood\'s Unshaking Hand', contentGrade: 8.2, types: ['newMovieStar', 'celebrity', 'rising-star', 'screen-icon'] },
