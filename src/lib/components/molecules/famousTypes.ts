...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	4: [
		...
		{ name: 'sza', link: false, hasImage: false, lastmod: '2026-04-12', personaTitle: 'R&B\'s Unfinished Wound', contentGrade: 8.4 },
	...
	9: [
		...
		{ name: 'rachel-mcadams', link: true, hasImage: false, lastmod: '2026-04-12', personaTitle: 'Hollywood\'s Deliberate Ghost', contentGrade: 8.9 },
