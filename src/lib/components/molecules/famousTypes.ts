...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	6: [
		...
		{ name: 'ryan-grim', link: false, hasImage: true, lastmod: '2026-04-10', personaTitle: 'Media\'s Loyal Insurgent', contentGrade: 8.7 },
	...
	7: [
		...
		{ name: 'mike-majlak', link: false, hasImage: true, lastmod: '2026-04-10', personaTitle: 'Recovery\'s Restless Evangelist', contentGrade: 8.7 },
	...
	8: [
		...
		{ name: 'joe-rogan', link: true, hasImage: true, lastmod: '2026-04-03', personaTitle: 'Podcasting\'s Alpha Interrogator', contentGrade: 9.4 },
