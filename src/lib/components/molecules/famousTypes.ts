...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	2: [
		...
		{ name: 'sky-bri', link: false, hasImage: true, lastmod: '2026-04-06', personaTitle: 'The Internet\'s Permanent Offering', contentGrade: 9 },
	...
	3: [
		...
		{ name: 'ben-affleck', link: false, hasImage: true, lastmod: '2026-04-06', personaTitle: 'Hollywood\'s Self-Demolishing Architect', contentGrade: 8.6 },
		...
		{ name: 'patrick-bet-david', link: false, hasImage: true, lastmod: '2026-04-06', personaTitle: 'Media\'s Self-Made Strategist', contentGrade: 8.8 },
