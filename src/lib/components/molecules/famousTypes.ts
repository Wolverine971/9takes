...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	4: [
		...
		{ name: 'Alex-Karp', link: false, hasImage: false, lastmod: '2026-03-23', personaTitle: 'Silicon Valley\'s Ornery Poet', contentGrade: 8.9 },
	...
	5: [
		...
		{ name: 'Dario-Amodei', link: false, hasImage: true, lastmod: '2026-03-23', personaTitle: 'AI\'s Reluctant Prometheus', contentGrade: 8.8 },
	...
	8: [
		...
		{ name: 'Travis-Kalanick', link: false, hasImage: true, lastmod: '2026-03-23', personaTitle: 'Tech\'s Armored Disruptor', contentGrade: 8.8 },
