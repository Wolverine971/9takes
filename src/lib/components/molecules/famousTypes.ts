...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	2: [
		...
		{ name: 'simon-sinek', link: false, hasImage: false, lastmod: '2026-03-28', personaTitle: 'Leadership\'s Selfless Architect', contentGrade: null }
	],
	3: [
		...
		{ name: 'arnold-schwarzenegger', link: true, hasImage: true, lastmod: '2026-03-28', personaTitle: 'Hollywood\'s Insatiable Architect', contentGrade: null },
