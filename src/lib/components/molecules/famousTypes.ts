...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	7: [
		...
		{ name: 'john-f-kennedy', link: true, hasImage: true, lastmod: '2026-04-01', personaTitle: 'Camelot\'s Graceful Fugitive', contentGrade: 9.1 },
		{ name: 'jon-stewart', link: true, hasImage: true, lastmod: '2026-03-03', personaTitle: 'Comedy\'s Wounded Compass', contentGrade: 9 },
		{ name: 'kai-cenat', link: true, hasImage: true, lastmod: '2026-04-02', personaTitle: 'Twitch\'s Perpetual Motion Machine', contentGrade: 8.7 },
		...
		{ name: 'kyle-forgeard', link: false, hasImage: false, lastmod: '2026-04-03', personaTitle: 'Content\'s Restless Empire Builder', contentGrade: 8.5 },
	...
	8: [
		...
		{ name: 'ishowspeed', link: true, hasImage: true, lastmod: '2026-04-01', personaTitle: 'Streaming\'s Homesick Warlord', contentGrade: 9.1 },
