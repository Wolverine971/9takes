...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	6: [
		...
		{ name: 'Howard-Stern', link: true, hasImage: true, lastmod: '2026-03-11', personaTitle: 'Radio\'s Counterphobic Sentinel', contentGrade: 9.1 },
		...
		{ name: 'Stephen-Colbert', link: true, hasImage: true, lastmod: '2026-03-11', personaTitle: 'Late Night\'s Faithful Skeptic', contentGrade: 8.9 },
