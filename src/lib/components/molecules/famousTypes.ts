...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	3: [
		...
		{ name: 'bernard-arnault', link: false, hasImage: true, lastmod: '2026-05-01', personaTitle: 'The Achiever in Cashmere', contentGrade: 9.3 },
	...
	6: [
		...
		{ name: 'meghan-trainor', link: false, hasImage: true, lastmod: '2026-04-16', personaTitle: 'Pop\'s Bubblegum Sentinel', contentGrade: 8.9 },
