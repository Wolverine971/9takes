...
export const famousTypes: { [index: number]: FamousTypePerson[] } = {
	...
	2: [
		...
		{ name: 'madelaine-petsch', link: false, hasImage: true, lastmod: '2026-07-09', personaTitle: 'Riverdale\'s Recovering Fixer', contentGrade: 8.4, types: ['newMovieStar', 'creator'] },
	...
	6: [
		...
		{ name: 'keira-knightley', link: false, hasImage: true, lastmod: '2026-06-12', personaTitle: 'Cinema\'s Sword-Drawn Skeptic', contentGrade: 8.6, types: ['movieStar'] },
