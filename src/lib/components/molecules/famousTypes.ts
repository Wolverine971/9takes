...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	3: [
		...
		{ name: 'Tyler-Perry', link: false, hasImage: false, lastmod: '2026-03-24', personaTitle: 'Hollywood\'s Self-Built Fortress', contentGrade: 8.8 }
	],
	4: [
	...
	6: [
		...
		{ name: 'Jake-Shane', link: false, hasImage: false, lastmod: '2026-03-24', personaTitle: 'TikTok\'s Anxious Sweetheart', contentGrade: 8.8 },
