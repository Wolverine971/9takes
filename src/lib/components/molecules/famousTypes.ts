...
export const famousTypes: { [index: number]: { name: string; link: boolean; hasImage: boolean; lastmod: string | null; personaTitle: string | null; contentGrade: number | null }[] } = {
	...
	3: [
		...
		{ name: 'sara-saffari', link: true, hasImage: true, lastmod: '2026-04-08', personaTitle: 'Fitness\'s Self-Built Phoenix', contentGrade: 8.4 },
	...
	8: [
		...
		{ name: 'bradley-martyn', link: true, hasImage: true, lastmod: '2026-04-08', personaTitle: 'Fitness\'s Armored Guardian', contentGrade: null },
