...
export const famousTypes: { [index: number]: FamousTypePerson[] } = {
	...
	3: [
		...
		{ name: 'elizabeth-holmes', link: true, hasImage: true, lastmod: '2026-05-07', personaTitle: 'Silicon Valley\'s Empty Costume', contentGrade: 8.9, types: ['entrepreneur', 'techie', 'business-operator'] },
