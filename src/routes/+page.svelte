	...
	<div class="column">
		...
		>
			<div class="content-display">
				<h1 class=" txt-white jumbo-name bold-shadow" data-value={'9takes'} itemprop="name">
					{'9takes'}
				</h1>
				<p
