<!-- src/routes/old-home/+page.svelte -->
<!--
  Archived production homepage — Streetlamp Symposium V5.
  Preserved at /old-home as a rollback/reference surface after the 2026-07-16 promotion.
...
<SEOHead
	title={`Old homepage · ${homepageTitle}`}
	description="Archived version of the previous 9takes homepage, preserved for reference."
	canonical={`${siteUrl}/old-home`}
...
<div class="home">
	<aside class="archive-notice" aria-label="Archived homepage notice">
		<div class="archive-notice-inner">
			<div>
				<span>ARCHIVED HOMEPAGE · OLD VERSION</span>
				<p>This page is preserved for reference and is no longer the 9takes homepage.</p>
			</div>
			<Button href="/" size="sm" variant="ghost">View the current homepage</Button>
		</div>
	</aside>
...
<style lang="scss">
	...
	.archive-notice {
		position: relative;
		z-index: 8;
		border-bottom: 1px solid color-mix(in srgb, var(--lamp-glow) 42%, var(--stone-edge));
		background: color-mix(in srgb, var(--lamp-glow) 9%, var(--night-mid));
	}
