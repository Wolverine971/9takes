-- supabase/migrations/20260812010200_optimize_trending_pages_planning.sql
-- Re-plan the trending query with each bounded parameter set. The original
-- SECURITY DEFINER SQL wrapper cached a generic plan that ran about 10x slower.
