-- supabase/migrations/20260812010500_materialize_release_demand_source_buckets.sql
-- Created: 2026-08-12
--
-- Classify each qualifying visit once. Without MATERIALIZED, PostgreSQL can inline `bucketed`
-- into `flagged` and expand the source-bucket CASE repeatedly for each derived flag.
--
