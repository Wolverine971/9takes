-- supabase/migrations/20260905013714_fix_acquisition_source_fallbacks.sql
-- Make acquisition normalization total for unrecognized UTM sources and click IDs.
-- PL/pgSQL statement-form CASE raises SQLSTATE 20000 when no branch matches and
-- no ELSE is present. Unknown campaign values should fall through to the next
-- signal instead of rejecting the analytics write.
