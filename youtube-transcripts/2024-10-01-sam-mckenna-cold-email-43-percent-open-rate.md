---
title: "Her Cold Email Strategy Has a 43% OPEN RATE!"
video_id: ydsMxs2yeos
url: "https://www.youtube.com/watch?v=ydsMxs2yeos"
channel: Apollo
channel_url: "https://www.youtube.com/channel/UCJla_9zDYTxVRGoiBkZ0dGg"
...
timestamps:
  - time: "0:00"
    label: Intro
  - time: "1:11"
    label: Cold Email Subject Line
  - time: "3:07"
    label: The First Sentence in Your Cold Email
  - time: "4:30"
    label: The Value Proposition in Your Cold Email
  - time: "7:59"
    label: Writing the Perfect Cold Email
  - time: "8:10"
    label: Outro
description: |
  Find the right people to email by getting started with Apollo for FREE - https://bit.ly/4euNhPV
  
  
  Sam McKenna used to question whether a career in sales was right for her… until she discovered a unique approach that led her to seven figures a year, smashing quotas and building an eight-figure business.
  
  She's discovered how to craft the perfect cold email...with open rates that could make a unicorn jealous (43%) and a reply rate that defies the laws of email physics (20%). Sam's Show Me You Know Me® method holds the secrets to getting replies from prospects you never thought possible.
  
  And now she's ready to share them.
  
  In the full course, you'll learn how to:
  
  - Research your prospect in a way that’s comprehensive (but not creepy)
  - Avoid common pitfalls in cold emailing
  - Write subject lines so specific your prospect can’t resist responding
  - Craft “perfect” emails that scream authenticity
  - Build a basic sequence structure for if you don’t get a reply
  - Get a bonus discovery call script
  - And so much more…
  
  Timestamps
  00:00 - Intro
  01:11 - Cold Email Subject Line
  03:07 - The First Sentence in Your Cold Email
  04:30 - The Value Proposition in Your Cold Email
  07:59 - Writing the Perfect Cold Email
  08:10 - Outro
  
  Ready to take your sales game to the next level? Check out Apollo Academy for more FREE content just like this!
  
  [Free Course] How to Write Cold Emails Anyone Will Respond To - https://bit.ly/3BClNJq
  
  Get our data-backed playbook for cold email, cold calling, social selling, and more - https://bit.ly/4gETwCp
  
  Connect With Us!
  
  LinkedIn: https://www.linkedin.com/company/apolloio
  Instagram:  https://www.instagram.com/meetapollo.io/
  Tiktok:  https://www.tiktok.com/@useapollo.io
  
  #sales #coldemail #salesstrategy
transcribed_date: "2026-04-27"
path: youtube-transcripts/2024-10-01-sam-mckenna-cold-email-43-percent-open-rate.md
---
...
- **Channel**: [Apollo](https://www.youtube.com/channel/UCJla_9zDYTxVRGoiBkZ0dGg)
- **Video**: [Watch on YouTube](https://www.youtube.com/watch?v=ydsMxs2yeos)
- **Duration**: 9:19
...
- 0:00 — Intro
- 1:11 — Cold Email Subject Line
- 3:07 — The First Sentence in Your Cold Email
- 4:30 — The Value Proposition in Your Cold Email
- 7:59 — Writing the Perfect Cold Email
- 8:10 — Outro
