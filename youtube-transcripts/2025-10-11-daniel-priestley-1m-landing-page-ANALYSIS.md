...
path: youtube-transcripts/2025-10-11-daniel-priestley-1m-landing-page-ANALYSIS.md
---
...
**A. Frustration Hook**
- Format: *"Feeling frustrated that [outcome] isn't happening **even though** you're [doing the right thing]?"*
...
- Format: *"Are you ready to [aspirational result]?"*
- Examples:
...
Format: *"Take this assessment so we can measure and improve [3 key areas]."*
...
Ask 10 yes/no-ish questions about whether they're doing the things they *should* be doing in your domain.
...
**Q3 — Obstacle**
> "What is the obstacle you think is stopping you?" *(or "What have you tried that hasn't worked?")*
- 3–4 options
...
- **Pre-empt skepticism** with credibility *before* the CTA, not after.
...
3. **Personality-analysis pages** — each celebrity page could end with a mini-assessment ("How similar are *you* to [celebrity]?") that segments readers into community / quiz / coaching paths.
