...
- **Raw transcript dumps** (unstructured, mostly verbatim): `youtube-transcripts/_raw/*.raw.md`
- **Transcript writeups** (structured + lightly cleaned): `youtube-transcripts/*.md`
- **Multi-transcript analysis docs** (e.g., consolidated analyses): `youtube-transcripts/*consolidated-analysis.md`
- **Folder-level synthesis**: `youtube-transcripts/consolidated-synthesis.md`
...
- Raw transcripts live in `_raw/` and add a `.raw` suffix:
  - Writeup: `youtube-transcripts/<slug>.md`
  - Raw: `youtube-transcripts/_raw/<slug>.raw.md`
...
If `youtube-transcripts/_raw/<slug>.raw.md` exists, the writeup **must** link to it using a Markdown link:
...
## Standard Template: Transcript Writeup (`youtube-transcripts/<slug>.md`)
...
```md
<!-- youtube-transcripts/<name>-consolidated-analysis.md -->
...
1. Save the raw dump as `youtube-transcripts/_raw/<slug>.raw.md`.
2. Create `youtube-transcripts/<slug>.md` using the template above.
...
5. If you rename any files:
   - Update any `<!-- youtube-transcripts/... -->` filepath comments.
